...
static int LUACALL wxLua_function_wxCopyFile(lua_State *L)
{
    ...
    // bool overwrite = true
    bool overwrite = (argCount >= 3 ? wxlua_getbooleantype(L, 3) : (bool)true);
    // const wxString file2
    const wxString file2 = wxlua_getwxStringtype(L, 2);
    // const wxString file1
    const wxString file1 = wxlua_getwxStringtype(L, 1);
...
static int LUACALL wxLua_function_wxGetElapsedTime(lua_State *L)
{
    ...
    bool resetTimer = (argCount >= 1 ? wxlua_getbooleantype(L, 1) : (bool)true);
...
static int LUACALL wxLua_function_wxGetTranslation1(lua_State *L)
{
    ...
    wxString  domain = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (wxString )wxString(wxEmptyString));
    // const wxString sz
    const wxString sz = wxlua_getwxStringtype(L, 1);
    // call wxGetTranslation
...
static int LUACALL wxLua_function_wxGetTranslation(lua_State *L)
{
    ...
    const wxString domain = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (const wxString)wxString(wxEmptyString));
    // const wxString sz
    const wxString sz = wxlua_getwxStringtype(L, 1);
    // call wxGetTranslation
...
static int LUACALL wxLua_function_wxGetTranslationPlural1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxChar domain = NULL
    wxString  domain = (argCount >= 4 ? wxlua_getwxStringtype(L, 4) : (wxString )wxString(wxEmptyString));
    // size_t n
    size_t n = (size_t)wxlua_getuintegertype(L, 3);
    // const wxString sz2
    const wxString sz2 = wxlua_getwxStringtype(L, 2);
...
static int LUACALL wxLua_function_wxGetUserHome(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString user = ""
    const wxString user = (argCount >= 1 ? wxlua_getwxStringtype(L, 1) : (const wxString)wxString(wxEmptyString));
    // call wxGetUserHome
...
static int LUACALL wxLua_function_wxMkdir(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int perm = 0777
    int perm = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)0777);
    // const wxString dir
...
static int LUACALL wxLua_function_wxSysErrorMsg(lua_State *L)
{
    ...
    unsigned long nErrCode = (argCount >= 1 ? (unsigned long)wxlua_getuintegertype(L, 1) : (unsigned long)0);
    // call wxSysErrorMsg
