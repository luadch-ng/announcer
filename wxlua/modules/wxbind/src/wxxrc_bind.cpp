...
static int LUACALL wxLua_wxXmlResource_GetXRCID(lua_State *L)
{
    ...
    int value_if_not_found = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)wxID_NONE);
...
static int LUACALL wxLua_wxXmlResource_constructor1(lua_State *L)
{
    ...
    int flags = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)wxXRC_USE_LOCALE);
    // const wxString filemask
...
static int LUACALL wxLua_wxXmlResource_constructor(lua_State *L)
{
    ...
    // int flags = wxXRC_USE_LOCALE
    int flags = (argCount >= 1 ? (int)wxlua_getnumbertype(L, 1) : (int)wxXRC_USE_LOCALE);
    // call constructor
