...
static int LUACALL wxLua_wxMenu_Append1(lua_State *L)
{
    ...
    const wxString helpString = (argCount >= 5 ? wxlua_getwxStringtype(L, 5) : (const wxString)wxString(wxEmptyString));
    // wxMenu subMenu
...
static int LUACALL wxLua_wxMenu_Append(lua_State *L)
{
    ...
    wxItemKind kind = (argCount >= 5 ? (wxItemKind)wxlua_getenumtype(L, 5) : (wxItemKind)wxITEM_NORMAL);
    // const wxString helpString = ""
    const wxString helpString = (argCount >= 4 ? wxlua_getwxStringtype(L, 4) : (const wxString)wxString(wxEmptyString));
    // const wxString item
    const wxString item = wxlua_getwxStringtype(L, 3);
    // int id
    int id = (int)wxlua_getnumbertype(L, 2);
...
static int LUACALL wxLua_wxMenu_AppendCheckItem(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString help = ""
    const wxString help = (argCount >= 4 ? wxlua_getwxStringtype(L, 4) : (const wxString)wxString(wxEmptyString));
    // const wxString item
    const wxString item = wxlua_getwxStringtype(L, 3);
    // int id
    int id = (int)wxlua_getnumbertype(L, 2);
...
static int LUACALL wxLua_wxMenu_FindChildItem(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // size_t pos = NULL
    size_t * pos = (argCount >= 3 ? (size_t *)wxlua_touserdata(L, 3) : (size_t *)NULL);
    // int id
    int id = (int)wxlua_getnumbertype(L, 2);
    // get this
    wxMenu * self = (wxMenu *)wxluaT_getuserdatatype(L, 1, wxluatype_wxMenu);
...
static int LUACALL wxLua_wxMenu_Insert2(lua_State *L)
{
    ...
    const wxString help = (argCount >= 6 ? wxlua_getwxStringtype(L, 6) : (const wxString)wxString(wxEmptyString));
    // wxMenu submenu
...
static int LUACALL wxLua_wxMenu_Prepend2(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString help = wxEmptyString
    const wxString help = (argCount >= 5 ? wxlua_getwxStringtype(L, 5) : (const wxString)wxString(wxEmptyString));
    // wxMenu submenu
    wxMenu * submenu = (wxMenu *)wxluaT_getuserdatatype(L, 4, wxluatype_wxMenu);
    // const wxString text
    const wxString text = wxlua_getwxStringtype(L, 3);
...
static int LUACALL wxLua_wxMenu_UpdateUI(lua_State *L)
{
    ...
    wxEvtHandler * source = (argCount >= 2 ? (wxEvtHandler *)wxluaT_getuserdatatype(L, 2, wxluatype_wxEvtHandler) : (wxEvtHandler *)NULL);
    // get this
    wxMenu * self = (wxMenu *)wxluaT_getuserdatatype(L, 1, wxluatype_wxMenu);
    // call UpdateUI
...
static int LUACALL wxLua_wxMenu_constructor2(lua_State *L)
{
    ...
    // const wxString title = ""
    const wxString title = (argCount >= 1 ? wxlua_getwxStringtype(L, 1) : (const wxString)wxString(wxEmptyString));
    // call constructor
    wxMenu* returns = new wxMenu(title, style);
...
static int LUACALL wxLua_wxMenuBar_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // long style = 0
    long style = (argCount >= 1 ? (long)wxlua_getnumbertype(L, 1) : (long)0);
    // call constructor
...
static int LUACALL wxLua_wxMenuItem_Check(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool check = true
    bool check = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
...
static int LUACALL wxLua_wxMenuItem_Enable(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool enable = true
    bool enable = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxMenuItem * self = (wxMenuItem *)wxluaT_getuserdatatype(L, 1, wxluatype_wxMenuItem);
    // call Enable
    self->Enable(enable);
...
static int LUACALL wxLua_wxMenuItem_GetBitmap(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool checked = true
    bool checked = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxMenuItem * self = (wxMenuItem *)wxluaT_getuserdatatype(L, 1, wxluatype_wxMenuItem);
    // call GetBitmap
    // allocate a new object using the copy constructor
...
static int LUACALL wxLua_wxMenuItem_SetBitmaps(lua_State *L)
{
    ...
    const wxBitmap * unchecked = (argCount >= 3 ? (const wxBitmap *)wxluaT_getuserdatatype(L, 3, wxluatype_wxBitmap) : (const wxBitmap *)&wxNullBitmap);
...
static int LUACALL wxLua_wxMenuEvent_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxMenu menu = NULL
    wxMenu * menu = (argCount >= 3 ? (wxMenu *)wxluaT_getuserdatatype(L, 3, wxluatype_wxMenu) : (wxMenu *)NULL);
    // int id = 0
...
static int LUACALL wxLua_wxToolBarBase_AddCheckTool(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxObject data = NULL
    wxObject * data = (argCount >= 8 ? (wxObject *)wxluaT_getuserdatatype(L, 8, wxluatype_wxObject) : (wxObject *)NULL);
    // const wxString longHelp = ""
    const wxString longHelp = (argCount >= 7 ? wxlua_getwxStringtype(L, 7) : (const wxString)wxString(wxEmptyString));
    // const wxString shortHelp = ""
    const wxString shortHelp = (argCount >= 6 ? wxlua_getwxStringtype(L, 6) : (const wxString)wxString(wxEmptyString));
    // const wxBitmap bmpDisabled = wxNullBitmap
    const wxBitmap * bmpDisabled = (argCount >= 5 ? (const wxBitmap *)wxluaT_getuserdatatype(L, 5, wxluatype_wxBitmap) : (const wxBitmap *)&wxNullBitmap);
...
static int LUACALL wxLua_wxToolBarBase_AddTool1(lua_State *L)
{
    ...
    const wxString shortHelpString = (argCount >= 5 ? wxlua_getwxStringtype(L, 5) : (const wxString)wxString(wxEmptyString));
...
static int LUACALL wxLua_wxToolBarBase_AddTool(lua_State *L)
{
    ...
    wxObject * clientData = (argCount >= 9 ? (wxObject *)wxluaT_getuserdatatype(L, 9, wxluatype_wxObject) : (wxObject *)NULL);
    // const wxString longHelpString = ""
    const wxString longHelpString = (argCount >= 8 ? wxlua_getwxStringtype(L, 8) : (const wxString)wxString(wxEmptyString));
    // const wxString shortHelpString = ""
    const wxString shortHelpString = (argCount >= 7 ? wxlua_getwxStringtype(L, 7) : (const wxString)wxString(wxEmptyString));
    // wxItemKind kind = wxITEM_NORMAL
    wxItemKind kind = (argCount >= 6 ? (wxItemKind)wxlua_getenumtype(L, 6) : (wxItemKind)wxITEM_NORMAL);
    // const wxBitmap bitmap2 = wxNullBitmap
    const wxBitmap * bitmap2 = (argCount >= 5 ? (const wxBitmap *)wxluaT_getuserdatatype(L, 5, wxluatype_wxBitmap) : (const wxBitmap *)&wxNullBitmap);
    // const wxBitmap bitmap1
    const wxBitmap * bitmap1 = (const wxBitmap *)wxluaT_getuserdatatype(L, 4, wxluatype_wxBitmap);
    // const wxString label
    const wxString label = wxlua_getwxStringtype(L, 3);
...
static int LUACALL wxLua_wxToolBarBase_InsertTool1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxObject clientData = NULL
    wxObject * clientData = (argCount >= 10 ? (wxObject *)wxluaT_getuserdatatype(L, 10, wxluatype_wxObject) : (wxObject *)NULL);
    // const wxString longHelp = ""
    const wxString longHelp = (argCount >= 9 ? wxlua_getwxStringtype(L, 9) : (const wxString)wxString(wxEmptyString));
    // const wxString shortHelp = ""
    const wxString shortHelp = (argCount >= 8 ? wxlua_getwxStringtype(L, 8) : (const wxString)wxString(wxEmptyString));
    // wxItemKind kind = wxITEM_NORMAL
    wxItemKind kind = (argCount >= 7 ? (wxItemKind)wxlua_getenumtype(L, 7) : (wxItemKind)wxITEM_NORMAL);
    // const wxBitmap bmpDisabled = wxNullBitmap
    const wxBitmap * bmpDisabled = (argCount >= 6 ? (const wxBitmap *)wxluaT_getuserdatatype(L, 6, wxluatype_wxBitmap) : (const wxBitmap *)&wxNullBitmap);
    // const wxBitmap bitmap
...
static int LUACALL wxLua_wxToolBarBase_InsertTool(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString longHelpString = ""
    const wxString longHelpString = (argCount >= 9 ? wxlua_getwxStringtype(L, 9) : (const wxString)wxString(wxEmptyString));
    // const wxString shortHelpString = ""
    const wxString shortHelpString = (argCount >= 8 ? wxlua_getwxStringtype(L, 8) : (const wxString)wxString(wxEmptyString));
    // wxObject clientData = NULL
    wxObject * clientData = (argCount >= 7 ? (wxObject *)wxluaT_getuserdatatype(L, 7, wxluatype_wxObject) : (wxObject *)NULL);
    // bool isToggle = false
    bool isToggle = (argCount >= 6 ? wxlua_getbooleantype(L, 6) : (bool)false);
    // const wxBitmap pushedBitmap = wxNullBitmap
    const wxBitmap * pushedBitmap = (argCount >= 5 ? (const wxBitmap *)wxluaT_getuserdatatype(L, 5, wxluatype_wxBitmap) : (const wxBitmap *)&wxNullBitmap);
    // const wxBitmap bitmap
    const wxBitmap * bitmap = (const wxBitmap *)wxluaT_getuserdatatype(L, 4, wxluatype_wxBitmap);
    // int id
    int id = (int)wxlua_getnumbertype(L, 3);
...
static int LUACALL wxLua_wxToolBar_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 7 ? wxlua_getwxStringtype(L, 7) : (const wxString)wxString(wxT("wxToolBar")));
    // long style = wxNO_BORDER | wxTB_HORIZONTAL
    long style = (argCount >= 6 ? (long)wxlua_getnumbertype(L, 6) : (long)wxNO_BORDER | wxTB_HORIZONTAL);
...
static int LUACALL wxLua_wxToolBar_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxToolBar"
    const wxString name = (argCount >= 6 ? wxlua_getwxStringtype(L, 6) : (const wxString)wxString(wxT("wxToolBar")));
    // long style = wxNO_BORDER | wxTB_HORIZONTAL
    long style = (argCount >= 5 ? (long)wxlua_getnumbertype(L, 5) : (long)wxNO_BORDER | wxTB_HORIZONTAL);
    // const wxSize size = wxDefaultSize
...
static int LUACALL wxLua_wxToolBarSimple_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 7 ? wxlua_getwxStringtype(L, 7) : (const wxString)wxString(wxToolBarNameStr));
    // long style = wxNO_BORDER | wxTB_HORIZONTAL
    long style = (argCount >= 6 ? (long)wxlua_getnumbertype(L, 6) : (long)wxNO_BORDER | wxTB_HORIZONTAL);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 5 ? (const wxSize *)wxluaT_getuserdatatype(L, 5, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
...
static int LUACALL wxLua_wxToolBarSimple_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = wxToolBarNameStr
    const wxString name = (argCount >= 6 ? wxlua_getwxStringtype(L, 6) : (const wxString)wxString(wxToolBarNameStr));
    // long style = wxNO_BORDER | wxTB_HORIZONTAL
    long style = (argCount >= 5 ? (long)wxlua_getnumbertype(L, 5) : (long)wxNO_BORDER | wxTB_HORIZONTAL);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 4 ? (const wxSize *)wxluaT_getuserdatatype(L, 4, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
...
static int LUACALL wxLua_wxAcceleratorEntry_Set(lua_State *L)
{
    ...
    wxMenuItem * item = (argCount >= 5 ? (wxMenuItem *)wxluaT_getuserdatatype(L, 5, wxluatype_wxMenuItem) : (wxMenuItem *)NULL);
    // int Cmd
...
static int LUACALL wxLua_wxAcceleratorEntry_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxMenuItem item = NULL
    wxMenuItem * item = (argCount >= 4 ? (wxMenuItem *)wxluaT_getuserdatatype(L, 4, wxluatype_wxMenuItem) : (wxMenuItem *)NULL);
    // int cmd = 0
    int cmd = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)0);
    // int keyCode = 0
    int keyCode = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)0);
    // int flags = 0
    int flags = (argCount >= 1 ? (int)wxlua_getnumbertype(L, 1) : (int)0);
    // call constructor
