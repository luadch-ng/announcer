...
//     void SetExtraLong(long extraLong);	// changed from int to long for OneLuaPro
static int LUACALL wxLua_wxCommandEvent_SetExtraLong(lua_State *L)
{
    // long extraLong
...
static int LUACALL wxLua_wxCommandEvent_constructor(lua_State *L)
{
    ...
    wxEventType commandEventType = (argCount >= 1 ? (wxEventType)wxlua_getnumbertype(L, 1) : (wxEventType)wxEVT_NULL);
    // call constructor
...
static int LUACALL wxLua_wxActivateEvent_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int id = 0
    int id = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)0);
    // bool active = true
    bool active = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // wxEventType eventType = wxEVT_NULL
    wxEventType eventType = (argCount >= 1 ? (wxEventType)wxlua_getnumbertype(L, 1) : (wxEventType)wxEVT_NULL);
    // call constructor
...
static int LUACALL wxLua_wxEraseEvent_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxDC dc = NULL
    wxDC * dc = (argCount >= 2 ? (wxDC *)wxluaT_getuserdatatype(L, 2, wxluatype_wxDC) : (wxDC *)NULL);
    // int id = 0
    int id = (argCount >= 1 ? (int)wxlua_getnumbertype(L, 1) : (int)0);
    // call constructor
...
static int LUACALL wxLua_wxQueryNewPaletteEvent_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxWindowID winid = 0
    wxWindowID winid = (argCount >= 1 ? (wxWindowID)wxlua_getnumbertype(L, 1) : (wxWindowID)0);
    // call constructor
...
static int LUACALL wxLua_wxIdleEvent_RequestMore(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool needMore = true
    bool needMore = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxIdleEvent * self = (wxIdleEvent *)wxluaT_getuserdatatype(L, 1, wxluatype_wxIdleEvent);
    // call RequestMore
...
static int LUACALL wxLua_wxContextMenuEvent_constructor(lua_State *L)
{
    ...
    const wxPoint * pt = (argCount >= 3 ? (const wxPoint *)wxluaT_getuserdatatype(L, 3, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
    // wxWindowID winid = 0
...
static int LUACALL wxLua_wxMouseEvent_ButtonDClick(lua_State *L)
{
    ...
    int but = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)wxMOUSE_BTN_ANY);
    // get this
    wxMouseEvent * self = (wxMouseEvent *)wxluaT_getuserdatatype(L, 1, wxluatype_wxMouseEvent);
    // call ButtonDClick
...
static int LUACALL wxLua_wxMouseEvent_constructor(lua_State *L)
{
    ...
    wxEventType mouseEventType = (argCount >= 1 ? (wxEventType)wxlua_getnumbertype(L, 1) : (wxEventType)wxEVT_NULL);
    // call constructor
...
static int LUACALL wxLua_wxMouseCaptureChangedEvent_constructor(lua_State *L)
{
    ...
    wxWindow * gainedCapture = (argCount >= 2 ? (wxWindow *)wxluaT_getuserdatatype(L, 2, wxluatype_wxWindow) : (wxWindow *)NULL);
    // wxWindowID winid = 0
    wxWindowID winid = (argCount >= 1 ? (wxWindowID)wxlua_getnumbertype(L, 1) : (wxWindowID)0);
    // call constructor
...
static int LUACALL wxLua_wxProcessEvent_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int exitcode = 0
    int exitcode = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)0);
    // int pid = 0
    int pid = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)0);
    // int nId = 0
    int nId = (argCount >= 1 ? (int)wxlua_getnumbertype(L, 1) : (int)0);
    // call constructor
...
static int LUACALL wxLua_wxScrollEvent_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int orientation = 0
    int orientation = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)0);
    // int pos = 0
    int pos = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)0);
    // int id = 0
    int id = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)0);
...
static int LUACALL wxLua_wxScrollWinEvent_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int orientation = 0
    int orientation = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)0);
    // int pos = 0
    int pos = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)0);
    // wxEventType commandType = wxEVT_NULL
    wxEventType commandType = (argCount >= 1 ? (wxEventType)wxlua_getnumbertype(L, 1) : (wxEventType)wxEVT_NULL);
    // call constructor
...
static int LUACALL wxLua_wxShowEvent_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool show = false
    bool show = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)false);
    // int winid = 0
    int winid = (argCount >= 1 ? (int)wxlua_getnumbertype(L, 1) : (int)0);
    // call constructor
...
static int LUACALL wxLua_wxIconizeEvent_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool iconized = true
    bool iconized = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // int winid = 0
    int winid = (argCount >= 1 ? (int)wxlua_getnumbertype(L, 1) : (int)0);
    // call constructor
...
static int LUACALL wxLua_wxSetCursorEvent_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxCoord y = 0
    wxCoord y = (argCount >= 2 ? (wxCoord)wxlua_getnumbertype(L, 2) : (wxCoord)0);
    // wxCoord x = 0
    wxCoord x = (argCount >= 1 ? (wxCoord)wxlua_getnumbertype(L, 1) : (wxCoord)0);
    // call constructor
...
static int LUACALL wxLua_wxUpdateUIEvent_constructor(lua_State *L)
{
    ...
    wxWindowID commandId = (argCount >= 1 ? (wxWindowID)wxlua_getnumbertype(L, 1) : (wxWindowID)wxID_ANY);
    // call constructor
...
static int LUACALL wxLua_wxHelpEvent_constructor1(lua_State *L)
{
    ...
    wxHelpEvent::Origin origin = (argCount >= 4 ? (wxHelpEvent::Origin)wxlua_getenumtype(L, 4) : (wxHelpEvent::Origin)wxHelpEvent::Origin_Unknown);
    // const wxPoint pt = wxDefaultPosition
    const wxPoint * pt = (argCount >= 3 ? (const wxPoint *)wxluaT_getuserdatatype(L, 3, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
    // wxWindowID id = 0
    wxWindowID id = (argCount >= 2 ? (wxWindowID)wxlua_getnumbertype(L, 2) : (wxWindowID)0);
    // wxEventType type = wxEVT_NULL
    wxEventType type = (argCount >= 1 ? (wxEventType)wxlua_getnumbertype(L, 1) : (wxEventType)wxEVT_NULL);
    // call constructor
...
static int LUACALL wxLua_wxThreadEvent_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int id = wxID_ANY
    int id = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)wxID_ANY);
    // wxEventType eventType = wxEVT_THREAD
    wxEventType eventType = (argCount >= 1 ? (wxEventType)wxlua_getnumbertype(L, 1) : (wxEventType)wxEVT_THREAD);
    // call constructor
