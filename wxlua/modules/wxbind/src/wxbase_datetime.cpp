...
static int LUACALL wxLua_wxDateTime_Format(lua_State *L)
{
    ...
    wxDateTime::TZ tz = (argCount >= 3 ? (wxDateTime::TZ)wxlua_getenumtype(L, 3) : (wxDateTime::TZ)wxDateTime::Local);
    // wxString format = "%c"
    wxString format = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (wxString)wxString(wxT("%c")));
    // get this
    wxDateTime * self = (wxDateTime *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDateTime);
    // call Format
...
static int LUACALL wxLua_wxDateTime_FromTimezone(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool noDST = false
    bool noDST = (argCount >= 3 ? wxlua_getbooleantype(L, 3) : (bool)false);
...
static int LUACALL wxLua_wxDateTime_FromUTC(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool noDST = false
    bool noDST = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)false);
    // get this
    wxDateTime * self = (wxDateTime *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDateTime);
    // call FromUTC
    // allocate a new object using the copy constructor
...
static int LUACALL wxLua_wxDateTime_GetBeginDST(lua_State *L)
{
    ...
    wxDateTime::Country country = (argCount >= 2 ? (wxDateTime::Country)wxlua_getenumtype(L, 2) : (wxDateTime::Country)wxDateTime::Country_Default);
    // int year = wxDateTime::Inv_Year
    int year = (argCount >= 1 ? (int)wxlua_getnumbertype(L, 1) : (int)wxDateTime::Inv_Year);
    // call GetBeginDST
    // allocate a new object using the copy constructor
...
static int LUACALL wxLua_wxDateTime_GetCentury1(lua_State *L)
{
    ...
    const wxDateTime::TimeZone * tz = (argCount >= 2 ? (const wxDateTime::TimeZone *)wxluaT_getuserdatatype(L, 2, wxluatype_wxDateTime_TimeZone) : (const wxDateTime::TimeZone *)&wxLua_wxDateTime_TimeZone_Local);
    // get this
    wxDateTime * self = (wxDateTime *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDateTime);
    // call GetCentury
...
static int LUACALL wxLua_wxDateTime_GetCurrentMonth(lua_State *L)
{
    ...
    wxDateTime::Calendar cal = (argCount >= 1 ? (wxDateTime::Calendar)wxlua_getenumtype(L, 1) : (wxDateTime::Calendar)wxDateTime::Gregorian);
...
static int LUACALL wxLua_wxDateTime_GetLastMonthDay(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int year = wxDateTime::Inv_Year
    int year = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)wxDateTime::Inv_Year);
    // wxDateTime::Month month = wxDateTime::Inv_Month
    wxDateTime::Month month = (argCount >= 2 ? (wxDateTime::Month)wxlua_getenumtype(L, 2) : (wxDateTime::Month)wxDateTime::Inv_Month);
    // get this
    wxDateTime * self = (wxDateTime *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDateTime);
...
static int LUACALL wxLua_wxDateTime_GetLastWeekDay(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int year = wxDateTime::Inv_Year
    int year = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)wxDateTime::Inv_Year);
    // wxDateTime::Month month = wxDateTime::Inv_Month
    wxDateTime::Month month = (argCount >= 3 ? (wxDateTime::Month)wxlua_getenumtype(L, 3) : (wxDateTime::Month)wxDateTime::Inv_Month);
...
static int LUACALL wxLua_wxDateTime_GetMonthName(lua_State *L)
{
    ...
    wxDateTime::NameFlags flags = (argCount >= 2 ? (wxDateTime::NameFlags)wxlua_getenumtype(L, 2) : (wxDateTime::NameFlags)wxDateTime::Name_Full);
...
static int LUACALL wxLua_wxDateTime_GetNumberOfDays1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxDateTime::Calendar cal = wxDateTime::Gregorian
    wxDateTime::Calendar cal = (argCount >= 3 ? (wxDateTime::Calendar)wxlua_getenumtype(L, 3) : (wxDateTime::Calendar)wxDateTime::Gregorian);
    // int year = wxDateTime::Inv_Year
    int year = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)wxDateTime::Inv_Year);
    // wxDateTime::Month month
    wxDateTime::Month month = (wxDateTime::Month)wxlua_getenumtype(L, 1);
...
static int LUACALL wxLua_wxDateTime_GetNumberOfDays(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxDateTime::Calendar cal = wxDateTime::Gregorian
    wxDateTime::Calendar cal = (argCount >= 2 ? (wxDateTime::Calendar)wxlua_getenumtype(L, 2) : (wxDateTime::Calendar)wxDateTime::Gregorian);
    // int year
    int year = (int)wxlua_getnumbertype(L, 1);
    // call GetNumberOfDays
...
static int LUACALL wxLua_wxDateTime_GetWeek(lua_State *L)
{
    ...
    wxDateTime::WeekDay weekday = (argCount >= 3 ? (wxDateTime::WeekDay)wxlua_getenumtype(L, 3) : (wxDateTime::WeekDay)wxDateTime::Mon);
...
static int LUACALL wxLua_wxDateTime_GetWeekDay(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int year = wxDateTime::Inv_Year
    int year = (argCount >= 5 ? (int)wxlua_getnumbertype(L, 5) : (int)wxDateTime::Inv_Year);
    // wxDateTime::Month month = wxDateTime::Inv_Month
    wxDateTime::Month month = (argCount >= 4 ? (wxDateTime::Month)wxlua_getenumtype(L, 4) : (wxDateTime::Month)wxDateTime::Inv_Month);
    // int n = 1
    int n = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)1);
    // wxDateTime::WeekDay weekday
    wxDateTime::WeekDay weekday = (wxDateTime::WeekDay)wxlua_getenumtype(L, 2);
    // get this
    wxDateTime * self = (wxDateTime *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDateTime);
...
static int LUACALL wxLua_wxDateTime_GetWeekOfMonth(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxDateTime::TimeZone tz = wxLua_wxDateTime_TimeZone_Local
    const wxDateTime::TimeZone * tz = (argCount >= 3 ? (const wxDateTime::TimeZone *)wxluaT_getuserdatatype(L, 3, wxluatype_wxDateTime_TimeZone) : (const wxDateTime::TimeZone *)&wxLua_wxDateTime_TimeZone_Local);
    // wxDateTime::WeekFlags flags = wxDateTime::Monday_First
    wxDateTime::WeekFlags flags = (argCount >= 2 ? (wxDateTime::WeekFlags)wxlua_getenumtype(L, 2) : (wxDateTime::WeekFlags)wxDateTime::Monday_First);
    // get this
    wxDateTime * self = (wxDateTime *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDateTime);
    // call GetWeekOfMonth
...
static int LUACALL wxLua_wxDateTime_IsWestEuropeanCountry(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxDateTime::Country country = wxDateTime::Country_Default
    wxDateTime::Country country = (argCount >= 1 ? (wxDateTime::Country)wxlua_getenumtype(L, 1) : (wxDateTime::Country)wxDateTime::Country_Default);
...
static int LUACALL wxLua_wxDateTime_ParseFormat3(lua_State *L)
{
    ...
    const wxDateTime * dateDef = (argCount >= 4 ? (const wxDateTime *)wxluaT_getuserdatatype(L, 4, wxluatype_wxDateTime) : (const wxDateTime *)&wxDefaultDateTime);
    // wxString format = "%c"
    wxString format = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (wxString)wxString(wxT("%c")));
    // wxString date
    wxString date = wxlua_getwxStringtype(L, 2);
    // get this
    wxDateTime * self = (wxDateTime *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDateTime);
...
static int LUACALL wxLua_wxDateTime_SetToDMY(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int millisec = 0
    int millisec = (argCount >= 8 ? (int)wxlua_getnumbertype(L, 8) : (int)0);
    // int second = 0
    int second = (argCount >= 7 ? (int)wxlua_getnumbertype(L, 7) : (int)0);
    // int minute = 0
    int minute = (argCount >= 6 ? (int)wxlua_getnumbertype(L, 6) : (int)0);
    // int hour = 0
    int hour = (argCount >= 5 ? (int)wxlua_getnumbertype(L, 5) : (int)0);
    // int year = wxDateTime::Inv_Year
    int year = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)wxDateTime::Inv_Year);
    // wxDateTime::Month month = wxDateTime::Inv_Month
    wxDateTime::Month month = (argCount >= 3 ? (wxDateTime::Month)wxlua_getenumtype(L, 3) : (wxDateTime::Month)wxDateTime::Inv_Month);
...
static int LUACALL wxLua_wxDateTimeFromDMY_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int millisec = 0
    int millisec = (argCount >= 7 ? (int)wxlua_getnumbertype(L, 7) : (int)0);
    // int second = 0
    int second = (argCount >= 6 ? (int)wxlua_getnumbertype(L, 6) : (int)0);
    // int minute = 0
    int minute = (argCount >= 5 ? (int)wxlua_getnumbertype(L, 5) : (int)0);
    // int hour = 0
    int hour = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)0);
    // int year = wxDateTime::Inv_Year
    int year = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)wxDateTime::Inv_Year);
    // wxDateTime::Month month = wxDateTime::Inv_Month
    wxDateTime::Month month = (argCount >= 2 ? (wxDateTime::Month)wxlua_getenumtype(L, 2) : (wxDateTime::Month)wxDateTime::Inv_Month);
...
static int LUACALL wxLua_wxTimeSpan_Format(lua_State *L)
{
    ...
    wxString format = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (wxString)wxString(wxT("%H:%M:%S")));
    // get this
    wxTimeSpan * self = (wxTimeSpan *)wxluaT_getuserdatatype(L, 1, wxluatype_wxTimeSpan);
    // call Format
...
static int LUACALL wxLua_wxTimeSpan_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // long milliseconds = 0
    long milliseconds = (argCount >= 4 ? (long)wxlua_getnumbertype(L, 4) : (long)0);
    // long seconds = 0
    long seconds = (argCount >= 3 ? (long)wxlua_getnumbertype(L, 3) : (long)0);
    // long minutes = 0
    long minutes = (argCount >= 2 ? (long)wxlua_getnumbertype(L, 2) : (long)0);
    // long hours
    long hours = (long)wxlua_getnumbertype(L, 1);
    // call constructor
...
static int LUACALL wxLua_wxDateSpan_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int days = 0
    int days = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)0);
    // int weeks = 0
    int weeks = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)0);
    // int months = 0
    int months = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)0);
    // int years = 0
    int years = (argCount >= 1 ? (int)wxlua_getnumbertype(L, 1) : (int)0);
    // call constructor
...
static int LUACALL wxLua_wxStopWatch_Start(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // long t0 = 0
    long t0 = (argCount >= 2 ? (long)wxlua_getnumbertype(L, 2) : (long)0);
    // get this
    wxStopWatch * self = (wxStopWatch *)wxluaT_getuserdatatype(L, 1, wxluatype_wxStopWatch);
    // call Start
    self->Start(t0);
