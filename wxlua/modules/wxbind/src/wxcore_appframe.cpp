...
static int LUACALL wxLua_wxApp_SetUseBestVisual(lua_State *L)
{
    ...
    bool forceTrueColour = (argCount >= 3 ? wxlua_getbooleantype(L, 3) : (bool)false);
    // bool flag
    bool flag = wxlua_getbooleantype(L, 2);
    // get this
    wxApp * self = (wxApp *)wxluaT_getuserdatatype(L, 1, wxluatype_wxApp);
...
static int LUACALL wxLua_wxTopLevelWindow_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 8 ? wxlua_getwxStringtype(L, 8) : (const wxString)wxString(wxFrameNameStr));
...
static int LUACALL wxLua_wxTopLevelWindow_RequestUserAttention(lua_State *L)
{
    ...
    int flags = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)wxUSER_ATTENTION_INFO);
    // get this
    wxTopLevelWindow * self = (wxTopLevelWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxTopLevelWindow);
...
static int LUACALL wxLua_wxTopLevelWindow_ShowFullScreen(lua_State *L)
{
    ...
    long style = (argCount >= 3 ? (long)wxlua_getnumbertype(L, 3) : (long)wxFULLSCREEN_ALL);
    // bool show
...
static int LUACALL wxLua_wxTopLevelWindow_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = wxFrameNameStr
    const wxString name = (argCount >= 7 ? wxlua_getwxStringtype(L, 7) : (const wxString)wxString(wxFrameNameStr));
    // long style = wxDEFAULT_FRAME_STYLE
...
static int LUACALL wxLua_wxFrame_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 8 ? wxlua_getwxStringtype(L, 8) : (const wxString)wxString(wxT("wxFrame")));
    // long style = wxDEFAULT_FRAME_STYLE
    long style = (argCount >= 7 ? (long)wxlua_getnumbertype(L, 7) : (long)wxDEFAULT_FRAME_STYLE);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 6 ? (const wxSize *)wxluaT_getuserdatatype(L, 6, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
...
static int LUACALL wxLua_wxFrame_CreateStatusBar(lua_State *L)
{
    ...
    const wxString name = (argCount >= 5 ? wxlua_getwxStringtype(L, 5) : (const wxString)wxString(wxT("wxStatusBar")));
    // wxWindowID id = wxID_ANY
    wxWindowID id = (argCount >= 4 ? (wxWindowID)wxlua_getnumbertype(L, 4) : (wxWindowID)wxID_ANY);
    // long style = 0
    long style = (argCount >= 3 ? (long)wxlua_getnumbertype(L, 3) : (long)0);
    // int number = 1
...
static int LUACALL wxLua_wxFrame_CreateToolBar1(lua_State *L)
{
    ...
    const wxString name = (argCount >= 4 ? wxlua_getwxStringtype(L, 4) : (const wxString)wxString(wxT("wxToolBar")));
    // wxWindowID id = wxID_ANY
    wxWindowID id = (argCount >= 3 ? (wxWindowID)wxlua_getnumbertype(L, 3) : (wxWindowID)wxID_ANY);
    // long style = wxNO_BORDER | wxTB_HORIZONTAL
    long style = (argCount >= 2 ? (long)wxlua_getnumbertype(L, 2) : (long)wxNO_BORDER | wxTB_HORIZONTAL);
    // get this
    wxFrame * self = (wxFrame *)wxluaT_getuserdatatype(L, 1, wxluatype_wxFrame);
    // call CreateToolBar
...
static int LUACALL wxLua_wxFrame_CreateToolBar(lua_State *L)
{
    ...
    const wxString name = (argCount >= 4 ? wxlua_getwxStringtype(L, 4) : (const wxString)wxString(wxToolBarNameStr));
    // wxWindowID id = wxID_ANY
    wxWindowID id = (argCount >= 3 ? (wxWindowID)wxlua_getnumbertype(L, 3) : (wxWindowID)wxID_ANY);
    // long style = wxTB_DEFAULT_STYLE
    long style = (argCount >= 2 ? (long)wxlua_getnumbertype(L, 2) : (long)wxTB_DEFAULT_STYLE);
    // get this
    wxFrame * self = (wxFrame *)wxluaT_getuserdatatype(L, 1, wxluatype_wxFrame);
    // call CreateToolBar
    wxToolBar* returns = (wxToolBar*)self->CreateToolBar(style, id, name);
...
static int LUACALL wxLua_wxFrame_PopStatusText(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int number = 0
    int number = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)0);
    // get this
    wxFrame * self = (wxFrame *)wxluaT_getuserdatatype(L, 1, wxluatype_wxFrame);
    // call PopStatusText
...
static int LUACALL wxLua_wxFrame_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxFrame"
    const wxString name = (argCount >= 7 ? wxlua_getwxStringtype(L, 7) : (const wxString)wxString(wxT("wxFrame")));
    // long style = wxDEFAULT_FRAME_STYLE
    long style = (argCount >= 6 ? (long)wxlua_getnumbertype(L, 6) : (long)wxDEFAULT_FRAME_STYLE);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 5 ? (const wxSize *)wxluaT_getuserdatatype(L, 5, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
...
static int LUACALL wxLua_wxMiniFrame_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 8 ? wxlua_getwxStringtype(L, 8) : (const wxString)wxString(wxT("wxMiniFrame")));
    // long style = wxDEFAULT_FRAME_STYLE
    long style = (argCount >= 7 ? (long)wxlua_getnumbertype(L, 7) : (long)wxDEFAULT_FRAME_STYLE);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 6 ? (const wxSize *)wxluaT_getuserdatatype(L, 6, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
...
static int LUACALL wxLua_wxMiniFrame_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxMiniFrame"
    const wxString name = (argCount >= 7 ? wxlua_getwxStringtype(L, 7) : (const wxString)wxString(wxT("wxMiniFrame")));
    // long style = wxDEFAULT_FRAME_STYLE
    long style = (argCount >= 6 ? (long)wxlua_getnumbertype(L, 6) : (long)wxDEFAULT_FRAME_STYLE);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 5 ? (const wxSize *)wxluaT_getuserdatatype(L, 5, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
...
static int LUACALL wxLua_wxStatusBarPane_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int width = 0
    int width = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)0);
    // int style = wxSB_NORMAL
    int style = (argCount >= 1 ? (int)wxlua_getnumbertype(L, 1) : (int)wxSB_NORMAL);
    // call constructor
...
static int LUACALL wxLua_wxStatusBar_Create(lua_State *L)
{
    ...
    long style = (argCount >= 4 ? (long)wxlua_getnumbertype(L, 4) : (long)wxST_SIZEGRIP);
    // wxWindowID id
    wxWindowID id = (wxWindowID)wxlua_getnumbertype(L, 3);
    // wxWindow parent
    wxWindow * parent = (wxWindow *)wxluaT_getuserdatatype(L, 2, wxluatype_wxWindow);
...
static int LUACALL wxLua_wxStatusBar_GetStatusText(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int ir = 0
    int ir = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)0);
    // get this
    wxStatusBar * self = (wxStatusBar *)wxluaT_getuserdatatype(L, 1, wxluatype_wxStatusBar);
    // call GetStatusText
...
static int LUACALL wxLua_wxStatusBar_PopStatusText(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int field = 0
    int field = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)0);
    // get this
    wxStatusBar * self = (wxStatusBar *)wxluaT_getuserdatatype(L, 1, wxluatype_wxStatusBar);
    // call PopStatusText
...
static int LUACALL wxLua_wxStatusBar_PushStatusText(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int field = 0
    int field = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)0);
...
static int LUACALL wxLua_wxStatusBar_SetStatusText(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int i = 0
    int i = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)0);
    // const wxString text
    const wxString text = wxlua_getwxStringtype(L, 2);
    // get this
    wxStatusBar * self = (wxStatusBar *)wxluaT_getuserdatatype(L, 1, wxluatype_wxStatusBar);
...
static int LUACALL wxLua_wxStatusBar_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxStatusBar"
    const wxString name = (argCount >= 4 ? wxlua_getwxStringtype(L, 4) : (const wxString)wxString(wxT("wxStatusBar")));
    // long style = wxST_SIZEGRIP
    long style = (argCount >= 3 ? (long)wxlua_getnumbertype(L, 3) : (long)wxST_SIZEGRIP);
    // wxWindowID id
    wxWindowID id = (wxWindowID)wxlua_getnumbertype(L, 2);
    // wxWindow parent
    wxWindow * parent = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
