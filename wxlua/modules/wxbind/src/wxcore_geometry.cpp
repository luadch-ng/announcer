...
static int LUACALL wxLua_wxPoint2DInt_constructor(lua_State *L)
{
    ...
    // wxInt32 y = 0
    wxInt32 y = (argCount >= 2 ? (wxInt32)wxlua_getnumbertype(L, 2) : (wxInt32)0);
    // wxInt32 x = 0
    wxInt32 x = (argCount >= 1 ? (wxInt32)wxlua_getnumbertype(L, 1) : (wxInt32)0);
    // call constructor
...
static int LUACALL wxLua_wxPoint2DDouble_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxDouble y = 0
    wxDouble y = (argCount >= 2 ? (wxDouble)wxlua_getnumbertype(L, 2) : (wxDouble)0);
    // wxDouble x = 0
    wxDouble x = (argCount >= 1 ? (wxDouble)wxlua_getnumbertype(L, 1) : (wxDouble)0);
    // call constructor
...
static int LUACALL wxLua_wxRect2DDouble_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxDouble h = 0
    wxDouble h = (argCount >= 4 ? (wxDouble)wxlua_getnumbertype(L, 4) : (wxDouble)0);
    // wxDouble w = 0
    wxDouble w = (argCount >= 3 ? (wxDouble)wxlua_getnumbertype(L, 3) : (wxDouble)0);
    // wxDouble y = 0
    wxDouble y = (argCount >= 2 ? (wxDouble)wxlua_getnumbertype(L, 2) : (wxDouble)0);
    // wxDouble x = 0
    wxDouble x = (argCount >= 1 ? (wxDouble)wxlua_getnumbertype(L, 1) : (wxDouble)0);
...
static int LUACALL wxLua_wxRect2DInt_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxInt32 h = 0
    wxInt32 h = (argCount >= 4 ? (wxInt32)wxlua_getnumbertype(L, 4) : (wxInt32)0);
    // wxInt32 w = 0
    wxInt32 w = (argCount >= 3 ? (wxInt32)wxlua_getnumbertype(L, 3) : (wxInt32)0);
    // wxInt32 y = 0
    wxInt32 y = (argCount >= 2 ? (wxInt32)wxlua_getnumbertype(L, 2) : (wxInt32)0);
    // wxInt32 x = 0
    wxInt32 x = (argCount >= 1 ? (wxInt32)wxlua_getnumbertype(L, 1) : (wxInt32)0);
