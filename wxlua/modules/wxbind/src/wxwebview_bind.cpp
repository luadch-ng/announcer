...
static int LUACALL wxLua_wxWebViewFactory_Create1(lua_State *L)
{
    ...
    const wxString name = (argCount >= 8 ? wxlua_getwxStringtype(L, 8) : (const wxString)wxString(wxWebViewNameStr));
    // long style = 0
    ...
    const wxString url = (argCount >= 4 ? wxlua_getwxStringtype(L, 4) : (const wxString)wxString(wxWebViewDefaultURLStr));
    // wxWindowID id
...
static int LUACALL wxLua_wxWebView_Find(lua_State *L)
{
    ...
    int flags = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)wxWEBVIEW_FIND_DEFAULT);
    // const wxString text
...
static int LUACALL wxLua_wxWebView_New1(lua_State *L)
{
    ...
    const wxString backend = (argCount >= 6 ? wxlua_getwxStringtype(L, 6) : (const wxString)wxString(wxWebViewBackendDefault));
    // const wxSize size = wxDefaultSize
    ...
    // const wxString url = wxWebViewDefaultURLStr
    const wxString url = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxWebViewDefaultURLStr));
    // wxWindowID id
...
static int LUACALL wxLua_wxWebView_New(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString backend = wxWebViewBackendDefault
    const wxString backend = (argCount >= 1 ? wxlua_getwxStringtype(L, 1) : (const wxString)wxString(wxWebViewBackendDefault));
    // call New
...
static int LUACALL wxLua_wxWebView_Reload(lua_State *L)
{
    ...
    wxWebViewReloadFlags flags = (argCount >= 2 ? (wxWebViewReloadFlags)wxlua_getenumtype(L, 2) : (wxWebViewReloadFlags)wxWEBVIEW_RELOAD_DEFAULT);
    // get this
    wxWebView * self = (wxWebView *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWebView);
    // call Reload
    self->Reload(flags);
