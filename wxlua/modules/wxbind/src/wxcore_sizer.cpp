...
static int LUACALL wxLua_wxSizerFlags_Border1(lua_State *L)
{
    ...
    // int direction = wxALL
    int direction = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)wxALL);
    // get this
    wxSizerFlags * self = (wxSizerFlags *)wxluaT_getuserdatatype(L, 1, wxluatype_wxSizerFlags);
    // call Border
...
static int LUACALL wxLua_wxSizerFlags_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int proportion = 0
    int proportion = (argCount >= 1 ? (int)wxlua_getnumbertype(L, 1) : (int)0);
    // call constructor
...
static int LUACALL wxLua_wxSizer_Add2(lua_State *L)
{
    ...
    wxObject * userData = (argCount >= 7 ? (wxObject *)wxluaT_getuserdatatype(L, 7, wxluatype_wxObject) : (wxObject *)NULL);
    // int border = 0
    int border = (argCount >= 6 ? (int)wxlua_getnumbertype(L, 6) : (int)0);
    // int flag = 0
    int flag = (argCount >= 5 ? (int)wxlua_getnumbertype(L, 5) : (int)0);
    // int proportion = 0
    int proportion = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)0);
    // int height
    int height = (int)wxlua_getnumbertype(L, 3);
    // int width
    int width = (int)wxlua_getnumbertype(L, 2);
...
static int LUACALL wxLua_wxSizer_Add1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxObject userData = NULL
    wxObject * userData = (argCount >= 6 ? (wxObject *)wxluaT_getuserdatatype(L, 6, wxluatype_wxObject) : (wxObject *)NULL);
    // int border = 0
    int border = (argCount >= 5 ? (int)wxlua_getnumbertype(L, 5) : (int)0);
    // int flag = 0
    int flag = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)0);
    // int proportion = 0
    int proportion = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)0);
    // wxSizer sizer
    wxSizer * sizer = (wxSizer *)wxluaT_getuserdatatype(L, 2, wxluatype_wxSizer);
    if (wxluaO_isgcobject(L, userData)) wxluaO_undeletegcobject(L, userData);
    // get this
...
static int LUACALL wxLua_wxSizer_AddStretchSpacer(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int prop = 1
    int prop = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)1);
    // get this
    wxSizer * self = (wxSizer *)wxluaT_getuserdatatype(L, 1, wxluatype_wxSizer);
...
static int LUACALL wxLua_wxSizer_Clear(lua_State *L)
{
    ...
    bool delete_windows = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)false);
    // get this
    wxSizer * self = (wxSizer *)wxluaT_getuserdatatype(L, 1, wxluatype_wxSizer);
    // call Clear
...
static int LUACALL wxLua_wxSizer_GetItem1(lua_State *L)
{
    ...
    bool recursive = (argCount >= 3 ? wxlua_getbooleantype(L, 3) : (bool)false);
    // wxSizer sizer
    wxSizer * sizer = (wxSizer *)wxluaT_getuserdatatype(L, 2, wxluatype_wxSizer);
    // get this
    wxSizer * self = (wxSizer *)wxluaT_getuserdatatype(L, 1, wxluatype_wxSizer);
...
static int LUACALL wxLua_wxSizer_Insert2(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxObject userData = NULL
    wxObject * userData = (argCount >= 8 ? (wxObject *)wxluaT_getuserdatatype(L, 8, wxluatype_wxObject) : (wxObject *)NULL);
    // int border = 0
    int border = (argCount >= 7 ? (int)wxlua_getnumbertype(L, 7) : (int)0);
    // int flag = 0
    int flag = (argCount >= 6 ? (int)wxlua_getnumbertype(L, 6) : (int)0);
    // int proportion = 0
    int proportion = (argCount >= 5 ? (int)wxlua_getnumbertype(L, 5) : (int)0);
    // int height
...
static int LUACALL wxLua_wxSizer_InsertStretchSpacer(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int prop = 1
    int prop = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)1);
    // size_t index
    size_t index = (size_t)wxlua_getuintegertype(L, 2);
    // get this
    wxSizer * self = (wxSizer *)wxluaT_getuserdatatype(L, 1, wxluatype_wxSizer);
...
static int LUACALL wxLua_wxSizer_Replace1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool recursive = false
    bool recursive = (argCount >= 4 ? wxlua_getbooleantype(L, 4) : (bool)false);
    // wxSizer newsz
...
static int LUACALL wxLua_wxSizer_Show2(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool show = true
    bool show = (argCount >= 3 ? wxlua_getbooleantype(L, 3) : (bool)true);
    // size_t index
    size_t index = (size_t)wxlua_getuintegertype(L, 2);
    // get this
    wxSizer * self = (wxSizer *)wxluaT_getuserdatatype(L, 1, wxluatype_wxSizer);
...
static int LUACALL wxLua_wxFlexGridSizer_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int hgap = 0
    int hgap = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)0);
    // int vgap = 0
    int vgap = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)0);
    // int cols
    int cols = (int)wxlua_getnumbertype(L, 2);
    // int rows
...
static int LUACALL wxLua_wxGridBagSizer_Add2(lua_State *L)
{
    ...
    const wxGBSpan * span = (argCount >= 5 ? (const wxGBSpan *)wxluaT_getuserdatatype(L, 5, wxluatype_wxGBSpan) : (const wxGBSpan *)&wxDefaultSpan);
...
static int LUACALL wxLua_wxGridBagSizer_Add1(lua_State *L)
{
    ...
    int flag = (argCount >= 5 ? (int)wxlua_getnumbertype(L, 5) : (int)0);
    // const wxGBSpan span = wxDefaultSpan
    const wxGBSpan * span = (argCount >= 4 ? (const wxGBSpan *)wxluaT_getuserdatatype(L, 4, wxluatype_wxGBSpan) : (const wxGBSpan *)&wxDefaultSpan);
    // const wxGBPosition pos
...
static int LUACALL wxLua_wxGridBagSizer_CheckForIntersection1(lua_State *L)
{
    ...
    wxGBSizerItem * excludeItem = (argCount >= 4 ? (wxGBSizerItem *)wxluaT_getuserdatatype(L, 4, wxluatype_wxGBSizerItem) : (wxGBSizerItem *)NULL);
    // const wxGBSpan span
...
static int LUACALL wxLua_wxGridBagSizer_CheckForIntersection(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxGBSizerItem excludeItem = NULL
    wxGBSizerItem * excludeItem = (argCount >= 3 ? (wxGBSizerItem *)wxluaT_getuserdatatype(L, 3, wxluatype_wxGBSizerItem) : (wxGBSizerItem *)NULL);
    // wxGBSizerItem item
    wxGBSizerItem * item = (wxGBSizerItem *)wxluaT_getuserdatatype(L, 2, wxluatype_wxGBSizerItem);
    // get this
    wxGridBagSizer * self = (wxGridBagSizer *)wxluaT_getuserdatatype(L, 1, wxluatype_wxGridBagSizer);
...
static int LUACALL wxLua_wxGridBagSizer_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int hgap = 0
    int hgap = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)0);
    // int vgap = 0
    int vgap = (argCount >= 1 ? (int)wxlua_getnumbertype(L, 1) : (int)0);
    // call constructor
...
static int LUACALL wxLua_wxGBPosition_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int col = 0
    int col = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)0);
    // int row = 0
    int row = (argCount >= 1 ? (int)wxlua_getnumbertype(L, 1) : (int)0);
    // call constructor
...
static int LUACALL wxLua_wxGBSpan_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int colspan = 1
    int colspan = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)1);
    // int rowspan = 1
    int rowspan = (argCount >= 1 ? (int)wxlua_getnumbertype(L, 1) : (int)1);
    // call constructor
...
static int LUACALL wxLua_wxWrapSizer_constructor(lua_State *L)
{
    ...
    int flags = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)wxWRAPSIZER_DEFAULT_FLAGS);
    // int orient = wxHORIZONTAL
    int orient = (argCount >= 1 ? (int)wxlua_getnumbertype(L, 1) : (int)wxHORIZONTAL);
    // call constructor
...
static int LUACALL wxLua_wxIndividualLayoutConstraint_Above(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int margin = 0
    int margin = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)0);
    // wxWindow otherWin
...
static int LUACALL wxLua_wxIndividualLayoutConstraint_SameAs(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int margin = 0
    int margin = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)0);
    // wxEdge edge
    wxEdge edge = (wxEdge)wxlua_getenumtype(L, 3);
    // wxWindow otherWin
    wxWindow * otherWin = (wxWindow *)wxluaT_getuserdatatype(L, 2, wxluatype_wxWindow);
...
static int LUACALL wxLua_wxIndividualLayoutConstraint_Set(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int margin = 0
    int margin = (argCount >= 6 ? (int)wxlua_getnumbertype(L, 6) : (int)0);
    // int value = 0
    int value = (argCount >= 5 ? (int)wxlua_getnumbertype(L, 5) : (int)0);
    // wxEdge otherEdge
