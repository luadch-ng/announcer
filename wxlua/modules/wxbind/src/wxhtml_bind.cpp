...
static int LUACALL wxLua_wxHtmlCell_GetLink(lua_State *L)
{
    ...
    // int y = 0
    int y = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)0);
    // int x = 0
    int x = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)0);
    // get this
    wxHtmlCell * self = (wxHtmlCell *)wxluaT_getuserdatatype(L, 1, wxluatype_wxHtmlCell);
    // call GetLink
...
static int LUACALL wxLua_wxHtmlWidgetCell_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int w = 0
    int w = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)0);
    // wxWindow wnd
...
static int LUACALL wxLua_wxHtmlContainerCell_SetIndent(lua_State *L)
{
    ...
    int units = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)wxHTML_UNITS_PIXELS);
    // int what
...
static int LUACALL wxLua_wxHtmlContainerCell_SetMinHeight(lua_State *L)
{
    ...
    int align = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)wxHTML_ALIGN_TOP);
    // int h
...
static int LUACALL wxLua_wxHtmlContainerCell_SetWidthFloat1(lua_State *L)
{
    ...
    double pixel_scale = (argCount >= 3 ? (double)wxlua_getnumbertype(L, 3) : (double)1.0);
    // const wxHtmlTag tag
    const wxHtmlTag * tag = (const wxHtmlTag *)wxluaT_getuserdatatype(L, 2, wxluatype_wxHtmlTag);
    // get this
    wxHtmlContainerCell * self = (wxHtmlContainerCell *)wxluaT_getuserdatatype(L, 1, wxluatype_wxHtmlContainerCell);
...
static int LUACALL wxLua_wxHtmlColourCell_constructor(lua_State *L)
{
    ...
    int flags = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)wxHTML_CLR_FOREGROUND);
    // const wxColour clr
...
static int LUACALL wxLua_wxHtmlLinkInfo_constructor(lua_State *L)
{
    ...
    const wxString target = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (const wxString)wxString(wxEmptyString));
    // const wxString href
...
static int LUACALL wxLua_wxHtmlTag_GetParam(lua_State *L)
{
    ...
    bool with_commas = (argCount >= 3 ? wxlua_getbooleantype(L, 3) : (bool)false);
    // const wxString par
...
static int LUACALL wxLua_wxHtmlWindow_ReadCustomization(lua_State *L)
{
    ...
    wxString path = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (wxString)wxString(wxEmptyString));
    // wxConfigBase cfg
...
static int LUACALL wxLua_wxHtmlWindow_constructor(lua_State *L)
{
    ...
    const wxString name = (argCount >= 6 ? wxlua_getwxStringtype(L, 6) : (const wxString)wxString(wxT("wxHtmlWindow")));
    // long style = wxHW_SCROLLBAR_AUTO
    long style = (argCount >= 5 ? (long)wxlua_getnumbertype(L, 5) : (long)wxHW_SCROLLBAR_AUTO);
...
static int LUACALL wxLua_wxLuaHtmlWinTagEvent_SetParseInnerCalled(lua_State *L)
{
    ...
    bool fParseInnerCalled = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxLuaHtmlWinTagEvent * self = (wxLuaHtmlWinTagEvent *)wxluaT_getuserdatatype(L, 1, wxluatype_wxLuaHtmlWinTagEvent);
...
static int LUACALL wxLua_wxSimpleHtmlListBox_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 9 ? wxlua_getwxStringtype(L, 9) : (const wxString)wxString(wxT("wxSimpleHtmlListBox")));
    ...
    long style = (argCount >= 7 ? (long)wxlua_getnumbertype(L, 7) : (long)wxHLB_DEFAULT_STYLE);
...
static int LUACALL wxLua_wxSimpleHtmlListBox_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxSimpleHtmlListBox"
    const wxString name = (argCount >= 8 ? wxlua_getwxStringtype(L, 8) : (const wxString)wxString(wxT("wxSimpleHtmlListBox")));
    // const wxValidator validator = wxDefaultValidator
    ...
    // long style = wxHLB_DEFAULT_STYLE
    long style = (argCount >= 6 ? (long)wxlua_getnumbertype(L, 6) : (long)wxHLB_DEFAULT_STYLE);
    // const wxArrayString choices
...
static int LUACALL wxLua_wxHtmlDCRenderer_Render1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int to = INT_MAX
    int to = (argCount >= 7 ? (int)wxlua_getnumbertype(L, 7) : (int)INT_MAX);
    // int dont_render = false
    int dont_render = (argCount >= 6 ? (int)wxlua_getnumbertype(L, 6) : (int)false);
    // int from = 0
    int from = (argCount >= 5 ? (int)wxlua_getnumbertype(L, 5) : (int)0);
    // wxArrayInt known_pagebreaks
...
static int LUACALL wxLua_wxHtmlDCRenderer_Render(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int to = INT_MAX
    int to = (argCount >= 5 ? (int)wxlua_getnumbertype(L, 5) : (int)INT_MAX);
    // int from = 0
    int from = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)0);
    // int y
    int y = (int)wxlua_getnumbertype(L, 3);
    // int x
    int x = (int)wxlua_getnumbertype(L, 2);
...
static int LUACALL wxLua_wxHtmlDCRenderer_SetHtmlText(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool isdir = true
    bool isdir = (argCount >= 4 ? wxlua_getbooleantype(L, 4) : (bool)true);
    // const wxString basepath = wxEmptyString
    const wxString basepath = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxEmptyString));
    // const wxString html
...
static int LUACALL wxLua_wxHtmlDCRenderer_SetStandardFonts(lua_State *L)
{
    ...
    const wxString fixed_face = (argCount >= 4 ? wxlua_getwxStringtype(L, 4) : (const wxString)wxString(wxEmptyString));
    // const wxString normal_face = wxEmptyString
    const wxString normal_face = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxEmptyString));
    // int size = -1
    int size = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)-1);
    // get this
    wxHtmlDCRenderer * self = (wxHtmlDCRenderer *)wxluaT_getuserdatatype(L, 1, wxluatype_wxHtmlDCRenderer);
...
static int LUACALL wxLua_wxHtmlEasyPrinting_SetFooter(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int pg = wxPAGE_ALL
    int pg = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)wxPAGE_ALL);
...
static int LUACALL wxLua_wxHtmlEasyPrinting_constructor(lua_State *L)
{
    ...
    wxFrame * parent_frame = (argCount >= 2 ? (wxFrame *)wxluaT_getuserdatatype(L, 2, wxluatype_wxFrame) : (wxFrame *)NULL);
    // const wxString name = "Printing"
    const wxString name = (argCount >= 1 ? wxlua_getwxStringtype(L, 1) : (const wxString)wxString(wxT("Printing")));
    // call constructor
...
static int LUACALL wxLua_wxHtmlPrintout_SetMargins(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // float spaces = 5
    float spaces = (argCount >= 6 ? (float)wxlua_getnumbertype(L, 6) : (float)5);
    // float right = 25.2
    float right = (argCount >= 5 ? (float)wxlua_getnumbertype(L, 5) : (float)25.2);
    // float left = 25.2
    float left = (argCount >= 4 ? (float)wxlua_getnumbertype(L, 4) : (float)25.2);
    // float bottom = 25.2
    float bottom = (argCount >= 3 ? (float)wxlua_getnumbertype(L, 3) : (float)25.2);
    // float top = 25.2
    float top = (argCount >= 2 ? (float)wxlua_getnumbertype(L, 2) : (float)25.2);
    // get this
    wxHtmlPrintout * self = (wxHtmlPrintout *)wxluaT_getuserdatatype(L, 1, wxluatype_wxHtmlPrintout);
    // call SetMargins
...
static int LUACALL wxLua_wxHtmlPrintout_constructor(lua_State *L)
{
    ...
    const wxString title = (argCount >= 1 ? wxlua_getwxStringtype(L, 1) : (const wxString)wxString(wxT("Printout")));
    // call constructor
...
static int LUACALL wxLua_wxHtmlHelpController_UseConfig(lua_State *L)
{
    ...
    const wxString rootpath = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxEmptyString));
    // wxConfigBase config
...
static int LUACALL wxLua_wxHtmlHelpController_constructor(lua_State *L)
{
    ...
    int style = (argCount >= 1 ? (int)wxlua_getnumbertype(L, 1) : (int)wxHF_DEFAULT_STYLE);
    // call constructor
