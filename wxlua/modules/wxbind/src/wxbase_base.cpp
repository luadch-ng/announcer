...
static int LUACALL wxLua_wxLog_EnableLogging(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool doIt = true
    bool doIt = (argCount >= 1 ? wxlua_getbooleantype(L, 1) : (bool)true);
    // call EnableLogging
...
static int LUACALL wxLua_wxLog_SetRepetitionCounting(lua_State *L)
{
    ...
    bool bRepetCounting = (argCount >= 1 ? wxlua_getbooleantype(L, 1) : (bool)true);
...
static int LUACALL wxLua_wxLog_SetVerbose(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool bVerbose = true
    bool bVerbose = (argCount >= 1 ? wxlua_getbooleantype(L, 1) : (bool)true);
    // call SetVerbose
...
static int LUACALL wxLua_wxDynamicLibrary_CanonicalizeName(lua_State *L)
{
    ...
    wxDynamicLibraryCategory cat = (argCount >= 2 ? (wxDynamicLibraryCategory)wxlua_getenumtype(L, 2) : (wxDynamicLibraryCategory)wxDL_LIBRARY);
    // const wxString name
    const wxString name = wxlua_getwxStringtype(L, 1);
...
static int LUACALL wxLua_wxDynamicLibrary_CanonicalizePluginName(lua_State *L)
{
    ...
    wxPluginCategory cat = (argCount >= 2 ? (wxPluginCategory)wxlua_getenumtype(L, 2) : (wxPluginCategory)wxDL_PLUGIN_GUI);
    // const wxString name
    const wxString name = wxlua_getwxStringtype(L, 1);
...
static int LUACALL wxLua_wxDynamicLibrary_Load(lua_State *L)
{
    ...
    int flags = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)wxDL_DEFAULT);
...
static int LUACALL wxLua_wxDynamicLibrary_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int flags = wxDL_DEFAULT
    int flags = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)wxDL_DEFAULT);
    // const wxString libname
...
static int LUACALL wxLua_wxRegEx_Compile(lua_State *L)
{
    ...
    int flags = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)wxRE_DEFAULT);
...
static int LUACALL wxLua_wxRegEx_GetMatch(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // size_t index = 0
    size_t index = (argCount >= 3 ? (size_t)wxlua_getuintegertype(L, 3) : (size_t)0);
    // const wxString text
...
static int LUACALL wxLua_wxRegEx_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int flags = wxRE_DEFAULT
    int flags = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)wxRE_DEFAULT);
    // const wxString expr
...
static int LUACALL wxLua_wxEventLoopBase_Exit(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int rc = 0
    int rc = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)0);
    // get this
    wxEventLoopBase * self = (wxEventLoopBase *)wxluaT_getuserdatatype(L, 1, wxluatype_wxEventLoopBase);
    // call Exit
    self->Exit(rc);
...
static int LUACALL wxLua_wxEvent_Skip(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool skip = true
    bool skip = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxEvent * self = (wxEvent *)wxluaT_getuserdatatype(L, 1, wxluatype_wxEvent);
    // call Skip
    self->Skip(skip);
...
static int LUACALL wxLua_wxVersionInfo_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString copyright = ""
    const wxString copyright = (argCount >= 6 ? wxlua_getwxStringtype(L, 6) : (const wxString)wxString(wxEmptyString));
    // const wxString description = ""
    const wxString description = (argCount >= 5 ? wxlua_getwxStringtype(L, 5) : (const wxString)wxString(wxEmptyString));
    // int micro = 0
    int micro = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)0);
    // int minor = 0
    int minor = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)0);
    // int major = 0
    int major = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)0);
    // const wxString name = ""
    const wxString name = (argCount >= 1 ? wxlua_getwxStringtype(L, 1) : (const wxString)wxString(wxEmptyString));
    // call constructor
...
static int LUACALL wxLua_wxMsgCatalog_GetString1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString ct = ""
    const wxString ct = (argCount >= 4 ? wxlua_getwxStringtype(L, 4) : (const wxString)wxString(wxEmptyString));
    // unsigned int n = UINT_MAX
    unsigned int n = (argCount >= 3 ? (unsigned int)wxlua_getuintegertype(L, 3) : (unsigned int)UINT_MAX);
    // const wxString sz
...
static int LUACALL wxLua_wxTranslations_AddCatalog(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxLanguage msgIdLanguage = wxLANGUAGE_ENGLISH_US
    wxLanguage msgIdLanguage = (argCount >= 3 ? (wxLanguage)wxlua_getenumtype(L, 3) : (wxLanguage)wxLANGUAGE_ENGLISH_US);
    // const wxString domain
    const wxString domain = wxlua_getwxStringtype(L, 2);
    // get this
    wxTranslations * self = (wxTranslations *)wxluaT_getuserdatatype(L, 1, wxluatype_wxTranslations);
...
static int LUACALL wxLua_wxTranslations_GetBestTranslation1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString msgIdLanguage = "en"
    const wxString msgIdLanguage = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxT("en")));
    // const wxString domain
    const wxString domain = wxlua_getwxStringtype(L, 2);
    // get this
    wxTranslations * self = (wxTranslations *)wxluaT_getuserdatatype(L, 1, wxluatype_wxTranslations);
...
static int LUACALL wxLua_wxTranslations_GetHeaderValue(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString domain = ""
    const wxString domain = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxEmptyString));
...
static int LUACALL wxLua_wxTranslations_GetTranslatedString3(lua_State *L)
{
    ...
    const wxString context = (argCount >= 5 ? wxlua_getwxStringtype(L, 5) : (const wxString)wxString(wxEmptyString));
    // const wxString domain = ""
    const wxString domain = (argCount >= 4 ? wxlua_getwxStringtype(L, 4) : (const wxString)wxString(wxEmptyString));
    // unsigned int n
...
static int LUACALL wxLua_wxTranslations_GetTranslatedString2(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString context = ""
    const wxString context = (argCount >= 4 ? wxlua_getwxStringtype(L, 4) : (const wxString)wxString(wxEmptyString));
    // const wxString domain = ""
    const wxString domain = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxEmptyString));
    // const wxString origString
    const wxString origString = wxlua_getwxStringtype(L, 2);
...
static int LUACALL wxLua_wxLocale_GetHeaderValue(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString szDomain = ""
    const wxString szDomain = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxEmptyString));
...
static int LUACALL wxLua_wxLocale_GetString3(lua_State *L)
{
    ...
    wxString  szDomain = (argCount >= 5 ? wxlua_getwxStringtype(L, 5) : (wxString )wxString(wxEmptyString));
    // size_t n
...
static int LUACALL wxLua_wxLocale_GetString2(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString szDomain = ""
    const wxString szDomain = (argCount >= 5 ? wxlua_getwxStringtype(L, 5) : (const wxString)wxString(wxEmptyString));
    // size_t n
    size_t n = (size_t)wxlua_getuintegertype(L, 4);
    // const wxString szOrigString2
    const wxString szOrigString2 = wxlua_getwxStringtype(L, 3);
...
static int LUACALL wxLua_wxLocale_GetString1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxChar szDomain = NULL
    wxString  szDomain = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (wxString )wxString(wxEmptyString));
    // const wxString szOrigString
    const wxString szOrigString = wxlua_getwxStringtype(L, 2);
    // get this
    wxLocale * self = (wxLocale *)wxluaT_getuserdatatype(L, 1, wxluatype_wxLocale);
...
static int LUACALL wxLua_wxLocale_Init2(lua_State *L)
{
    ...
    int flags = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)wxLOCALE_LOAD_DEFAULT);
    // int language = wxLANGUAGE_DEFAULT
    int language = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)wxLANGUAGE_DEFAULT);
    // get this
    wxLocale * self = (wxLocale *)wxluaT_getuserdatatype(L, 1, wxluatype_wxLocale);
    // call Init
...
static int LUACALL wxLua_wxLocale_Init1(lua_State *L)
{
    ...
    bool bLoadDefault = (argCount >= 5 ? wxlua_getbooleantype(L, 5) : (bool)true);
    // const wxString szLocale = ""
    const wxString szLocale = (argCount >= 4 ? wxlua_getwxStringtype(L, 4) : (const wxString)wxString(wxEmptyString));
    // const wxString szShort = ""
    const wxString szShort = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxEmptyString));
...
static int LUACALL wxLua_wxLocale_Init(lua_State *L)
{
    ...
    bool bConvertEncoding = (argCount >= 6 ? wxlua_getbooleantype(L, 6) : (bool)false);
    // bool bLoadDefault = true
    bool bLoadDefault = (argCount >= 5 ? wxlua_getbooleantype(L, 5) : (bool)true);
    // const wxString szLocale = ""
    const wxString szLocale = (argCount >= 4 ? wxlua_getwxStringtype(L, 4) : (const wxString)wxString(wxEmptyString));
...
static int LUACALL wxLua_wxLocale_constructor3(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int flags = wxLOCALE_LOAD_DEFAULT
    int flags = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)wxLOCALE_LOAD_DEFAULT);
    // int language
...
static int LUACALL wxLua_wxLocale_constructor2(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool bLoadDefault = true
    bool bLoadDefault = (argCount >= 4 ? wxlua_getbooleantype(L, 4) : (bool)true);
    // const wxString szLocale = ""
    const wxString szLocale = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxEmptyString));
    // const wxString szShort = ""
    const wxString szShort = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (const wxString)wxString(wxEmptyString));
    // const wxString szName
...
static int LUACALL wxLua_wxLocale_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool bConvertEncoding = false
    bool bConvertEncoding = (argCount >= 5 ? wxlua_getbooleantype(L, 5) : (bool)false);
    // bool bLoadDefault = true
    bool bLoadDefault = (argCount >= 4 ? wxlua_getbooleantype(L, 4) : (bool)true);
    // const wxString szLocale = ""
    const wxString szLocale = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxEmptyString));
