...
static int LUACALL wxLua_wxStyledTextCtrl_AddTextRaw(lua_State *L)
{
    ...
    // int length = -1
    int length = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)-1);
    // const char text
...
static int LUACALL wxLua_wxStyledTextCtrl_BraceMatch(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int maxReStyle = 0
    int maxReStyle = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)0);
    // int pos
    int pos = (int)wxlua_getnumbertype(L, 2);
    // get this
    wxStyledTextCtrl * self = (wxStyledTextCtrl *)wxluaT_getuserdatatype(L, 1, wxluatype_wxStyledTextCtrl);
...
static int LUACALL wxLua_wxStyledTextCtrl_GetCurLineRaw(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int linePos = NULL
    int * linePos = (argCount >= 2 ? (int *)wxlua_touserdata(L, 2) : (int *)NULL);
    // get this
    wxStyledTextCtrl * self = (wxStyledTextCtrl *)wxluaT_getuserdatatype(L, 1, wxluatype_wxStyledTextCtrl);
    // call GetCurLineRaw
...
static int LUACALL wxLua_wxStyledTextCtrl_GetPropertyInt(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int defaultValue = 0
    int defaultValue = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)0);
    // const wxString key
    const wxString key = wxlua_getwxStringtype(L, 2);
    // get this
    wxStyledTextCtrl * self = (wxStyledTextCtrl *)wxluaT_getuserdatatype(L, 1, wxluatype_wxStyledTextCtrl);
...
static int LUACALL wxLua_wxStyledTextCtrl_MarkerDefine(lua_State *L)
{
    ...
    const wxColour * background = (argCount >= 5 ? (const wxColour *)wxluaT_getuserdatatype(L, 5, wxluatype_wxColour) : (const wxColour *)&wxNullColour);
    // const wxColour foreground = wxNullColour
    const wxColour * foreground = (argCount >= 4 ? (const wxColour *)wxluaT_getuserdatatype(L, 4, wxluatype_wxColour) : (const wxColour *)&wxNullColour);
    // int markerSymbol
...
static int LUACALL wxLua_wxStyledTextCtrl_SendMsg(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // long lp = 0
    long lp = (argCount >= 4 ? (long)wxlua_getnumbertype(L, 4) : (long)0);
    // long wp = 0
    long wp = (argCount >= 3 ? (long)wxlua_getnumbertype(L, 3) : (long)0);
    // int msg
...
static int LUACALL wxLua_wxStyledTextCtrl_constructor(lua_State *L)
{
    ...
    const wxString name = (argCount >= 6 ? wxlua_getwxStringtype(L, 6) : (const wxString)wxString(wxT("wxStyledTextCtrl")));
    // long style = 0
