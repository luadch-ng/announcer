...
static int LUACALL wxLua_wxWindowDisabler_constructor(lua_State *L)
{
    ...
    wxWindow * winToSkip = (argCount >= 1 ? (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow) : (wxWindow *)NULL);
    // call constructor
...
static int LUACALL wxLua_wxWindowUpdateLocker_constructor(lua_State *L)
{
    ...
    wxWindow * winToLock = (argCount >= 1 ? (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow) : (wxWindow *)NULL);
    // call constructor
...
static int LUACALL wxLua_wxWindow_AlwaysShowScrollbars(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool vflag = true
    bool vflag = (argCount >= 3 ? wxlua_getbooleantype(L, 3) : (bool)true);
    // bool hflag = true
    bool hflag = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxWindow * self = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
...
static int LUACALL wxLua_wxWindow_Center(lua_State *L)
{
    ...
    int direction = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)wxBOTH);
    // get this
    wxWindow * self = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
    // call Center
...
static int LUACALL wxLua_wxWindow_Close(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool force = false
    bool force = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)false);
    // get this
    wxWindow * self = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
    // call Close
...
static int LUACALL wxLua_wxWindow_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 7 ? wxlua_getwxStringtype(L, 7) : (const wxString)wxString(wxT("wxWindow")));
    // long style = 0
    long style = (argCount >= 6 ? (long)wxlua_getnumbertype(L, 6) : (long)0);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 5 ? (const wxSize *)wxluaT_getuserdatatype(L, 5, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 4 ? (const wxPoint *)wxluaT_getuserdatatype(L, 4, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
    // wxWindowID id
...
static int LUACALL wxLua_wxWindow_FindWindowById1(lua_State *L)
{
    ...
    wxWindow * parent = (argCount >= 2 ? (wxWindow *)wxluaT_getuserdatatype(L, 2, wxluatype_wxWindow) : (wxWindow *)NULL);
    // long id
...
static int LUACALL wxLua_wxWindow_FindWindowById(lua_State *L)
{
    ...
    const wxWindow * parent = (argCount >= 2 ? (const wxWindow *)wxluaT_getuserdatatype(L, 2, wxluatype_wxWindow) : (const wxWindow *)0);
    // long id
    long id = (long)wxlua_getnumbertype(L, 1);
    // call FindWindowById
    wxWindow* returns = (wxWindow*)wxWindow::FindWindowById(id, parent);
...
static int LUACALL wxLua_wxWindow_GetClassDefaultAttributes(lua_State *L)
{
    ...
    wxWindowVariant variant = (argCount >= 1 ? (wxWindowVariant)wxlua_getenumtype(L, 1) : (wxWindowVariant)wxWINDOW_VARIANT_NORMAL);
...
static int LUACALL wxLua_wxWindow_GetPopupMenuSelectionFromUser(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 3 ? (const wxPoint *)wxluaT_getuserdatatype(L, 3, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
    // wxMenu menu
    wxMenu * menu = (wxMenu *)wxluaT_getuserdatatype(L, 2, wxluatype_wxMenu);
    // get this
    wxWindow * self = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
...
static int LUACALL wxLua_wxWindow_HideWithEffect(lua_State *L)
{
    ...
    unsigned int timeout = (argCount >= 3 ? (unsigned int)wxlua_getuintegertype(L, 3) : (unsigned int)0);
    // wxShowEffect effect
...
static int LUACALL wxLua_wxWindow_IsTransparentBackgroundSupported(lua_State *L)
{
    ...
    wxString * reason = (argCount >= 2 ? (wxString *)wxlua_touserdata(L, 2) : (wxString *)NULL);
    // get this
    wxWindow * self = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
...
static int LUACALL wxLua_wxWindow_Move1(lua_State *L)
{
    ...
    int flags = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)wxSIZE_USE_EXISTING);
    // const wxPoint pt
    const wxPoint * pt = (const wxPoint *)wxluaT_getuserdatatype(L, 2, wxluatype_wxPoint);
    // get this
    wxWindow * self = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
...
static int LUACALL wxLua_wxWindow_Move(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int flags = wxSIZE_USE_EXISTING
    int flags = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)wxSIZE_USE_EXISTING);
    // int y
    int y = (int)wxlua_getnumbertype(L, 3);
    // int x
    int x = (int)wxlua_getnumbertype(L, 2);
...
static int LUACALL wxLua_wxWindow_Navigate(lua_State *L)
{
    ...
    int flags = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)wxNavigationKeyEvent::IsForward);
    // get this
    wxWindow * self = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
    // call Navigate
...
static int LUACALL wxLua_wxWindow_NewControlId(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int count = 1
    int count = (argCount >= 1 ? (int)wxlua_getnumbertype(L, 1) : (int)1);
    // call NewControlId
...
static int LUACALL wxLua_wxWindow_PopEventHandler(lua_State *L)
{
    ...
    bool deleteHandler = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)false);
    // get this
    wxWindow * self = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
...
static int LUACALL wxLua_wxWindow_Refresh(lua_State *L)
{
    ...
    const wxRect * rect = (argCount >= 3 ? (const wxRect *)wxluaT_getuserdatatype(L, 3, wxluatype_wxRect) : (const wxRect *)NULL);
    // bool eraseBackground = true
    bool eraseBackground = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxWindow * self = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
    // call Refresh
...
static int LUACALL wxLua_wxWindow_RefreshRect(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool eraseBackground = true
    bool eraseBackground = (argCount >= 3 ? wxlua_getbooleantype(L, 3) : (bool)true);
    // const wxRect rect
    const wxRect * rect = (const wxRect *)wxluaT_getuserdatatype(L, 2, wxluatype_wxRect);
    // get this
    wxWindow * self = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
...
static int LUACALL wxLua_wxWindow_ScrollWindow(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxRect rect = NULL
    const wxRect * rect = (argCount >= 4 ? (const wxRect *)wxluaT_getuserdatatype(L, 4, wxluatype_wxRect) : (const wxRect *)NULL);
    // int dy
...
static int LUACALL wxLua_wxWindow_SendSizeEvent(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int flags = 0
    int flags = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)0);
    // get this
    wxWindow * self = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
    // call SendSizeEvent
...
static int LUACALL wxLua_wxWindow_SetInitialSize(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 2 ? (const wxSize *)wxluaT_getuserdatatype(L, 2, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // get this
    wxWindow * self = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
    // call SetInitialSize
...
static int LUACALL wxLua_wxWindow_SetScrollPos(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool refresh = true
    bool refresh = (argCount >= 4 ? wxlua_getbooleantype(L, 4) : (bool)true);
    // int pos
...
static int LUACALL wxLua_wxWindow_SetScrollbar(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool refresh = true
    bool refresh = (argCount >= 6 ? wxlua_getbooleantype(L, 6) : (bool)true);
    // int range
...
static int LUACALL wxLua_wxWindow_SetSize(lua_State *L)
{
    ...
    int sizeFlags = (argCount >= 6 ? (int)wxlua_getnumbertype(L, 6) : (int)wxSIZE_AUTO);
    // int height
...
static int LUACALL wxLua_wxWindow_SetSizeHints(lua_State *L)
{
    ...
    const wxSize * incSize = (argCount >= 4 ? (const wxSize *)wxluaT_getuserdatatype(L, 4, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxSize maxSize = wxDefaultSize
    const wxSize * maxSize = (argCount >= 3 ? (const wxSize *)wxluaT_getuserdatatype(L, 3, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
...
static int LUACALL wxLua_wxWindow_SetSizeHints1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int incH = -1
    int incH = (argCount >= 7 ? (int)wxlua_getnumbertype(L, 7) : (int)-1);
    // int incW = -1
    int incW = (argCount >= 6 ? (int)wxlua_getnumbertype(L, 6) : (int)-1);
    // int maxH = -1
    int maxH = (argCount >= 5 ? (int)wxlua_getnumbertype(L, 5) : (int)-1);
    // int maxW = -1
    int maxW = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)-1);
    // int minH
...
static int LUACALL wxLua_wxWindow_SetSizer(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool deleteOld = true
    bool deleteOld = (argCount >= 3 ? wxlua_getbooleantype(L, 3) : (bool)true);
    // wxSizer sizer
    wxSizer * sizer = (wxSizer *)wxluaT_getuserdatatype(L, 2, wxluatype_wxSizer);
    // get this
    wxWindow * self = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
...
static int LUACALL wxLua_wxWindow_SetVirtualSizeHints1(lua_State *L)
{
    ...
    const wxSize * minSize = (argCount >= 2 ? (const wxSize *)wxluaT_getuserdatatype(L, 2, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // get this
    wxWindow * self = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
...
static int LUACALL wxLua_wxWindow_Show(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool show = true
    bool show = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxWindow * self = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
    // call Show
...
static int LUACALL wxLua_wxWindow_UnreserveControlId(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int count = 1
    int count = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)1);
    // wxWindowID id
...
static int LUACALL wxLua_wxWindow_UpdateWindowUI(lua_State *L)
{
    ...
    long flags = (argCount >= 2 ? (long)wxlua_getnumbertype(L, 2) : (long)wxUPDATE_UI_NONE);
    // get this
    wxWindow * self = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
    // call UpdateWindowUI
...
static int LUACALL wxLua_wxWindow_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxWindow"
    const wxString name = (argCount >= 6 ? wxlua_getwxStringtype(L, 6) : (const wxString)wxString(wxT("wxWindow")));
    // long style = 0
    long style = (argCount >= 5 ? (long)wxlua_getnumbertype(L, 5) : (long)0);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 4 ? (const wxSize *)wxluaT_getuserdatatype(L, 4, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 3 ? (const wxPoint *)wxluaT_getuserdatatype(L, 3, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
    // wxWindowID id
...
static int LUACALL wxLua_wxPanel_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 7 ? wxlua_getwxStringtype(L, 7) : (const wxString)wxString(wxT("wxPanel")));
    // long style = wxTAB_TRAVERSAL
    long style = (argCount >= 6 ? (long)wxlua_getnumbertype(L, 6) : (long)wxTAB_TRAVERSAL);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 5 ? (const wxSize *)wxluaT_getuserdatatype(L, 5, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 4 ? (const wxPoint *)wxluaT_getuserdatatype(L, 4, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
...
static int LUACALL wxLua_wxPanel_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxPanel"
    const wxString name = (argCount >= 6 ? wxlua_getwxStringtype(L, 6) : (const wxString)wxString(wxT("wxPanel")));
    // long style = wxTAB_TRAVERSAL
    long style = (argCount >= 5 ? (long)wxlua_getnumbertype(L, 5) : (long)wxTAB_TRAVERSAL);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 4 ? (const wxSize *)wxluaT_getuserdatatype(L, 4, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 3 ? (const wxPoint *)wxluaT_getuserdatatype(L, 3, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
...
static int LUACALL wxLua_wxControl_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 8 ? wxlua_getwxStringtype(L, 8) : (const wxString)wxString(wxT("wxControl")));
    // const wxValidator validator = wxDefaultValidator
    const wxValidator * validator = (argCount >= 7 ? (const wxValidator *)wxluaT_getuserdatatype(L, 7, wxluatype_wxValidator) : (const wxValidator *)&wxDefaultValidator);
    // long style = 0
    long style = (argCount >= 6 ? (long)wxlua_getnumbertype(L, 6) : (long)0);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 5 ? (const wxSize *)wxluaT_getuserdatatype(L, 5, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
...
static int LUACALL wxLua_wxControl_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxControl"
    const wxString name = (argCount >= 7 ? wxlua_getwxStringtype(L, 7) : (const wxString)wxString(wxT("wxControl")));
    // const wxValidator validator = wxDefaultValidator
    const wxValidator * validator = (argCount >= 6 ? (const wxValidator *)wxluaT_getuserdatatype(L, 6, wxluatype_wxValidator) : (const wxValidator *)&wxDefaultValidator);
    // long style = 0
    long style = (argCount >= 5 ? (long)wxlua_getnumbertype(L, 5) : (long)0);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 4 ? (const wxSize *)wxluaT_getuserdatatype(L, 4, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
...
static int LUACALL wxLua_wxBookCtrlBase_AddPage(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int imageId = -1
    int imageId = (argCount >= 5 ? (int)wxlua_getnumbertype(L, 5) : (int)-1);
    // bool bSelect = false
    bool bSelect = (argCount >= 4 ? wxlua_getbooleantype(L, 4) : (bool)false);
    // const wxString text
...
static int LUACALL wxLua_wxBookCtrlBase_AdvanceSelection(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool forward = true
    bool forward = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxBookCtrlBase * self = (wxBookCtrlBase *)wxluaT_getuserdatatype(L, 1, wxluatype_wxBookCtrlBase);
...
static int LUACALL wxLua_wxBookCtrlBase_InsertPage(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int imageId = -1
    int imageId = (argCount >= 6 ? (int)wxlua_getnumbertype(L, 6) : (int)-1);
    // bool bSelect = false
    bool bSelect = (argCount >= 5 ? wxlua_getbooleantype(L, 5) : (bool)false);
    // const wxString text
...
static int LUACALL wxLua_wxBookCtrlBaseEvent_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int nOldSel = -1
    int nOldSel = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)-1);
    // int nSel = -1
    int nSel = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)-1);
    // int winid = 0
    int winid = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)0);
    // wxEventType commandType = wxEVT_NULL
    wxEventType commandType = (argCount >= 1 ? (wxEventType)wxlua_getnumbertype(L, 1) : (wxEventType)wxEVT_NULL);
    // call constructor
...
static int LUACALL wxLua_wxNotebook_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 7 ? wxlua_getwxStringtype(L, 7) : (const wxString)wxString(wxT("wxNotebook")));
    // long style = 0
    long style = (argCount >= 6 ? (long)wxlua_getnumbertype(L, 6) : (long)0);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 5 ? (const wxSize *)wxluaT_getuserdatatype(L, 5, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
...
static int LUACALL wxLua_wxNotebook_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxNotebook"
    const wxString name = (argCount >= 6 ? wxlua_getwxStringtype(L, 6) : (const wxString)wxString(wxT("wxNotebook")));
    // long style = 0
    long style = (argCount >= 5 ? (long)wxlua_getnumbertype(L, 5) : (long)0);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 4 ? (const wxSize *)wxluaT_getuserdatatype(L, 4, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
...
static int LUACALL wxLua_wxNotebookEvent_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int oldSel = -1
    int oldSel = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)-1);
    // int sel = -1
    int sel = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)-1);
    // int id = 0
    int id = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)0);
    // wxEventType eventType = wxEVT_NULL
    wxEventType eventType = (argCount >= 1 ? (wxEventType)wxlua_getnumbertype(L, 1) : (wxEventType)wxEVT_NULL);
    // call constructor
...
static int LUACALL wxLua_wxListbook_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 7 ? wxlua_getwxStringtype(L, 7) : (const wxString)wxString(wxT("wxListbook")));
    // long style = 0
    long style = (argCount >= 6 ? (long)wxlua_getnumbertype(L, 6) : (long)0);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 5 ? (const wxSize *)wxluaT_getuserdatatype(L, 5, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
...
static int LUACALL wxLua_wxListbook_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxListbook"
    const wxString name = (argCount >= 6 ? wxlua_getwxStringtype(L, 6) : (const wxString)wxString(wxT("wxListbook")));
    // long style = 0
    long style = (argCount >= 5 ? (long)wxlua_getnumbertype(L, 5) : (long)0);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 4 ? (const wxSize *)wxluaT_getuserdatatype(L, 4, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
...
static int LUACALL wxLua_wxChoicebook_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 7 ? wxlua_getwxStringtype(L, 7) : (const wxString)wxString(wxT("wxChoicebook")));
    // long style = 0
    long style = (argCount >= 6 ? (long)wxlua_getnumbertype(L, 6) : (long)0);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 5 ? (const wxSize *)wxluaT_getuserdatatype(L, 5, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
...
static int LUACALL wxLua_wxChoicebook_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxChoicebook"
    const wxString name = (argCount >= 6 ? wxlua_getwxStringtype(L, 6) : (const wxString)wxString(wxT("wxChoicebook")));
    // long style = 0
    long style = (argCount >= 5 ? (long)wxlua_getnumbertype(L, 5) : (long)0);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 4 ? (const wxSize *)wxluaT_getuserdatatype(L, 4, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
...
static int LUACALL wxLua_wxTreebook_AddPage(lua_State *L)
{
    ...
    int imageId = (argCount >= 5 ? (int)wxlua_getnumbertype(L, 5) : (int)wxNOT_FOUND);
    // bool bSelect = false
    bool bSelect = (argCount >= 4 ? wxlua_getbooleantype(L, 4) : (bool)false);
    // const wxString text
    const wxString text = wxlua_getwxStringtype(L, 3);
...
static int LUACALL wxLua_wxTreebook_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 7 ? wxlua_getwxStringtype(L, 7) : (const wxString)wxString(wxT("wxTreebook")));
    // long style = wxBK_DEFAULT
    long style = (argCount >= 6 ? (long)wxlua_getnumbertype(L, 6) : (long)wxBK_DEFAULT);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 5 ? (const wxSize *)wxluaT_getuserdatatype(L, 5, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 4 ? (const wxPoint *)wxluaT_getuserdatatype(L, 4, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
...
static int LUACALL wxLua_wxTreebook_ExpandNode(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool expand = true
    bool expand = (argCount >= 3 ? wxlua_getbooleantype(L, 3) : (bool)true);
    // size_t pos
    size_t pos = (size_t)wxlua_getuintegertype(L, 2);
    // get this
    wxTreebook * self = (wxTreebook *)wxluaT_getuserdatatype(L, 1, wxluatype_wxTreebook);
...
static int LUACALL wxLua_wxTreebook_InsertPage(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int imageId = wxNOT_FOUND
    int imageId = (argCount >= 6 ? (int)wxlua_getnumbertype(L, 6) : (int)wxNOT_FOUND);
    // bool bSelect = false
    bool bSelect = (argCount >= 5 ? wxlua_getbooleantype(L, 5) : (bool)false);
    // const wxString text
    const wxString text = wxlua_getwxStringtype(L, 4);
...
static int LUACALL wxLua_wxTreebook_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxTreebook"
    const wxString name = (argCount >= 6 ? wxlua_getwxStringtype(L, 6) : (const wxString)wxString(wxT("wxTreebook")));
    // long style = wxBK_DEFAULT
    long style = (argCount >= 5 ? (long)wxlua_getnumbertype(L, 5) : (long)wxBK_DEFAULT);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 4 ? (const wxSize *)wxluaT_getuserdatatype(L, 4, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 3 ? (const wxPoint *)wxluaT_getuserdatatype(L, 3, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
...
static int LUACALL wxLua_wxTreebookEvent_constructor1(lua_State *L)
{
    ...
    int nOldSel = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)wxNOT_FOUND);
    // int nSel = wxNOT_FOUND
    int nSel = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)wxNOT_FOUND);
    // int id = 0
    int id = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)0);
    // wxEventType commandType = wxEVT_NULL
    wxEventType commandType = (argCount >= 1 ? (wxEventType)wxlua_getnumbertype(L, 1) : (wxEventType)wxEVT_NULL);
...
static int LUACALL wxLua_wxToolbook_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 7 ? wxlua_getwxStringtype(L, 7) : (const wxString)wxString(wxT("wxToolbook")));
    // long style = 0
    long style = (argCount >= 6 ? (long)wxlua_getnumbertype(L, 6) : (long)0);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 5 ? (const wxSize *)wxluaT_getuserdatatype(L, 5, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
...
static int LUACALL wxLua_wxToolbook_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxToolbook"
    const wxString name = (argCount >= 6 ? wxlua_getwxStringtype(L, 6) : (const wxString)wxString(wxT("wxToolbook")));
    // long style = 0
    long style = (argCount >= 5 ? (long)wxlua_getnumbertype(L, 5) : (long)0);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 4 ? (const wxSize *)wxluaT_getuserdatatype(L, 4, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
...
static int LUACALL wxLua_wxTabCtrl_InsertItem(lua_State *L)
{
    ...
    wxObject * clientData = (argCount >= 5 ? (wxObject *)wxluaT_getuserdatatype(L, 5, wxluatype_wxObject) : (wxObject *)NULL);
    // int imageId = -1
    int imageId = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)-1);
    // const wxString text
    const wxString text = wxlua_getwxStringtype(L, 3);
    // int item
    int item = (int)wxlua_getnumbertype(L, 2);
...
static int LUACALL wxLua_wxTabCtrl_constructor(lua_State *L)
{
    ...
    const wxString name = (argCount >= 6 ? wxlua_getwxStringtype(L, 6) : (const wxString)wxString(wxT("wxTabCtrl")));
    // long style = 0
    long style = (argCount >= 5 ? (long)wxlua_getnumbertype(L, 5) : (long)0);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 4 ? (const wxSize *)wxluaT_getuserdatatype(L, 4, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
...
static int LUACALL wxLua_wxTabEvent_constructor(lua_State *L)
{
    ...
    wxEventType commandType = (argCount >= 1 ? (wxEventType)wxlua_getnumbertype(L, 1) : (wxEventType)0);
    // call constructor
...
static int LUACALL wxLua_wxScrollHelper_SetScrollbars(lua_State *L)
{
    ...
    bool noRefresh = (argCount >= 8 ? wxlua_getbooleantype(L, 8) : (bool)false);
    // int yPos = 0
    int yPos = (argCount >= 7 ? (int)wxlua_getnumbertype(L, 7) : (int)0);
    // int xPos = 0
    int xPos = (argCount >= 6 ? (int)wxlua_getnumbertype(L, 6) : (int)0);
    // int noUnitsY
...
static int LUACALL wxLua_wxScrolledWindow_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 7 ? wxlua_getwxStringtype(L, 7) : (const wxString)wxString(wxT("wxScrolledWindow")));
    // long style = wxHSCROLL | wxVSCROLL
    long style = (argCount >= 6 ? (long)wxlua_getnumbertype(L, 6) : (long)wxHSCROLL | wxVSCROLL);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 5 ? (const wxSize *)wxluaT_getuserdatatype(L, 5, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 4 ? (const wxPoint *)wxluaT_getuserdatatype(L, 4, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
    // wxWindowID id = -1
    wxWindowID id = (argCount >= 3 ? (wxWindowID)wxlua_getnumbertype(L, 3) : (wxWindowID)-1);
    // wxWindow parent
    wxWindow * parent = (wxWindow *)wxluaT_getuserdatatype(L, 2, wxluatype_wxWindow);
    // get this
    wxScrolledWindow * self = (wxScrolledWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxScrolledWindow);
...
static int LUACALL wxLua_wxScrolledWindow_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxScrolledWindow"
    const wxString name = (argCount >= 6 ? wxlua_getwxStringtype(L, 6) : (const wxString)wxString(wxT("wxScrolledWindow")));
    // long style = wxHSCROLL | wxVSCROLL
    long style = (argCount >= 5 ? (long)wxlua_getnumbertype(L, 5) : (long)wxHSCROLL | wxVSCROLL);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 4 ? (const wxSize *)wxluaT_getuserdatatype(L, 4, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 3 ? (const wxPoint *)wxluaT_getuserdatatype(L, 3, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
    // wxWindowID id = wxID_ANY
    wxWindowID id = (argCount >= 2 ? (wxWindowID)wxlua_getnumbertype(L, 2) : (wxWindowID)wxID_ANY);
    // wxWindow parent
    wxWindow * parent = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
    // call constructor
...
static int LUACALL wxLua_wxSplitterWindow_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 7 ? wxlua_getwxStringtype(L, 7) : (const wxString)wxString(wxT("wxSplitterWindow")));
    // long style = wxSP_3D | wxCLIP_CHILDREN
    long style = (argCount >= 6 ? (long)wxlua_getnumbertype(L, 6) : (long)wxSP_3D | wxCLIP_CHILDREN);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 5 ? (const wxSize *)wxluaT_getuserdatatype(L, 5, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 4 ? (const wxPoint *)wxluaT_getuserdatatype(L, 4, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
    // wxWindowID id = wxID_ANY
    wxWindowID id = (argCount >= 3 ? (wxWindowID)wxlua_getnumbertype(L, 3) : (wxWindowID)wxID_ANY);
    // wxWindow parent
    wxWindow * parent = (wxWindow *)wxluaT_getuserdatatype(L, 2, wxluatype_wxWindow);
    // get this
...
static int LUACALL wxLua_wxSplitterWindow_SetSashPosition(lua_State *L)
{
    ...
    const bool redraw = (argCount >= 3 ? wxlua_getbooleantype(L, 3) : (const bool)true);
    // int position
...
static int LUACALL wxLua_wxSplitterWindow_SplitHorizontally(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int sashPosition = 0
    int sashPosition = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)0);
    // wxWindow window2
...
static int LUACALL wxLua_wxSplitterWindow_Unsplit(lua_State *L)
{
    ...
    wxWindow * toRemove = (argCount >= 2 ? (wxWindow *)wxluaT_getuserdatatype(L, 2, wxluatype_wxWindow) : (wxWindow *)NULL);
    // get this
    wxSplitterWindow * self = (wxSplitterWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxSplitterWindow);
    // call Unsplit
...
static int LUACALL wxLua_wxSplitterWindow_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxSplitterWindow"
    const wxString name = (argCount >= 6 ? wxlua_getwxStringtype(L, 6) : (const wxString)wxString(wxT("wxSplitterWindow")));
    // long style = wxSP_3D
    long style = (argCount >= 5 ? (long)wxlua_getnumbertype(L, 5) : (long)wxSP_3D);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 4 ? (const wxSize *)wxluaT_getuserdatatype(L, 4, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint point = wxDefaultPosition
    const wxPoint * point = (argCount >= 3 ? (const wxPoint *)wxluaT_getuserdatatype(L, 3, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
    // wxWindowID id
    wxWindowID id = (wxWindowID)wxlua_getnumbertype(L, 2);
    // wxWindow parent
    wxWindow * parent = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
...
static int LUACALL wxLua_wxSplitterEvent_constructor(lua_State *L)
{
    ...
    wxSplitterWindow * splitter = (argCount >= 2 ? (wxSplitterWindow *)wxluaT_getuserdatatype(L, 2, wxluatype_wxSplitterWindow) : (wxSplitterWindow *)NULL);
    // wxEventType type = wxEVT_NULL
    wxEventType type = (argCount >= 1 ? (wxEventType)wxlua_getnumbertype(L, 1) : (wxEventType)wxEVT_NULL);
    // call constructor
...
static int LUACALL wxLua_wxPopupWindow_Create(lua_State *L)
{
    ...
    int flags = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)wxBORDER_NONE);
    // wxWindow parent
    wxWindow * parent = (wxWindow *)wxluaT_getuserdatatype(L, 2, wxluatype_wxWindow);
    // get this
...
static int LUACALL wxLua_wxPopupWindow_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int flags = wxBORDER_NONE
    int flags = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)wxBORDER_NONE);
    // wxWindow parent
    wxWindow * parent = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
    // call constructor
...
static int LUACALL wxLua_wxPopupTransientWindow_Popup(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxWindow focus = NULL
    wxWindow * focus = (argCount >= 2 ? (wxWindow *)wxluaT_getuserdatatype(L, 2, wxluatype_wxWindow) : (wxWindow *)NULL);
    // get this
    wxPopupTransientWindow * self = (wxPopupTransientWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxPopupTransientWindow);
    // call Popup
    self->Popup(focus);
...
static int LUACALL wxLua_wxCollapsiblePane_Collapse(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool collapse = true
    bool collapse = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
...
static int LUACALL wxLua_wxCollapsiblePane_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 9 ? wxlua_getwxStringtype(L, 9) : (const wxString)wxString(wxT("wxCollapsiblePane")));
    // const wxValidator validator = wxDefaultValidator
    const wxValidator * validator = (argCount >= 8 ? (const wxValidator *)wxluaT_getuserdatatype(L, 8, wxluatype_wxValidator) : (const wxValidator *)&wxDefaultValidator);
    // long style = wxCP_DEFAULT_STYLE
    long style = (argCount >= 7 ? (long)wxlua_getnumbertype(L, 7) : (long)wxCP_DEFAULT_STYLE);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 6 ? (const wxSize *)wxluaT_getuserdatatype(L, 6, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 5 ? (const wxPoint *)wxluaT_getuserdatatype(L, 5, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
    // const wxString label
...
static int LUACALL wxLua_wxCollapsiblePane_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxCollapsiblePane"
    const wxString name = (argCount >= 8 ? wxlua_getwxStringtype(L, 8) : (const wxString)wxString(wxT("wxCollapsiblePane")));
    // const wxValidator validator = wxDefaultValidator
    const wxValidator * validator = (argCount >= 7 ? (const wxValidator *)wxluaT_getuserdatatype(L, 7, wxluatype_wxValidator) : (const wxValidator *)&wxDefaultValidator);
    // long style = wxCP_DEFAULT_STYLE
    long style = (argCount >= 6 ? (long)wxlua_getnumbertype(L, 6) : (long)wxCP_DEFAULT_STYLE);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 5 ? (const wxSize *)wxluaT_getuserdatatype(L, 5, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 4 ? (const wxPoint *)wxluaT_getuserdatatype(L, 4, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
...
static int LUACALL wxLua_wxStaticBox_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 8 ? wxlua_getwxStringtype(L, 8) : (const wxString)wxString(wxT("wxStaticBox")));
    // long style = 0
    long style = (argCount >= 7 ? (long)wxlua_getnumbertype(L, 7) : (long)0);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 6 ? (const wxSize *)wxluaT_getuserdatatype(L, 6, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 5 ? (const wxPoint *)wxluaT_getuserdatatype(L, 5, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
...
static int LUACALL wxLua_wxStaticBox_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxStaticBox"
    const wxString name = (argCount >= 7 ? wxlua_getwxStringtype(L, 7) : (const wxString)wxString(wxT("wxStaticBox")));
    // long style = 0
    long style = (argCount >= 6 ? (long)wxlua_getnumbertype(L, 6) : (long)0);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 5 ? (const wxSize *)wxluaT_getuserdatatype(L, 5, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
...
static int LUACALL wxLua_wxStaticBitmap_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 8 ? wxlua_getwxStringtype(L, 8) : (const wxString)wxString(wxT("wxStaticBitmap")));
    // long style = 0
    long style = (argCount >= 7 ? (long)wxlua_getnumbertype(L, 7) : (long)0);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 6 ? (const wxSize *)wxluaT_getuserdatatype(L, 6, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    ...
    const wxBitmap * label = (argCount >= 4 ? (const wxBitmap *)wxluaT_getuserdatatype(L, 4, wxluatype_wxBitmap) : (const wxBitmap *)&wxNullBitmap);
    // wxWindowID id
    wxWindowID id = (wxWindowID)wxlua_getnumbertype(L, 3);
    // wxWindow parent
    wxWindow * parent = (wxWindow *)wxluaT_getuserdatatype(L, 2, wxluatype_wxWindow);
...
static int LUACALL wxLua_wxStaticBitmap_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxStaticBitmap"
    const wxString name = (argCount >= 7 ? wxlua_getwxStringtype(L, 7) : (const wxString)wxString(wxT("wxStaticBitmap")));
    // long style = 0
    long style = (argCount >= 6 ? (long)wxlua_getnumbertype(L, 6) : (long)0);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 5 ? (const wxSize *)wxluaT_getuserdatatype(L, 5, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    ...
    const wxPoint * pos = (argCount >= 4 ? (const wxPoint *)wxluaT_getuserdatatype(L, 4, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
    // const wxBitmap label = wxNullBitmap
    const wxBitmap * label = (argCount >= 3 ? (const wxBitmap *)wxluaT_getuserdatatype(L, 3, wxluatype_wxBitmap) : (const wxBitmap *)&wxNullBitmap);
    // wxWindowID id
    wxWindowID id = (wxWindowID)wxlua_getnumbertype(L, 2);
    // wxWindow parent
    wxWindow * parent = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
...
static int LUACALL wxLua_wxStaticText_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 8 ? wxlua_getwxStringtype(L, 8) : (const wxString)wxString(wxT("wxStaticText")));
    // long style = 0
    long style = (argCount >= 7 ? (long)wxlua_getnumbertype(L, 7) : (long)0);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 6 ? (const wxSize *)wxluaT_getuserdatatype(L, 6, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
...
static int LUACALL wxLua_wxStaticText_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxStaticText"
    const wxString name = (argCount >= 7 ? wxlua_getwxStringtype(L, 7) : (const wxString)wxString(wxT("wxStaticText")));
    // long style = 0
    long style = (argCount >= 6 ? (long)wxlua_getnumbertype(L, 6) : (long)0);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 5 ? (const wxSize *)wxluaT_getuserdatatype(L, 5, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
...
static int LUACALL wxLua_wxStaticLine_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 7 ? wxlua_getwxStringtype(L, 7) : (const wxString)wxString(wxT("wxStaticLine")));
    // long style = 0
    long style = (argCount >= 6 ? (long)wxlua_getnumbertype(L, 6) : (long)0);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 5 ? (const wxSize *)wxluaT_getuserdatatype(L, 5, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
...
static int LUACALL wxLua_wxStaticLine_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxStaticLine"
    const wxString name = (argCount >= 6 ? wxlua_getwxStringtype(L, 6) : (const wxString)wxString(wxT("wxStaticLine")));
    // long style = wxLI_HORIZONTAL
    long style = (argCount >= 5 ? (long)wxlua_getnumbertype(L, 5) : (long)wxLI_HORIZONTAL);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 4 ? (const wxSize *)wxluaT_getuserdatatype(L, 4, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 3 ? (const wxPoint *)wxluaT_getuserdatatype(L, 3, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
