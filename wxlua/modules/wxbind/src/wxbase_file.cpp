...
static int LUACALL wxLua_wxStandardPaths_GetLocalizedResourcesDir(lua_State *L)
{
    ...
    wxStandardPaths::ResourceCat category = (argCount >= 3 ? (wxStandardPaths::ResourceCat)wxlua_getenumtype(L, 3) : (wxStandardPaths::ResourceCat)wxStandardPaths::ResourceCat_None);
    // const wxString lang
...
static int LUACALL wxLua_wxStandardPaths_MakeConfigFileName(lua_State *L)
{
    ...
    wxStandardPaths::ConfigFileConv conv = (argCount >= 3 ? (wxStandardPaths::ConfigFileConv)wxlua_getenumtype(L, 3) : (wxStandardPaths::ConfigFileConv)wxStandardPaths::ConfigFileConv_Ext);
...
static int LUACALL wxLua_wxFileName_Assign5(lua_State *L)
{
    ...
    wxPathFormat format = (argCount >= 5 ? (wxPathFormat)wxlua_getenumtype(L, 5) : (wxPathFormat)wxPATH_NATIVE);
    // const wxString ext
...
static int LUACALL wxLua_wxFileName_Assign4(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxPathFormat format = wxPATH_NATIVE
    wxPathFormat format = (argCount >= 4 ? (wxPathFormat)wxlua_getenumtype(L, 4) : (wxPathFormat)wxPATH_NATIVE);
    // const wxString name
    const wxString name = wxlua_getwxStringtype(L, 3);
    // const wxString path
    const wxString path = wxlua_getwxStringtype(L, 2);
...
static int LUACALL wxLua_wxFileName_Assign3(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxPathFormat format = wxPATH_NATIVE
    wxPathFormat format = (argCount >= 6 ? (wxPathFormat)wxlua_getenumtype(L, 6) : (wxPathFormat)wxPATH_NATIVE);
    // const wxString ext
...
static int LUACALL wxLua_wxFileName_Assign2(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxPathFormat format = wxPATH_NATIVE
    wxPathFormat format = (argCount >= 7 ? (wxPathFormat)wxlua_getenumtype(L, 7) : (wxPathFormat)wxPATH_NATIVE);
    // bool hasExt
...
static int LUACALL wxLua_wxFileName_Assign1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxPathFormat format = wxPATH_NATIVE
    wxPathFormat format = (argCount >= 3 ? (wxPathFormat)wxlua_getenumtype(L, 3) : (wxPathFormat)wxPATH_NATIVE);
...
static int LUACALL wxLua_wxFileName_AssignCwd(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString volume = ""
    const wxString volume = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (const wxString)wxString(wxEmptyString));
    // get this
    wxFileName * self = (wxFileName *)wxluaT_getuserdatatype(L, 1, wxluatype_wxFileName);
    // call AssignCwd
...
static int LUACALL wxLua_wxFileName_DirName(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxPathFormat format = wxPATH_NATIVE
    wxPathFormat format = (argCount >= 2 ? (wxPathFormat)wxlua_getenumtype(L, 2) : (wxPathFormat)wxPATH_NATIVE);
    // const wxString dir
    const wxString dir = wxlua_getwxStringtype(L, 1);
    // call DirName
    // allocate a new object using the copy constructor
...
static int LUACALL wxLua_wxFileName_Exists1(lua_State *L)
{
    ...
    int flags = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)wxFILE_EXISTS_ANY);
    // const wxString path
...
static int LUACALL wxLua_wxFileName_GetCwd(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString volume = ""
    const wxString volume = (argCount >= 1 ? wxlua_getwxStringtype(L, 1) : (const wxString)wxString(wxEmptyString));
    // call GetCwd
...
static int LUACALL wxLua_wxFileName_GetForbiddenChars(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxPathFormat format = wxPATH_NATIVE
    wxPathFormat format = (argCount >= 1 ? (wxPathFormat)wxlua_getenumtype(L, 1) : (wxPathFormat)wxPATH_NATIVE);
...
static int LUACALL wxLua_wxFileName_GetHumanReadableSize3(lua_State *L)
{
    ...
    wxSizeConvention conv = (argCount >= 4 ? (wxSizeConvention)wxlua_getenumtype(L, 4) : (wxSizeConvention)wxSIZE_CONV_TRADITIONAL);
    // int precision = 1
    int precision = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)1);
    // const wxString failmsg = "Not available"
    const wxString failmsg = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (const wxString)wxString(wxT("Not available")));
    // get this
    wxFileName * self = (wxFileName *)wxluaT_getuserdatatype(L, 1, wxluatype_wxFileName);
...
static int LUACALL wxLua_wxFileName_GetHumanReadableSize2(lua_State *L)
{
    ...
    const wxString nullsize = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (const wxString)wxString(wxT("Not available")));
...
static int LUACALL wxLua_wxFileName_GetVolumeString(lua_State *L)
{
    ...
    int flags = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)wxPATH_GET_SEPARATOR);
    // char drive
...
static int LUACALL wxLua_wxFileName_MakeAbsolute(lua_State *L)
{
    ...
    wxPathFormat format = (argCount >= 3 ? (wxPathFormat)wxlua_getenumtype(L, 3) : (wxPathFormat)wxPATH_NATIVE);
    // const wxString cwd = ""
    const wxString cwd = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (const wxString)wxString(wxEmptyString));
    // get this
    wxFileName * self = (wxFileName *)wxluaT_getuserdatatype(L, 1, wxluatype_wxFileName);
    // call MakeAbsolute
...
static int LUACALL wxLua_wxFileName_MakeRelativeTo(lua_State *L)
{
    ...
    const wxString pathBase = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (const wxString)wxString(wxEmptyString));
    // get this
    wxFileName * self = (wxFileName *)wxluaT_getuserdatatype(L, 1, wxluatype_wxFileName);
    // call MakeRelativeTo
...
static int LUACALL wxLua_wxFileName_Mkdir1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int flags = 0
    int flags = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)0);
    // int perm = 4095
    int perm = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)4095);
    // const wxString dir
    const wxString dir = wxlua_getwxStringtype(L, 1);
    // call Mkdir
...
static int LUACALL wxLua_wxFileName_Normalize(lua_State *L)
{
    ...
    const wxString cwd = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxEmptyString));
    // int flags = wxPATH_NORM_ALL
    int flags = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)wxPATH_NORM_ALL);
    // get this
    wxFileName * self = (wxFileName *)wxluaT_getuserdatatype(L, 1, wxluatype_wxFileName);
    // call Normalize
...
static int LUACALL wxLua_wxFileName_ReplaceEnvVariable(lua_State *L)
{
    ...
    const wxString replacementFmtString = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxT("$%s")));
...
static int LUACALL wxLua_wxFile_Create(lua_State *L)
{
    ...
    int access = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)wxS_DEFAULT);
    // bool overwrite = false
    bool overwrite = (argCount >= 3 ? wxlua_getbooleantype(L, 3) : (bool)false);
    // const wxString filename
    const wxString filename = wxlua_getwxStringtype(L, 2);
    // get this
    wxFile * self = (wxFile *)wxluaT_getuserdatatype(L, 1, wxluatype_wxFile);
...
static int LUACALL wxLua_wxFile_Open(lua_State *L)
{
    ...
    wxFile::OpenMode mode = (argCount >= 3 ? (wxFile::OpenMode)wxlua_getenumtype(L, 3) : (wxFile::OpenMode)wxFile::read);
    // const wxString filename
    const wxString filename = wxlua_getwxStringtype(L, 2);
    // get this
    wxFile * self = (wxFile *)wxluaT_getuserdatatype(L, 1, wxluatype_wxFile);
...
static int LUACALL wxLua_wxFile_Seek(lua_State *L)
{
    ...
    wxSeekMode mode = (argCount >= 3 ? (wxSeekMode)wxlua_getenumtype(L, 3) : (wxSeekMode)wxFromStart);
    // wxFileOffset offset
...
static int LUACALL wxLua_wxFile_SeekEnd(lua_State *L)
{
    ...
    wxFileOffset offset = (argCount >= 2 ? (wxFileOffset)wxlua_getuintegertype(L, 2) : (wxFileOffset)0);
    // get this
    wxFile * self = (wxFile *)wxluaT_getuserdatatype(L, 1, wxluatype_wxFile);
    // call SeekEnd
...
static int LUACALL wxLua_wxFile_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxFile::OpenMode mode = wxFile::read
    wxFile::OpenMode mode = (argCount >= 2 ? (wxFile::OpenMode)wxlua_getenumtype(L, 2) : (wxFile::OpenMode)wxFile::read);
    // const wxString filename
...
static int LUACALL wxLua_wxDir_FindFirst(lua_State *L)
{
    ...
    int flags = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)wxDIR_DEFAULT);
...
static int LUACALL wxLua_wxDir_HasFiles(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString filespec = ""
    const wxString filespec = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (const wxString)wxString(wxEmptyString));
    // get this
    wxDir * self = (wxDir *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDir);
    // call HasFiles
...
static int LUACALL wxLua_wxDir_HasSubDirs(lua_State *L)
{
    ...
    const wxString dirspec = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (const wxString)wxString(wxEmptyString));
    // get this
    wxDir * self = (wxDir *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDir);
    // call HasSubDirs
...
static int LUACALL wxLua_wxDir_Make(lua_State *L)
{
    ...
    int perm = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)wxS_DIR_DEFAULT);
    // const wxString dir
    const wxString dir = wxlua_getwxStringtype(L, 1);
    // call Make
...
static int LUACALL wxLua_wxFileTypeInfo_SetIcon(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int iconIndex = 0
    int iconIndex = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)0);
...
static int LUACALL wxLua_wxIconLocation_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int num = 0
    int num = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)0);
    // const wxString file = ""
    const wxString file = (argCount >= 1 ? wxlua_getwxStringtype(L, 1) : (const wxString)wxString(wxEmptyString));
    // call constructor
...
static int LUACALL wxLua_wxIconLocation_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString filename = ""
    const wxString filename = (argCount >= 1 ? wxlua_getwxStringtype(L, 1) : (const wxString)wxString(wxEmptyString));
    // call constructor
...
static int LUACALL wxLua_wxFileType_MessageParameters_constructor(lua_State *L)
{
    ...
    const wxString mimetype = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (const wxString)wxString(wxEmptyString));
    // const wxString filename
    const wxString filename = wxlua_getwxStringtype(L, 1);
    // call constructor
...
static int LUACALL wxLua_wxFileType_SetCommand(lua_State *L)
{
    ...
    bool overwriteprompt = (argCount >= 4 ? wxlua_getbooleantype(L, 4) : (bool)true);
    // const wxString verb
...
static int LUACALL wxLua_wxFileType_SetDefaultIcon(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int index = 0
    int index = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)0);
    // const wxString cmd = ""
    const wxString cmd = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (const wxString)wxString(wxEmptyString));
    // get this
    wxFileType * self = (wxFileType *)wxluaT_getuserdatatype(L, 1, wxluatype_wxFileType);
    // call SetDefaultIcon
...
static int LUACALL wxLua_wxMimeTypesManager_Initialize(lua_State *L)
{
    ...
    const wxString extraDir = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxEmptyString));
    // int mailcapStyle = wxMAILCAP_ALL
    int mailcapStyle = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)wxMAILCAP_ALL);
    // get this
    wxMimeTypesManager * self = (wxMimeTypesManager *)wxluaT_getuserdatatype(L, 1, wxluatype_wxMimeTypesManager);
    // call Initialize
...
static int LUACALL wxLua_wxMimeTypesManager_ReadMailcap(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool fallback = false
    bool fallback = (argCount >= 3 ? wxlua_getbooleantype(L, 3) : (bool)false);
    // const wxString filename
    const wxString filename = wxlua_getwxStringtype(L, 2);
    // get this
    wxMimeTypesManager * self = (wxMimeTypesManager *)wxluaT_getuserdatatype(L, 1, wxluatype_wxMimeTypesManager);
...
static int LUACALL wxLua_wxTextInputStream_Read16(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int base = 10
    int base = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)10);
    // get this
    wxTextInputStream * self = (wxTextInputStream *)wxluaT_getuserdatatype(L, 1, wxluatype_wxTextInputStream);
    // call Read16
...
static int LUACALL wxLua_wxTextOutputStream_SetMode(lua_State *L)
{
    ...
    wxEOL mode = (argCount >= 2 ? (wxEOL)wxlua_getenumtype(L, 2) : (wxEOL)wxEOL_NATIVE);
    // get this
    wxTextOutputStream * self = (wxTextOutputStream *)wxluaT_getuserdatatype(L, 1, wxluatype_wxTextOutputStream);
    // call SetMode
    self->SetMode(mode);
...
static int LUACALL wxLua_wxFileSystem_ChangePathTo(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool is_dir = false
    bool is_dir = (argCount >= 3 ? wxlua_getbooleantype(L, 3) : (bool)false);
    // const wxString location
    const wxString location = wxlua_getwxStringtype(L, 2);
    // get this
...
static int LUACALL wxLua_wxFileSystem_OpenFile(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int flags = wxFS_READ
    int flags = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)wxFS_READ);
    // const wxString location
    const wxString location = wxlua_getwxStringtype(L, 2);
    // get this
    wxFileSystem * self = (wxFileSystem *)wxluaT_getuserdatatype(L, 1, wxluatype_wxFileSystem);
...
static int LUACALL wxLua_wxFileSystemWatcherEvent_constructor2(lua_State *L)
{
    ...
    int watchid = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)wxID_ANY);
...
static int LUACALL wxLua_wxFileSystemWatcherEvent_constructor1(lua_State *L)
{
    ...
    const wxString errorMsg = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxEmptyString));
...
static int LUACALL wxLua_wxFileSystemWatcherEvent_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int watchid = wxID_ANY
    int watchid = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)wxID_ANY);
    // int changeType = 0
    int changeType = (argCount >= 1 ? (int)wxlua_getnumbertype(L, 1) : (int)0);
    // call constructor
...
static int LUACALL wxLua_wxFileSystemWatcher_Add(lua_State *L)
{
    ...
    int events = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)wxFSW_EVENT_ALL);
    // const wxFileName path
    const wxFileName * path = (const wxFileName *)wxluaT_getuserdatatype(L, 2, wxluatype_wxFileName);
    // get this
...
static int LUACALL wxLua_wxFileSystemWatcher_AddAny(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString filespec = ""
    const wxString filespec = (argCount >= 5 ? wxlua_getwxStringtype(L, 5) : (const wxString)wxString(wxEmptyString));
    // wxFSWPathType type
...
static int LUACALL wxLua_wxFileSystemWatcher_AddTree(lua_State *L)
{
    ...
    const wxString filespec = (argCount >= 4 ? wxlua_getwxStringtype(L, 4) : (const wxString)wxString(wxEmptyString));
    // int events = wxFSW_EVENT_ALL
    int events = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)wxFSW_EVENT_ALL);
    // const wxFileName path
    const wxFileName * path = (const wxFileName *)wxluaT_getuserdatatype(L, 2, wxluatype_wxFileName);
