...
static int LUACALL wxLua_wxGraphicsPenInfo_LinearGradient1(lua_State *L)
{
    ...
    // const wxGraphicsMatrix matrix = wxNullGraphicsMatrix
    const wxGraphicsMatrix * matrix = (argCount >= 7 ? (const wxGraphicsMatrix *)wxluaT_getuserdatatype(L, 7, wxluatype_wxGraphicsMatrix) : (const wxGraphicsMatrix *)&wxNullGraphicsMatrix);
...
static int LUACALL wxLua_wxGraphicsPenInfo_LinearGradient(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxGraphicsMatrix matrix = wxNullGraphicsMatrix
    const wxGraphicsMatrix * matrix = (argCount >= 8 ? (const wxGraphicsMatrix *)wxluaT_getuserdatatype(L, 8, wxluatype_wxGraphicsMatrix) : (const wxGraphicsMatrix *)&wxNullGraphicsMatrix);
    // const wxColour c2
...
static int LUACALL wxLua_wxGraphicsPenInfo_RadialGradient(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxGraphicsMatrix matrix = wxNullGraphicsMatrix
    const wxGraphicsMatrix * matrix = (argCount >= 9 ? (const wxGraphicsMatrix *)wxluaT_getuserdatatype(L, 9, wxluatype_wxGraphicsMatrix) : (const wxGraphicsMatrix *)&wxNullGraphicsMatrix);
...
static int LUACALL wxLua_wxGraphicsPenInfo_constructor1(lua_State *L)
{
    ...
    // wxDouble width = 1.0
    wxDouble width = (argCount >= 2 ? (wxDouble)wxlua_getnumbertype(L, 2) : (wxDouble)1.0);
    // const wxColour colour
...
static int LUACALL wxLua_wxGraphicsMatrix_Get(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxDouble ty = NULL
    wxDouble * ty = (argCount >= 7 ? (wxDouble *)wxlua_touserdata(L, 7) : (wxDouble *)NULL);
    // wxDouble tx = NULL
    wxDouble * tx = (argCount >= 6 ? (wxDouble *)wxlua_touserdata(L, 6) : (wxDouble *)NULL);
    // wxDouble d = NULL
    wxDouble * d = (argCount >= 5 ? (wxDouble *)wxlua_touserdata(L, 5) : (wxDouble *)NULL);
    // wxDouble c = NULL
    wxDouble * c = (argCount >= 4 ? (wxDouble *)wxlua_touserdata(L, 4) : (wxDouble *)NULL);
    // wxDouble b = NULL
    wxDouble * b = (argCount >= 3 ? (wxDouble *)wxlua_touserdata(L, 3) : (wxDouble *)NULL);
    // wxDouble a = NULL
    wxDouble * a = (argCount >= 2 ? (wxDouble *)wxlua_touserdata(L, 2) : (wxDouble *)NULL);
    // get this
    wxGraphicsMatrix * self = (wxGraphicsMatrix *)wxluaT_getuserdatatype(L, 1, wxluatype_wxGraphicsMatrix);
    // call Get
...
static int LUACALL wxLua_wxGraphicsMatrix_Set(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxDouble ty = 0.0
    wxDouble ty = (argCount >= 7 ? (wxDouble)wxlua_getnumbertype(L, 7) : (wxDouble)0.0);
    // wxDouble tx = 0.0
    wxDouble tx = (argCount >= 6 ? (wxDouble)wxlua_getnumbertype(L, 6) : (wxDouble)0.0);
    // wxDouble d = 1.0
    wxDouble d = (argCount >= 5 ? (wxDouble)wxlua_getnumbertype(L, 5) : (wxDouble)1.0);
    // wxDouble c = 0.0
    wxDouble c = (argCount >= 4 ? (wxDouble)wxlua_getnumbertype(L, 4) : (wxDouble)0.0);
    // wxDouble b = 0.0
    wxDouble b = (argCount >= 3 ? (wxDouble)wxlua_getnumbertype(L, 3) : (wxDouble)0.0);
    // wxDouble a = 1.0
    wxDouble a = (argCount >= 2 ? (wxDouble)wxlua_getnumbertype(L, 2) : (wxDouble)1.0);
    // get this
    wxGraphicsMatrix * self = (wxGraphicsMatrix *)wxluaT_getuserdatatype(L, 1, wxluatype_wxGraphicsMatrix);
    // call Set
...
static int LUACALL wxLua_wxGraphicsPath_Contains1(lua_State *L)
{
    ...
    wxPolygonFillMode fillStyle = (argCount >= 3 ? (wxPolygonFillMode)wxlua_getenumtype(L, 3) : (wxPolygonFillMode)wxODDEVEN_RULE);
    // const wxPoint2DDouble c
    const wxPoint2DDouble * c = (const wxPoint2DDouble *)wxluaT_getuserdatatype(L, 2, wxluatype_wxPoint2DDouble);
    // get this
    wxGraphicsPath * self = (wxGraphicsPath *)wxluaT_getuserdatatype(L, 1, wxluatype_wxGraphicsPath);
...
static int LUACALL wxLua_wxGraphicsPath_Contains(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxPolygonFillMode fillStyle = wxODDEVEN_RULE
    wxPolygonFillMode fillStyle = (argCount >= 4 ? (wxPolygonFillMode)wxlua_getenumtype(L, 4) : (wxPolygonFillMode)wxODDEVEN_RULE);
    // wxDouble y
    wxDouble y = (wxDouble)wxlua_getnumbertype(L, 3);
    // wxDouble x
    wxDouble x = (wxDouble)wxlua_getnumbertype(L, 2);
...
static int LUACALL wxLua_wxGraphicsGradientStop_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // float pos = 0.0
    float pos = (argCount >= 2 ? (float)wxlua_getnumbertype(L, 2) : (float)0.0);
    // wxColour col = wxTransparentColour
    wxColour col = (argCount >= 1 ? *(wxColour*)wxluaT_getuserdatatype(L, 1, wxluatype_wxColour) : (wxColour)wxTransparentColour);
    // call constructor
...
static int LUACALL wxLua_wxGraphicsGradientStops_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxColour endCol = wxTransparentColour
    wxColour endCol = (argCount >= 2 ? *(wxColour*)wxluaT_getuserdatatype(L, 2, wxluatype_wxColour) : (wxColour)wxTransparentColour);
    // wxColour startCol = wxTransparentColour
    wxColour startCol = (argCount >= 1 ? *(wxColour*)wxluaT_getuserdatatype(L, 1, wxluatype_wxColour) : (wxColour)wxTransparentColour);
    // call constructor
...
static int LUACALL wxLua_wxGraphicsContext_CreateFont2(lua_State *L)
{
    ...
    int flags = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)wxFONTFLAG_DEFAULT);
...
static int LUACALL wxLua_wxGraphicsContext_StartPage(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxDouble height = 0
    wxDouble height = (argCount >= 3 ? (wxDouble)wxlua_getnumbertype(L, 3) : (wxDouble)0);
    // wxDouble width = 0
    wxDouble width = (argCount >= 2 ? (wxDouble)wxlua_getnumbertype(L, 2) : (wxDouble)0);
    // get this
    wxGraphicsContext * self = (wxGraphicsContext *)wxluaT_getuserdatatype(L, 1, wxluatype_wxGraphicsContext);
    // call StartPage
...
static int LUACALL wxLua_wxGraphicsRenderer_GetVersion(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int micro = NULL
    int * micro = (argCount >= 4 ? (int *)wxlua_touserdata(L, 4) : (int *)NULL);
    // int minor = NULL
    int * minor = (argCount >= 3 ? (int *)wxlua_touserdata(L, 3) : (int *)NULL);
    // int major
