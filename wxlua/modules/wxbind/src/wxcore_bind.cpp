...
static int LUACALL wxLua_function_wxBeginBusyCursor(lua_State *L)
{
    ...
    wxCursor * cursor = (argCount >= 1 ? (wxCursor *)wxluaT_getuserdatatype(L, 1, wxluatype_wxCursor) : (wxCursor *)wxLua_wxHOURGLASS_CURSOR);
...
static int LUACALL wxLua_function_wxDirSelector(lua_State *L)
{
    ...
    long style = (argCount >= 3 ? (long)wxlua_getnumbertype(L, 3) : (long)wxDD_DEFAULT_STYLE);
    // const wxString default_path = ""
    const wxString default_path = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (const wxString)wxString(wxEmptyString));
    // const wxString message = wxDirSelectorPromptStr
    const wxString message = (argCount >= 1 ? wxlua_getwxStringtype(L, 1) : (const wxString)wxString(wxDirSelectorPromptStr));
    // call wxDirSelector
...
static int LUACALL wxLua_function_wxEnableTopLevelWindows(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool enable = true
    bool enable = (argCount >= 1 ? wxlua_getbooleantype(L, 1) : (bool)true);
...
static int LUACALL wxLua_function_wxExecute1(lua_State *L)
{
    ...
    wxProcess * process = (argCount >= 3 ? (wxProcess *)wxluaT_getuserdatatype(L, 3, wxluatype_wxProcess) : (wxProcess *)NULL);
    // int flags = wxEXEC_ASYNC
    int flags = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)wxEXEC_ASYNC);
...
static int LUACALL wxLua_function_wxExecute(lua_State *L)
{
    ...
    wxProcess * callback = (argCount >= 3 ? (wxProcess *)wxluaT_getuserdatatype(L, 3, wxluatype_wxProcess) : (wxProcess *)NULL);
    // bool sync = false
    bool sync = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)false);
    // const wxString command
    const wxString command = wxlua_getwxStringtype(L, 1);
    // call wxExecute
...
static int LUACALL wxLua_function_wxFileSelector(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int y = -1
    int y = (argCount >= 9 ? (int)wxlua_getnumbertype(L, 9) : (int)-1);
    // int x = -1
    int x = (argCount >= 8 ? (int)wxlua_getnumbertype(L, 8) : (int)-1);
    // wxWindow parent = NULL
    wxWindow * parent = (argCount >= 7 ? (wxWindow *)wxluaT_getuserdatatype(L, 7, wxluatype_wxWindow) : (wxWindow *)NULL);
    // int flags = 0
    int flags = (argCount >= 6 ? (int)wxlua_getnumbertype(L, 6) : (int)0);
    ...
    const wxString default_extension = (argCount >= 4 ? wxlua_getwxStringtype(L, 4) : (const wxString)wxString(wxEmptyString));
    // const wxString default_filename = ""
    const wxString default_filename = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxEmptyString));
    // const wxString default_path = ""
    const wxString default_path = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (const wxString)wxString(wxEmptyString));
...
static int LUACALL wxLua_function_wxGetColourFromUser1(lua_State *L)
{
    ...
    const wxString caption = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxEmptyString));
...
static int LUACALL wxLua_function_wxGetFontFromUser1(lua_State *L)
{
    ...
    const wxFont * fontInit = (argCount >= 2 ? (const wxFont *)wxluaT_getuserdatatype(L, 2, wxluatype_wxFont) : (const wxFont *)&wxNullFont);
    // wxWindow parent = NULL
    wxWindow * parent = (argCount >= 1 ? (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow) : (wxWindow *)NULL);
...
static int LUACALL wxLua_function_wxGetNumberFromUser1(lua_State *L)
{
    ...
    wxWindow * parent = (argCount >= 7 ? (wxWindow *)wxluaT_getuserdatatype(L, 7, wxluatype_wxWindow) : (wxWindow *)NULL);
    // long max = 100
    long max = (argCount >= 6 ? (long)wxlua_getnumbertype(L, 6) : (long)100);
    // long min = 0
    long min = (argCount >= 5 ? (long)wxlua_getnumbertype(L, 5) : (long)0);
    // long value
...
static int LUACALL wxLua_function_wxGetPasswordFromUser(lua_State *L)
{
    ...
    const wxString default_value = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxEmptyString));
    // const wxString caption = "Input text"
    const wxString caption = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (const wxString)wxString(wxT("Input text")));
    // const wxString message
    const wxString message = wxlua_getwxStringtype(L, 1);
...
static int LUACALL wxLua_function_wxGetSelectedChoices(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int height = wxCHOICE_HEIGHT
    int height = (argCount >= 10 ? (int)wxlua_getnumbertype(L, 10) : (int)wxCHOICE_HEIGHT);
    // int width = wxCHOICE_WIDTH
    int width = (argCount >= 9 ? (int)wxlua_getnumbertype(L, 9) : (int)wxCHOICE_WIDTH);
    // bool centre = true
    bool centre = (argCount >= 8 ? wxlua_getbooleantype(L, 8) : (bool)true);
    // int y = wxDefaultCoord
    int y = (argCount >= 7 ? (int)wxlua_getnumbertype(L, 7) : (int)wxDefaultCoord);
    // int x = wxDefaultCoord
    int x = (argCount >= 6 ? (int)wxlua_getnumbertype(L, 6) : (int)wxDefaultCoord);
    // wxWindow parent = NULL
    wxWindow * parent = (argCount >= 5 ? (wxWindow *)wxluaT_getuserdatatype(L, 5, wxluatype_wxWindow) : (wxWindow *)NULL);
...
static int LUACALL wxLua_function_wxGetSingleChoice(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int height = wxCHOICE_HEIGHT
    int height = (argCount >= 9 ? (int)wxlua_getnumbertype(L, 9) : (int)wxCHOICE_HEIGHT);
    // int width = wxCHOICE_WIDTH
    int width = (argCount >= 8 ? (int)wxlua_getnumbertype(L, 8) : (int)wxCHOICE_WIDTH);
    // bool centre = true
    bool centre = (argCount >= 7 ? wxlua_getbooleantype(L, 7) : (bool)true);
    // int y = wxDefaultCoord
    int y = (argCount >= 6 ? (int)wxlua_getnumbertype(L, 6) : (int)wxDefaultCoord);
    // int x = wxDefaultCoord
    int x = (argCount >= 5 ? (int)wxlua_getnumbertype(L, 5) : (int)wxDefaultCoord);
    // wxWindow parent = NULL
    wxWindow * parent = (argCount >= 4 ? (wxWindow *)wxluaT_getuserdatatype(L, 4, wxluatype_wxWindow) : (wxWindow *)NULL);
...
static int LUACALL wxLua_function_wxGetTextFromUser(lua_State *L)
{
    ...
    bool centre = (argCount >= 7 ? wxlua_getbooleantype(L, 7) : (bool)true);
    // int y = -1
    int y = (argCount >= 6 ? (int)wxlua_getnumbertype(L, 6) : (int)-1);
    // int x = -1
    int x = (argCount >= 5 ? (int)wxlua_getnumbertype(L, 5) : (int)-1);
    // wxWindow parent = NULL
    wxWindow * parent = (argCount >= 4 ? (wxWindow *)wxluaT_getuserdatatype(L, 4, wxluatype_wxWindow) : (wxWindow *)NULL);
    // const wxString default_value = ""
    const wxString default_value = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxEmptyString));
...
static int LUACALL wxLua_function_wxMessageBox(lua_State *L)
{
    ...
    int style = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)wxOK | wxCENTRE);
    // const wxString caption = "Message"
    const wxString caption = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (const wxString)wxString(wxT("Message")));
    // const wxString message
    const wxString message = wxlua_getwxStringtype(L, 1);
    // call wxMessageBox
...
static int LUACALL wxLua_function_wxSafeYield(lua_State *L)
{
    ...
    bool onlyIfNeeded = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)false);
    // wxWindow win = NULL
...
static int LUACALL wxLua_function_wxShell(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString command = ""
    const wxString command = (argCount >= 1 ? wxlua_getwxStringtype(L, 1) : (const wxString)wxString(wxEmptyString));
    // call wxShell
