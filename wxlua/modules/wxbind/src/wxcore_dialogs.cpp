...
static int LUACALL wxLua_wxDialog_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 8 ? wxlua_getwxStringtype(L, 8) : (const wxString)wxString(wxT("wxDialog")));
    // long style = wxDEFAULT_DIALOG_STYLE
    long style = (argCount >= 7 ? (long)wxlua_getnumbertype(L, 7) : (long)wxDEFAULT_DIALOG_STYLE);
...
static int LUACALL wxLua_wxDialog_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxDialog"
    const wxString name = (argCount >= 7 ? wxlua_getwxStringtype(L, 7) : (const wxString)wxString(wxT("wxDialog")));
    // long style = wxDEFAULT_DIALOG_STYLE
    long style = (argCount >= 6 ? (long)wxlua_getnumbertype(L, 6) : (long)wxDEFAULT_DIALOG_STYLE);
    // const wxSize size = wxDefaultSize
...
static int LUACALL wxLua_wxColourDialog_constructor(lua_State *L)
{
    ...
    wxColourData * data = (argCount >= 2 ? (wxColourData *)wxluaT_getuserdatatype(L, 2, wxluatype_wxColourData) : (wxColourData *)NULL);
    // wxWindow parent
    wxWindow * parent = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
    // call constructor
...
static int LUACALL wxLua_wxFileDialog_constructor(lua_State *L)
{
    ...
    const wxString name = (argCount >= 9 ? wxlua_getwxStringtype(L, 9) : (const wxString)wxString(wxT("wxFileDialog")));
    // const wxSize sz = wxDefaultSize
    const wxSize * sz = (argCount >= 8 ? (const wxSize *)wxluaT_getuserdatatype(L, 8, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    ...
    long style = (argCount >= 6 ? (long)wxlua_getnumbertype(L, 6) : (long)wxFD_DEFAULT_STYLE);
    ...
    const wxString defaultFile = (argCount >= 4 ? wxlua_getwxStringtype(L, 4) : (const wxString)wxString(wxEmptyString));
    // const wxString defaultDir = ""
    const wxString defaultDir = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxEmptyString));
    // const wxString message = wxFileSelectorPromptStr
    const wxString message = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (const wxString)wxString(wxFileSelectorPromptStr));
    // wxWindow parent
    wxWindow * parent = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
    // call constructor
...
static int LUACALL wxLua_wxFileDialog_constructor(lua_State *L)
{
    ...
    // const wxString wildcard = "*.*"
    const wxString wildcard = (argCount >= 5 ? wxlua_getwxStringtype(L, 5) : (const wxString)wxString(wxT("*.*")));
    // const wxString defaultFile = ""
    const wxString defaultFile = (argCount >= 4 ? wxlua_getwxStringtype(L, 4) : (const wxString)wxString(wxEmptyString));
    // const wxString defaultDir = ""
    const wxString defaultDir = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxEmptyString));
    // const wxString message = "Choose a file"
    const wxString message = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (const wxString)wxString(wxT("Choose a file")));
    // wxWindow parent
    wxWindow * parent = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
    // call constructor
...
static int LUACALL wxLua_wxDirDialog_constructor(lua_State *L)
{
    ...
    const wxPoint * pos = (argCount >= 5 ? (const wxPoint *)wxluaT_getuserdatatype(L, 5, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
    // long style = 0
    long style = (argCount >= 4 ? (long)wxlua_getnumbertype(L, 4) : (long)0);
    // const wxString defaultPath = ""
    const wxString defaultPath = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxEmptyString));
    // const wxString message = "Choose a directory"
    const wxString message = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (const wxString)wxString(wxT("Choose a directory")));
    // wxWindow parent
    wxWindow * parent = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
    // call constructor
...
static int LUACALL wxLua_wxMessageDialog_constructor(lua_State *L)
{
    ...
    long style = (argCount >= 4 ? (long)wxlua_getnumbertype(L, 4) : (long)wxOK | wxCANCEL | wxCENTRE);
    // const wxString caption = "Message box"
    const wxString caption = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxT("Message box")));
    // const wxString message
    const wxString message = wxlua_getwxStringtype(L, 2);
    // wxWindow parent
    wxWindow * parent = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
...
static int LUACALL wxLua_wxMultiChoiceDialog_constructor(lua_State *L)
{
    ...
    long style = (argCount >= 5 ? (long)wxlua_getnumbertype(L, 5) : (long)wxCHOICEDLG_STYLE);
...
static int LUACALL wxLua_wxTextEntryDialog_constructor(lua_State *L)
{
    ...
    const wxPoint * pos = (argCount >= 6 ? (const wxPoint *)wxluaT_getuserdatatype(L, 6, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
    // long style = wxOK | wxCANCEL | wxCENTRE
    long style = (argCount >= 5 ? (long)wxlua_getnumbertype(L, 5) : (long)wxOK | wxCANCEL | wxCENTRE);
    // const wxString defaultValue = ""
    const wxString defaultValue = (argCount >= 4 ? wxlua_getwxStringtype(L, 4) : (const wxString)wxString(wxEmptyString));
    // const wxString caption = "Please enter text"
    const wxString caption = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxT("Please enter text")));
    // const wxString message
    const wxString message = wxlua_getwxStringtype(L, 2);
    // wxWindow parent
    wxWindow * parent = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
...
static int LUACALL wxLua_wxPasswordEntryDialog_constructor(lua_State *L)
{
    ...
    long style = (argCount >= 5 ? (long)wxlua_getnumbertype(L, 5) : (long)wxTextEntryDialogStyle);
    // const wxString value = ""
    const wxString value = (argCount >= 4 ? wxlua_getwxStringtype(L, 4) : (const wxString)wxString(wxEmptyString));
    // const wxString caption = wxGetPasswordFromUserPromptStr
    const wxString caption = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxGetPasswordFromUserPromptStr));
    // const wxString message
    const wxString message = wxlua_getwxStringtype(L, 2);
    // wxWindow parent
    wxWindow * parent = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
...
static int LUACALL wxLua_wxFindReplaceDialog_Create(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int style = 0
    int style = (argCount >= 5 ? (int)wxlua_getnumbertype(L, 5) : (int)0);
    // const wxString title
    const wxString title = wxlua_getwxStringtype(L, 4);
...
static int LUACALL wxLua_wxFindReplaceDialog_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int style = 0
    int style = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)0);
    // const wxString title
    const wxString title = wxlua_getwxStringtype(L, 3);
    // wxFindReplaceData findData
    wxFindReplaceData * findData = (wxFindReplaceData *)wxluaT_getuserdatatype(L, 2, wxluatype_wxFindReplaceData);
...
static int LUACALL wxLua_wxProgressDialog_Pulse(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool skip = NULL
    bool * skip = (argCount >= 3 ? (bool *)wxlua_touserdata(L, 3) : (bool *)NULL);
    // const wxString newmsg = wxEmptyString
    const wxString newmsg = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (const wxString)wxString(wxEmptyString));
    // get this
    wxProgressDialog * self = (wxProgressDialog *)wxluaT_getuserdatatype(L, 1, wxluatype_wxProgressDialog);
    // call Pulse
...
static int LUACALL wxLua_wxProgressDialog_constructor(lua_State *L)
{
    ...
    int style = (argCount >= 5 ? (int)wxlua_getnumbertype(L, 5) : (int)wxPD_AUTO_HIDE | wxPD_APP_MODAL);
    // wxWindow parent = NULL
    wxWindow * parent = (argCount >= 4 ? (wxWindow *)wxluaT_getuserdatatype(L, 4, wxluatype_wxWindow) : (wxWindow *)NULL);
    // int maximum = 100
    int maximum = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)100);
    // const wxString message
    const wxString message = wxlua_getwxStringtype(L, 2);
    // const wxString title
...
static int LUACALL wxLua_wxNumberEntryDialog_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 8 ? (const wxPoint *)wxluaT_getuserdatatype(L, 8, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
    // long max
