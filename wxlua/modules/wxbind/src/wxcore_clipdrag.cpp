...
static int LUACALL wxLua_wxClipboard_UsePrimarySelection(lua_State *L)
{
    ...
    // bool primary = true
    bool primary = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxClipboard * self = (wxClipboard *)wxluaT_getuserdatatype(L, 1, wxluatype_wxClipboard);
...
static int LUACALL wxLua_wxClipboardLocker_constructor(lua_State *L)
{
    ...
    wxClipboard * clipboard = (argCount >= 1 ? (wxClipboard *)wxluaT_getuserdatatype(L, 1, wxluatype_wxClipboard) : (wxClipboard *)NULL);
    // call constructor
...
static int LUACALL wxLua_wxClipboardTextEvent_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxWindowID winid = 0
    wxWindowID winid = (argCount >= 2 ? (wxWindowID)wxlua_getnumbertype(L, 2) : (wxWindowID)0);
...
static int LUACALL wxLua_wxDataFormat_constructor(lua_State *L)
{
    ...
    wxDataFormatId format = (argCount >= 1 ? (wxDataFormatId)wxlua_getenumtype(L, 1) : (wxDataFormatId)wxDF_INVALID);
    // call constructor
    wxDataFormat* returns = new wxDataFormat(format);
    // add to tracked memory list
    wxluaO_addgcobject(L, returns, wxluatype_wxDataFormat);
...
static int LUACALL wxLua_wxDataObject_GetFormatCount(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxDataObject::Direction dir = wxDataObject::Get
    wxDataObject::Direction dir = (argCount >= 2 ? (wxDataObject::Direction)wxlua_getenumtype(L, 2) : (wxDataObject::Direction)wxDataObject::Get);
    // get this
    wxDataObject * self = (wxDataObject *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDataObject);
    // call GetFormatCount
...
static int LUACALL wxLua_wxDataObjectSimple_constructor(lua_State *L)
{
    ...
    const wxDataFormat * format = (argCount >= 1 ? (const wxDataFormat *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDataFormat) : (const wxDataFormat *)&wxFormatInvalid);
    // call constructor
...
static int LUACALL wxLua_wxDataObjectComposite_Add(lua_State *L)
{
    ...
    bool preferred = (argCount >= 3 ? wxlua_getbooleantype(L, 3) : (bool)false);
...
static int LUACALL wxLua_wxTextDataObject_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString text = ""
    const wxString text = (argCount >= 1 ? wxlua_getwxStringtype(L, 1) : (const wxString)wxString(wxEmptyString));
    // call constructor
...
static int LUACALL wxLua_wxBitmapDataObject_constructor(lua_State *L)
{
    ...
    const wxBitmap * bitmap = (argCount >= 1 ? (const wxBitmap *)wxluaT_getuserdatatype(L, 1, wxluatype_wxBitmap) : (const wxBitmap *)&wxNullBitmap);
    // call constructor
...
static int LUACALL wxLua_wxURLDataObject_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString url = ""
    const wxString url = (argCount >= 1 ? wxlua_getwxStringtype(L, 1) : (const wxString)wxString(wxEmptyString));
    // call constructor
...
static int LUACALL wxLua_wxDropSource_DoDragDrop(lua_State *L)
{
    ...
    int flags = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)wxDrag_CopyOnly);
    // get this
...
static int LUACALL wxLua_wxDropSource_constructor3(lua_State *L)
{
    ...
    const wxIcon * iconStop = (argCount >= 5 ? (const wxIcon *)wxluaT_getuserdatatype(L, 5, wxluatype_wxIcon) : (const wxIcon *)&wxNullIcon);
    // const wxIcon iconMove = wxNullIcon
    const wxIcon * iconMove = (argCount >= 4 ? (const wxIcon *)wxluaT_getuserdatatype(L, 4, wxluatype_wxIcon) : (const wxIcon *)&wxNullIcon);
    // const wxIcon iconCopy = wxNullIcon
    const wxIcon * iconCopy = (argCount >= 3 ? (const wxIcon *)wxluaT_getuserdatatype(L, 3, wxluatype_wxIcon) : (const wxIcon *)&wxNullIcon);
    // wxWindow win = NULL
    wxWindow * win = (argCount >= 2 ? (wxWindow *)wxluaT_getuserdatatype(L, 2, wxluatype_wxWindow) : (wxWindow *)NULL);
    // wxDataObject data
...
static int LUACALL wxLua_wxDropSource_constructor2(lua_State *L)
{
    ...
    const wxCursor * cursorStop = (argCount >= 5 ? (const wxCursor *)wxluaT_getuserdatatype(L, 5, wxluatype_wxCursor) : (const wxCursor *)&wxNullCursor);
    // const wxCursor cursorMove = wxNullCursor
    const wxCursor * cursorMove = (argCount >= 4 ? (const wxCursor *)wxluaT_getuserdatatype(L, 4, wxluatype_wxCursor) : (const wxCursor *)&wxNullCursor);
    // const wxCursor cursorCopy = wxNullCursor
    const wxCursor * cursorCopy = (argCount >= 3 ? (const wxCursor *)wxluaT_getuserdatatype(L, 3, wxluatype_wxCursor) : (const wxCursor *)&wxNullCursor);
    // wxWindow win = NULL
    wxWindow * win = (argCount >= 2 ? (wxWindow *)wxluaT_getuserdatatype(L, 2, wxluatype_wxWindow) : (wxWindow *)NULL);
    // wxDataObject data
    wxDataObject * data = (wxDataObject *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDataObject);
...
static int LUACALL wxLua_wxDropSource_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxIcon iconStop = wxNullIcon
    const wxIcon * iconStop = (argCount >= 4 ? (const wxIcon *)wxluaT_getuserdatatype(L, 4, wxluatype_wxIcon) : (const wxIcon *)&wxNullIcon);
    // const wxIcon iconMove = wxNullIcon
    const wxIcon * iconMove = (argCount >= 3 ? (const wxIcon *)wxluaT_getuserdatatype(L, 3, wxluatype_wxIcon) : (const wxIcon *)&wxNullIcon);
    // const wxIcon iconCopy = wxNullIcon
    const wxIcon * iconCopy = (argCount >= 2 ? (const wxIcon *)wxluaT_getuserdatatype(L, 2, wxluatype_wxIcon) : (const wxIcon *)&wxNullIcon);
    // wxWindow win = NULL
...
static int LUACALL wxLua_wxDropSource_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxCursor cursorStop = wxNullCursor
    const wxCursor * cursorStop = (argCount >= 4 ? (const wxCursor *)wxluaT_getuserdatatype(L, 4, wxluatype_wxCursor) : (const wxCursor *)&wxNullCursor);
    // const wxCursor cursorMove = wxNullCursor
    const wxCursor * cursorMove = (argCount >= 3 ? (const wxCursor *)wxluaT_getuserdatatype(L, 3, wxluatype_wxCursor) : (const wxCursor *)&wxNullCursor);
    // const wxCursor cursorCopy = wxNullCursor
    const wxCursor * cursorCopy = (argCount >= 2 ? (const wxCursor *)wxluaT_getuserdatatype(L, 2, wxluatype_wxCursor) : (const wxCursor *)&wxNullCursor);
    // wxWindow win = NULL
    wxWindow * win = (argCount >= 1 ? (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow) : (wxWindow *)NULL);
    // call constructor
...
static int LUACALL wxLua_wxMetafile_SetClipboard(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int height = 0
    int height = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)0);
    // int width = 0
