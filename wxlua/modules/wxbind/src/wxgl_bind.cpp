...
static int LUACALL wxLua_wxGLCanvas_constructor4(lua_State *L)
{
    ...
    const wxPalette * palette = (argCount >= 8 ? (const wxPalette *)wxluaT_getuserdatatype(L, 8, wxluatype_wxPalette) : (const wxPalette *)&wxNullPalette);
    // const wxString name = "GLCanvas"
    const wxString name = (argCount >= 7 ? wxlua_getwxStringtype(L, 7) : (const wxString)wxString(wxT("GLCanvas")));
    // long style = 0
...
static int LUACALL wxLua_wxGLCanvas_constructor2(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxPalette palette = wxNullPalette
    const wxPalette * palette = (argCount >= 9 ? (const wxPalette *)wxluaT_getuserdatatype(L, 9, wxluatype_wxPalette) : (const wxPalette *)&wxNullPalette);
    // int attribList = 0
...
static int LUACALL wxLua_wxGLCanvas_constructor(lua_State *L)
{
    ...
    // const wxString name = "GLCanvas"
    const wxString name = (argCount >= 6 ? wxlua_getwxStringtype(L, 6) : (const wxString)wxString(wxT("GLCanvas")));
    // long style = 0
...
static int LUACALL wxLua_wxGLAttribsBase_SetNeedsARB(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool needsARB = true
    bool needsARB = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxGLAttribsBase * self = (wxGLAttribsBase *)wxluaT_getuserdatatype(L, 1, wxluatype_wxGLAttribsBase);
    // call SetNeedsARB
...
static int LUACALL wxLua_wxGLContextAttrs_ReleaseFlush(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int val = 1
    int val = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)1);
    // get this
    wxGLContextAttrs * self = (wxGLContextAttrs *)wxluaT_getuserdatatype(L, 1, wxluatype_wxGLContextAttrs);
    // call ReleaseFlush
...
static int LUACALL wxLua_wxGLContext_constructor2(lua_State *L)
{
    ...
    const wxGLContext * other = (argCount >= 4 ? (const wxGLContext *)wxluaT_getuserdatatype(L, 4, wxluatype_wxGLContext) : (const wxGLContext *)NULL);
    // const wxPalette palette = wxNullPalette
    const wxPalette * palette = (argCount >= 3 ? (const wxPalette *)wxluaT_getuserdatatype(L, 3, wxluatype_wxPalette) : (const wxPalette *)&wxNullPalette);
    // wxGLCanvas win
...
static int LUACALL wxLua_wxGLContext_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxGLContext other = NULL
    const wxGLContext * other = (argCount >= 2 ? (const wxGLContext *)wxluaT_getuserdatatype(L, 2, wxluatype_wxGLContext) : (const wxGLContext *)NULL);
    // wxGLCanvas win
