...
static int LUACALL wxLua_wxStringTokenizer_SetString(lua_State *L)
{
    ...
    wxStringTokenizerMode mode = (argCount >= 4 ? (wxStringTokenizerMode)wxlua_getenumtype(L, 4) : (wxStringTokenizerMode)wxTOKEN_DEFAULT);
    // const wxString delims = wxDEFAULT_DELIMITERS
    const wxString delims = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxDEFAULT_DELIMITERS));
    // const wxString str
    const wxString str = wxlua_getwxStringtype(L, 2);
    // get this
    wxStringTokenizer * self = (wxStringTokenizer *)wxluaT_getuserdatatype(L, 1, wxluatype_wxStringTokenizer);
...
static int LUACALL wxLua_wxStringTokenizer_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxStringTokenizerMode mode = wxTOKEN_DEFAULT
    wxStringTokenizerMode mode = (argCount >= 3 ? (wxStringTokenizerMode)wxlua_getenumtype(L, 3) : (wxStringTokenizerMode)wxTOKEN_DEFAULT);
    // const wxString delims = wxDEFAULT_DELIMITERS
    const wxString delims = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (const wxString)wxString(wxDEFAULT_DELIMITERS));
    // const wxString str
...
static int LUACALL wxLua_wxStringClientData_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString data = ""
    const wxString data = (argCount >= 1 ? wxlua_getwxStringtype(L, 1) : (const wxString)wxString(wxEmptyString));
    // call constructor
...
static int LUACALL wxLua_wxArrayInt_Index(lua_State *L)
{
    ...
    bool searchFromEnd = (argCount >= 3 ? wxlua_getbooleantype(L, 3) : (bool)false);
    // int n
...
static int LUACALL wxLua_wxArrayInt_Insert(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int copies = 1
    int copies = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)1);
    // int n
...
static int LUACALL wxLua_wxArrayString_Index(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool bFromEnd = false
    bool bFromEnd = (argCount >= 4 ? wxlua_getbooleantype(L, 4) : (bool)false);
    // bool bCase = true
    bool bCase = (argCount >= 3 ? wxlua_getbooleantype(L, 3) : (bool)true);
    // const wxString sz
...
static int LUACALL wxLua_wxArrayString_Sort(lua_State *L)
{
    ...
    bool reverseOrder = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)false);
    // get this
    wxArrayString * self = (wxArrayString *)wxluaT_getuserdatatype(L, 1, wxluatype_wxArrayString);
    // call Sort
...
static int LUACALL wxLua_wxLongLong_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // unsigned long lo = 0
    unsigned long lo = (argCount >= 2 ? (unsigned long)wxlua_getuintegertype(L, 2) : (unsigned long)0);
    // long hi = 0
    long hi = (argCount >= 1 ? (long)wxlua_getnumbertype(L, 1) : (long)0);
    // call constructor
...
static int LUACALL wxLua_wxULongLong_constructor(lua_State *L)
{
    ...
    unsigned long lo = (argCount >= 2 ? (unsigned long)wxlua_getuintegertype(L, 2) : (unsigned long)0);
    // unsigned long hi = 0
    unsigned long hi = (argCount >= 1 ? (unsigned long)wxlua_getuintegertype(L, 1) : (unsigned long)0);
    // call constructor
...
static int LUACALL wxLua_wxMemoryBuffer_constructor(lua_State *L)
{
    ...
    size_t size = (argCount >= 1 ? (size_t)wxlua_getuintegertype(L, 1) : (size_t)wxMemoryBufferData::DefBufSize);
    // call constructor
...
static int LUACALL wxLua_wxVariant_constructor7(lua_State *L)
{
    ...
    const wxString name = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (const wxString)wxString(wxEmptyString));
