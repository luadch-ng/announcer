...
static int LUACALL wxLua_wxSocketBase_Wait(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // long millisecond = 0
    long millisecond = (argCount >= 3 ? (long)wxlua_getnumbertype(L, 3) : (long)0);
    // long seconds = -1
    long seconds = (argCount >= 2 ? (long)wxlua_getnumbertype(L, 2) : (long)-1);
    // get this
    wxSocketBase * self = (wxSocketBase *)wxluaT_getuserdatatype(L, 1, wxluatype_wxSocketBase);
    // call Wait
...
static int LUACALL wxLua_wxSocketClient_Connect(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool wait = true
    bool wait = (argCount >= 3 ? wxlua_getbooleantype(L, 3) : (bool)true);
...
static int LUACALL wxLua_wxSocketClient_WaitOnConnect(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // long milliseconds = 0
    long milliseconds = (argCount >= 3 ? (long)wxlua_getnumbertype(L, 3) : (long)0);
    // long seconds = -1
    long seconds = (argCount >= 2 ? (long)wxlua_getnumbertype(L, 2) : (long)-1);
    // get this
    wxSocketClient * self = (wxSocketClient *)wxluaT_getuserdatatype(L, 1, wxluatype_wxSocketClient);
...
static int LUACALL wxLua_wxSocketClient_constructor(lua_State *L)
{
    ...
    wxSocketFlags flags = (argCount >= 1 ? (wxSocketFlags)wxlua_getenumtype(L, 1) : (wxSocketFlags)wxSOCKET_NONE);
    // call constructor
...
static int LUACALL wxLua_wxSocketServer_Accept(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool wait = true
    bool wait = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
...
static int LUACALL wxLua_wxSocketServer_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxSocketFlags flags = wxSOCKET_NONE
    wxSocketFlags flags = (argCount >= 2 ? (wxSocketFlags)wxlua_getenumtype(L, 2) : (wxSocketFlags)wxSOCKET_NONE);
    // wxSockAddress address
...
static int LUACALL wxLua_wxFTP_GetDirList(lua_State *L)
{
    ...
    const wxString wildcard = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxEmptyString));
    // wxArrayString files
...
static int LUACALL wxLua_wxURI_Resolve(lua_State *L)
{
    ...
    int flags = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)wxURI_STRICT);
    // const wxURI base
