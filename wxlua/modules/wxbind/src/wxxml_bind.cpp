...
static int LUACALL wxLua_wxXmlNode_GetAttribute1(lua_State *L)
{
    ...
    const wxString defaultVal = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxEmptyString));
...
static int LUACALL wxLua_wxXmlNode_GetDepth(lua_State *L)
{
    ...
    wxXmlNode * grandparent = (argCount >= 2 ? (wxXmlNode *)wxluaT_getuserdatatype(L, 2, wxluatype_wxXmlNode) : (wxXmlNode *)NULL);
    // get this
    wxXmlNode * self = (wxXmlNode *)wxluaT_getuserdatatype(L, 1, wxluatype_wxXmlNode);
    // call GetDepth
...
static int LUACALL wxLua_wxXmlNode_constructor5(lua_State *L)
{
    ...
    const wxString content = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxEmptyString));
    // const wxString name
    const wxString name = wxlua_getwxStringtype(L, 2);
    // wxXmlNodeType type
...
static int LUACALL wxLua_wxXmlNode_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int lineNo = -1
    int lineNo = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)-1);
...
static int LUACALL wxLua_wxXmlNode_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int lineNo = -1
    int lineNo = (argCount >= 7 ? (int)wxlua_getnumbertype(L, 7) : (int)-1);
    // wxXmlNode next = NULL
    wxXmlNode * next = (argCount >= 6 ? (wxXmlNode *)wxluaT_getuserdatatype(L, 6, wxluatype_wxXmlNode) : (wxXmlNode *)NULL);
    // wxXmlAttribute attrs = NULL
    wxXmlAttribute * attrs = (argCount >= 5 ? (wxXmlAttribute *)wxluaT_getuserdatatype(L, 5, wxluatype_wxXmlAttribute) : (wxXmlAttribute *)NULL);
    // const wxString content = wxEmptyString
    const wxString content = (argCount >= 4 ? wxlua_getwxStringtype(L, 4) : (const wxString)wxString(wxEmptyString));
    // const wxString name
    const wxString name = wxlua_getwxStringtype(L, 3);
    // wxXmlNodeType type
    wxXmlNodeType type = (wxXmlNodeType)wxlua_getenumtype(L, 2);
...
static int LUACALL wxLua_wxXmlAttribute_constructor1(lua_State *L)
{
    ...
    wxXmlAttribute * next = (argCount >= 3 ? (wxXmlAttribute *)wxluaT_getuserdatatype(L, 3, wxluatype_wxXmlAttribute) : (wxXmlAttribute *)NULL);
    // const wxString value
    const wxString value = wxlua_getwxStringtype(L, 2);
    // const wxString name
    const wxString name = wxlua_getwxStringtype(L, 1);
...
static int LUACALL wxLua_wxXmlDoctype_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString publicId = ""
    const wxString publicId = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxEmptyString));
    // const wxString systemId = ""
    const wxString systemId = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (const wxString)wxString(wxEmptyString));
    // const wxString rootName = ""
    const wxString rootName = (argCount >= 1 ? wxlua_getwxStringtype(L, 1) : (const wxString)wxString(wxEmptyString));
    // call constructor
...
static int LUACALL wxLua_wxXmlDocument_Load2(lua_State *L)
{
    ...
    const wxString encoding = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxT("UTF-8")));
...
static int LUACALL wxLua_wxXmlDocument_Load1(lua_State *L)
{
    ...
    int flags = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)wxXMLDOC_NONE);
    // const wxString encoding = "UTF-8"
    const wxString encoding = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxT("UTF-8")));
...
static int LUACALL wxLua_wxXmlDocument_Save1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int indentstep = 1
    int indentstep = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)1);
...
static int LUACALL wxLua_wxXmlDocument_constructor3(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString encoding = "UTF-8"
    const wxString encoding = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (const wxString)wxString(wxT("UTF-8")));
    // const wxString filename
