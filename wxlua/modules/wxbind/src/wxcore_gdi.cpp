...
static int LUACALL wxLua_wxPoint_constructor(lua_State *L)
{
    ...
    // int y = 0
    int y = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)0);
    // int x = 0
    int x = (argCount >= 1 ? (int)wxlua_getnumbertype(L, 1) : (int)0);
    // call constructor
...
static int LUACALL wxLua_wxRealPoint_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // double yy = 0
    double yy = (argCount >= 2 ? (double)wxlua_getnumbertype(L, 2) : (double)0);
    // double xx = 0
    double xx = (argCount >= 1 ? (double)wxlua_getnumbertype(L, 1) : (double)0);
    // call constructor
...
static int LUACALL wxLua_wxSize_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int height = 0
    int height = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)0);
    // int width = 0
    int width = (argCount >= 1 ? (int)wxlua_getnumbertype(L, 1) : (int)0);
    // call constructor
...
static int LUACALL wxLua_wxRect_CentreIn(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int dir = wxBOTH
    int dir = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)wxBOTH);
    // const wxRect r
...
static int LUACALL wxLua_wxRect_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int h = 0
    int h = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)0);
    // int w = 0
    int w = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)0);
    // int y = 0
    int y = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)0);
    // int x = 0
    int x = (argCount >= 1 ? (int)wxlua_getnumbertype(L, 1) : (int)0);
...
static int LUACALL wxLua_wxRegion_Union4(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int tolerance = 0
    int tolerance = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)0);
...
static int LUACALL wxLua_wxRegion_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // long height = 0
    long height = (argCount >= 4 ? (long)wxlua_getnumbertype(L, 4) : (long)0);
    // long width = 0
    long width = (argCount >= 3 ? (long)wxlua_getnumbertype(L, 3) : (long)0);
    // long y = 0
    long y = (argCount >= 2 ? (long)wxlua_getnumbertype(L, 2) : (long)0);
    // long x = 0
    long x = (argCount >= 1 ? (long)wxlua_getnumbertype(L, 1) : (long)0);
    // call constructor
...
static int LUACALL wxLua_wxFontInfo_AntiAliased(lua_State *L)
{
    ...
    bool antiAliased = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxFontInfo * self = (wxFontInfo *)wxluaT_getuserdatatype(L, 1, wxluatype_wxFontInfo);
    // call AntiAliased
...
static int LUACALL wxLua_wxFontInfo_Bold(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool bold = true
    bool bold = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxFontInfo * self = (wxFontInfo *)wxluaT_getuserdatatype(L, 1, wxluatype_wxFontInfo);
    // call Bold
...
static int LUACALL wxLua_wxFontInfo_Italic(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool italic = true
    bool italic = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxFontInfo * self = (wxFontInfo *)wxluaT_getuserdatatype(L, 1, wxluatype_wxFontInfo);
    // call Italic
...
static int LUACALL wxLua_wxFontInfo_Light(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool light = true
    bool light = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxFontInfo * self = (wxFontInfo *)wxluaT_getuserdatatype(L, 1, wxluatype_wxFontInfo);
    // call Light
...
static int LUACALL wxLua_wxFontInfo_Slant(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool slant = true
    bool slant = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxFontInfo * self = (wxFontInfo *)wxluaT_getuserdatatype(L, 1, wxluatype_wxFontInfo);
    // call Slant
...
static int LUACALL wxLua_wxFontInfo_Strikethrough(lua_State *L)
{
    ...
    bool strikethrough = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxFontInfo * self = (wxFontInfo *)wxluaT_getuserdatatype(L, 1, wxluatype_wxFontInfo);
    // call Strikethrough
...
static int LUACALL wxLua_wxFontInfo_Underlined(lua_State *L)
{
    ...
    bool underlined = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxFontInfo * self = (wxFontInfo *)wxluaT_getuserdatatype(L, 1, wxluatype_wxFontInfo);
    // call Underlined
...
static int LUACALL wxLua_wxFont_New3(lua_State *L)
{
    ...
    wxFontEncoding encoding = (argCount >= 7 ? (wxFontEncoding)wxlua_getenumtype(L, 7) : (wxFontEncoding)wxFONTENCODING_DEFAULT);
    // const wxString faceName = ""
    const wxString faceName = (argCount >= 6 ? wxlua_getwxStringtype(L, 6) : (const wxString)wxString(wxEmptyString));
    // const bool underline = false
    const bool underline = (argCount >= 5 ? wxlua_getbooleantype(L, 5) : (const bool)false);
    // wxFontWeight weight
...
static int LUACALL wxLua_wxFont_New1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxFontEncoding encoding = wxFONTENCODING_DEFAULT
    wxFontEncoding encoding = (argCount >= 5 ? (wxFontEncoding)wxlua_getenumtype(L, 5) : (wxFontEncoding)wxFONTENCODING_DEFAULT);
    // const wxString faceName = ""
    const wxString faceName = (argCount >= 4 ? wxlua_getwxStringtype(L, 4) : (const wxString)wxString(wxEmptyString));
    // int flags = wxFONTFLAG_DEFAULT
    int flags = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)wxFONTFLAG_DEFAULT);
    // wxFontFamily family
    wxFontFamily family = (wxFontFamily)wxlua_getenumtype(L, 2);
    // const wxSize pixelSize
    const wxSize * pixelSize = (const wxSize *)wxluaT_getuserdatatype(L, 1, wxluatype_wxSize);
...
static int LUACALL wxLua_wxFont_constructor4(lua_State *L)
{
    ...
    bool underline = (argCount >= 5 ? wxlua_getbooleantype(L, 5) : (bool)false);
    // wxFontWeight weight
    wxFontWeight weight = (wxFontWeight)wxlua_getenumtype(L, 4);
    // wxFontStyle style
...
static int LUACALL wxLua_wxFontEnumerator_EnumerateEncodings(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString font = ""
    const wxString font = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (const wxString)wxString(wxEmptyString));
    // get this
...
static int LUACALL wxLua_wxFontEnumerator_EnumerateFacenames(lua_State *L)
{
    ...
    bool fixedWidthOnly = (argCount >= 3 ? wxlua_getbooleantype(L, 3) : (bool)false);
    // wxFontEncoding encoding = wxFONTENCODING_SYSTEM
    wxFontEncoding encoding = (argCount >= 2 ? (wxFontEncoding)wxlua_getenumtype(L, 2) : (wxFontEncoding)wxFONTENCODING_SYSTEM);
    // get this
    wxFontEnumerator * self = (wxFontEnumerator *)wxluaT_getuserdatatype(L, 1, wxluatype_wxFontEnumerator);
...
static int LUACALL wxLua_wxFontEnumerator_GetEncodings(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString facename = ""
    const wxString facename = (argCount >= 1 ? wxlua_getwxStringtype(L, 1) : (const wxString)wxString(wxEmptyString));
    // call GetEncodings
    // allocate a new object using the copy constructor
...
static int LUACALL wxLua_wxFontEnumerator_GetFacenames(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool fixedWidthOnly = false
    bool fixedWidthOnly = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)false);
    // wxFontEncoding encoding = wxFONTENCODING_SYSTEM
    wxFontEncoding encoding = (argCount >= 1 ? (wxFontEncoding)wxlua_getenumtype(L, 1) : (wxFontEncoding)wxFONTENCODING_SYSTEM);
    // call GetFacenames
    // allocate a new object using the copy constructor
...
static int LUACALL wxLua_wxFontList_FindOrCreateFont1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxFontEncoding encoding = wxFONTENCODING_DEFAULT
    wxFontEncoding encoding = (argCount >= 8 ? (wxFontEncoding)wxlua_getenumtype(L, 8) : (wxFontEncoding)wxFONTENCODING_DEFAULT);
    // const wxString face = wxEmptyString
    const wxString face = (argCount >= 7 ? wxlua_getwxStringtype(L, 7) : (const wxString)wxString(wxEmptyString));
    // bool underline = false
    bool underline = (argCount >= 6 ? wxlua_getbooleantype(L, 6) : (bool)false);
    // wxFontWeight weight
...
static int LUACALL wxLua_wxFontList_FindOrCreateFont(lua_State *L)
{
    ...
    wxFontEncoding encoding = (argCount >= 8 ? (wxFontEncoding)wxlua_getenumtype(L, 8) : (wxFontEncoding)wxFONTENCODING_DEFAULT);
    // const wxString faceName = ""
    const wxString faceName = (argCount >= 7 ? wxlua_getwxStringtype(L, 7) : (const wxString)wxString(wxEmptyString));
    // bool underline = false
    bool underline = (argCount >= 6 ? wxlua_getbooleantype(L, 6) : (bool)false);
    // int weight
...
static int LUACALL wxLua_wxFontMapper_CharsetToEncoding(lua_State *L)
{
    ...
    bool interactive = (argCount >= 3 ? wxlua_getbooleantype(L, 3) : (bool)true);
...
static int LUACALL wxLua_wxFontMapper_IsEncodingAvailable(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString facename = ""
    const wxString facename = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxEmptyString));
    // wxFontEncoding encoding
    wxFontEncoding encoding = (wxFontEncoding)wxlua_getenumtype(L, 2);
    // get this
    wxFontMapper * self = (wxFontMapper *)wxluaT_getuserdatatype(L, 1, wxluatype_wxFontMapper);
...
static int LUACALL wxLua_wxFontMapper_SetConfig(lua_State *L)
{
    ...
    wxConfigBase * config = (argCount >= 2 ? (wxConfigBase *)wxluaT_getuserdatatype(L, 2, wxluatype_wxConfigBase) : (wxConfigBase *)NULL);
    // get this
    wxFontMapper * self = (wxFontMapper *)wxluaT_getuserdatatype(L, 1, wxluatype_wxFontMapper);
    // call SetConfig
...
static int LUACALL wxLua_wxColour_GetAsString(lua_State *L)
{
    ...
    long flags = (argCount >= 2 ? (long)wxlua_getnumbertype(L, 2) : (long)wxC2S_NAME | wxC2S_CSS_SYNTAX);
    // get this
    wxColour * self = (wxColour *)wxluaT_getuserdatatype(L, 1, wxluatype_wxColour);
    // call GetAsString
...
static int LUACALL wxLua_wxColour_MakeDisabled(lua_State *L)
{
    ...
    unsigned char brightness = (argCount >= 2 ? (unsigned char)wxlua_getuintegertype(L, 2) : (unsigned char)255);
    // get this
    wxColour * self = (wxColour *)wxluaT_getuserdatatype(L, 1, wxluatype_wxColour);
    // call MakeDisabled
...
static int LUACALL wxLua_wxColour_Set(lua_State *L)
{
    ...
    unsigned char alpha = (argCount >= 5 ? (unsigned char)wxlua_getuintegertype(L, 5) : (unsigned char)wxALPHA_OPAQUE);
    // unsigned char blue
    unsigned char blue = (unsigned char)wxlua_getuintegertype(L, 4);
    // unsigned char green
    unsigned char green = (unsigned char)wxlua_getuintegertype(L, 3);
...
static int LUACALL wxLua_wxColour_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // unsigned char alpha = wxALPHA_OPAQUE
    unsigned char alpha = (argCount >= 4 ? (unsigned char)wxlua_getuintegertype(L, 4) : (unsigned char)wxALPHA_OPAQUE);
    // unsigned char blue
    unsigned char blue = (unsigned char)wxlua_getuintegertype(L, 3);
    // unsigned char green
    unsigned char green = (unsigned char)wxlua_getuintegertype(L, 2);
...
static int LUACALL wxLua_wxPenInfo_constructor(lua_State *L)
{
    ...
    wxPenStyle style = (argCount >= 3 ? (wxPenStyle)wxlua_getenumtype(L, 3) : (wxPenStyle)wxPENSTYLE_SOLID);
    // int width = 1
    int width = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)1);
    // const wxColour colour
    const wxColour * colour = (const wxColour *)wxluaT_getuserdatatype(L, 1, wxluatype_wxColour);
    // call constructor
...
static int LUACALL wxLua_wxPenList_FindOrCreatePen1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxPenStyle style = wxPENSTYLE_SOLID
    wxPenStyle style = (argCount >= 4 ? (wxPenStyle)wxlua_getenumtype(L, 4) : (wxPenStyle)wxPENSTYLE_SOLID);
    // int width = 1
    int width = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)1);
    // const wxColour colour
    const wxColour * colour = (const wxColour *)wxluaT_getuserdatatype(L, 2, wxluatype_wxColour);
    // get this
...
static int LUACALL wxLua_wxBrush_constructor1(lua_State *L)
{
    ...
    wxBrushStyle style = (argCount >= 2 ? (wxBrushStyle)wxlua_getenumtype(L, 2) : (wxBrushStyle)wxBRUSHSTYLE_SOLID);
    // const wxColour colour
    const wxColour * colour = (const wxColour *)wxluaT_getuserdatatype(L, 1, wxluatype_wxColour);
    // call constructor
    wxBrush* returns = new wxBrush(*colour, style);
...
static int LUACALL wxLua_wxBrushList_FindOrCreateBrush1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxBrushStyle style = wxBRUSHSTYLE_SOLID
    wxBrushStyle style = (argCount >= 3 ? (wxBrushStyle)wxlua_getenumtype(L, 3) : (wxBrushStyle)wxBRUSHSTYLE_SOLID);
    // const wxColour colour
    const wxColour * colour = (const wxColour *)wxluaT_getuserdatatype(L, 2, wxluatype_wxColour);
    // get this
...
static int LUACALL wxLua_wxIcon_LoadFile(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int desiredHeight = -1
    int desiredHeight = (argCount >= 5 ? (int)wxlua_getnumbertype(L, 5) : (int)-1);
    // int desiredWidth = -1
    int desiredWidth = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)-1);
    // wxBitmapType type = wxICON_DEFAULT_TYPE
    wxBitmapType type = (argCount >= 3 ? (wxBitmapType)wxlua_getenumtype(L, 3) : (wxBitmapType)wxICON_DEFAULT_TYPE);
    // const wxString name
    const wxString name = wxlua_getwxStringtype(L, 2);
    // get this
    wxIcon * self = (wxIcon *)wxluaT_getuserdatatype(L, 1, wxluatype_wxIcon);
...
static int LUACALL wxLua_wxIcon_constructor2(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int desiredHeight = -1
    int desiredHeight = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)-1);
    // int desiredWidth = -1
    int desiredWidth = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)-1);
    // wxBitmapType type = wxICON_DEFAULT_TYPE
    wxBitmapType type = (argCount >= 2 ? (wxBitmapType)wxlua_getenumtype(L, 2) : (wxBitmapType)wxICON_DEFAULT_TYPE);
    // const wxString name
...
static int LUACALL wxLua_wxIconBundle_AddIcon3(lua_State *L)
{
    ...
    wxBitmapType type = (argCount >= 3 ? (wxBitmapType)wxlua_getenumtype(L, 3) : (wxBitmapType)wxBITMAP_TYPE_ANY);
...
static int LUACALL wxLua_wxIconBundle_GetIcon1(lua_State *L)
{
    ...
    int size = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)wxDefaultCoord);
    // get this
    wxIconBundle * self = (wxIconBundle *)wxluaT_getuserdatatype(L, 1, wxluatype_wxIconBundle);
    // call GetIcon
    // allocate a new object using the copy constructor
...
static int LUACALL wxLua_wxIconBundle_constructor5(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxBitmapType type = wxBITMAP_TYPE_ANY
    wxBitmapType type = (argCount >= 2 ? (wxBitmapType)wxlua_getenumtype(L, 2) : (wxBitmapType)wxBITMAP_TYPE_ANY);
    // wxInputStream stream
...
static int LUACALL wxLua_wxBitmap_Create1(lua_State *L)
{
    ...
    int depth = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)wxBITMAP_SCREEN_DEPTH);
    // const wxSize sz
    const wxSize * sz = (const wxSize *)wxluaT_getuserdatatype(L, 2, wxluatype_wxSize);
    // get this
    wxBitmap * self = (wxBitmap *)wxluaT_getuserdatatype(L, 1, wxluatype_wxBitmap);
...
static int LUACALL wxLua_wxBitmap_Create(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int depth = wxBITMAP_SCREEN_DEPTH
    int depth = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)wxBITMAP_SCREEN_DEPTH);
    // int height
    int height = (int)wxlua_getnumbertype(L, 3);
    // int width
    int width = (int)wxlua_getnumbertype(L, 2);
...
static int LUACALL wxLua_wxBitmap_SaveFile1(lua_State *L)
{
    ...
    wxPalette * palette = (argCount >= 4 ? (wxPalette *)wxluaT_getuserdatatype(L, 4, wxluatype_wxPalette) : (wxPalette *)NULL);
    // wxBitmapType type
    wxBitmapType type = (wxBitmapType)wxlua_getenumtype(L, 3);
    // const wxString name
    const wxString name = wxlua_getwxStringtype(L, 2);
...
static int LUACALL wxLua_wxBitmap_SaveFile(lua_State *L)
{
    ...
    const wxPalette * palette = (argCount >= 4 ? (const wxPalette *)wxluaT_getuserdatatype(L, 4, wxluatype_wxPalette) : (const wxPalette *)NULL);
    // wxBitmapType type
    wxBitmapType type = (wxBitmapType)wxlua_getenumtype(L, 3);
    // const wxString name
    const wxString name = wxlua_getwxStringtype(L, 2);
...
static int LUACALL wxLua_wxBitmap_constructor8(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int depth = wxBITMAP_SCREEN_DEPTH
    int depth = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)wxBITMAP_SCREEN_DEPTH);
    // const wxImage image
...
static int LUACALL wxLua_wxBitmap_constructor6(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // double scale = 1.0
    double scale = (argCount >= 3 ? (double)wxlua_getnumbertype(L, 3) : (double)1.0);
    // int depth = wxBITMAP_SCREEN_DEPTH
    int depth = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)wxBITMAP_SCREEN_DEPTH);
    // const wxImage image
    const wxImage * image = (const wxImage *)wxluaT_getuserdatatype(L, 1, wxluatype_wxImage);
...
static int LUACALL wxLua_wxBitmap_constructor2(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int depth = 1
    int depth = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)1);
    // int height
    int height = (int)wxlua_getnumbertype(L, 3);
    // int width
    int width = (int)wxlua_getnumbertype(L, 2);
...
static int LUACALL wxLua_wxCursor_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int hotSpotY = 0
    int hotSpotY = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)0);
    // int hotSpotX = 0
    int hotSpotX = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)0);
    // wxBitmapType type
...
static int LUACALL wxLua_wxImageList_Add(lua_State *L)
{
    ...
    const wxBitmap * mask = (argCount >= 3 ? (const wxBitmap *)wxluaT_getuserdatatype(L, 3, wxluatype_wxBitmap) : (const wxBitmap *)&wxNullBitmap);
    // const wxBitmap bitmap
    const wxBitmap * bitmap = (const wxBitmap *)wxluaT_getuserdatatype(L, 2, wxluatype_wxBitmap);
    // get this
    wxImageList * self = (wxImageList *)wxluaT_getuserdatatype(L, 1, wxluatype_wxImageList);
...
static int LUACALL wxLua_wxImageList_Draw(lua_State *L)
{
    ...
    bool solidBackground = (argCount >= 7 ? wxlua_getbooleantype(L, 7) : (bool)false);
    // int flags = wxIMAGELIST_DRAW_NORMAL
    int flags = (argCount >= 6 ? (int)wxlua_getnumbertype(L, 6) : (int)wxIMAGELIST_DRAW_NORMAL);
    // int y
...
static int LUACALL wxLua_wxImageList_Replace(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxBitmap mask = wxNullBitmap
    const wxBitmap * mask = (argCount >= 4 ? (const wxBitmap *)wxluaT_getuserdatatype(L, 4, wxluatype_wxBitmap) : (const wxBitmap *)&wxNullBitmap);
    // const wxBitmap bitmap
    const wxBitmap * bitmap = (const wxBitmap *)wxluaT_getuserdatatype(L, 3, wxluatype_wxBitmap);
    // int index
    int index = (int)wxlua_getnumbertype(L, 2);
...
static int LUACALL wxLua_wxImageList_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int initialCount = 1
    int initialCount = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)1);
    // bool mask = true
    bool mask = (argCount >= 3 ? wxlua_getbooleantype(L, 3) : (bool)true);
    // int height
    int height = (int)wxlua_getnumbertype(L, 2);
    // int width
    int width = (int)wxlua_getnumbertype(L, 1);
...
static int LUACALL wxLua_wxMatrix2D_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxDouble v22 = 1
    wxDouble v22 = (argCount >= 4 ? (wxDouble)wxlua_getnumbertype(L, 4) : (wxDouble)1);
    // wxDouble v21 = 0
    wxDouble v21 = (argCount >= 3 ? (wxDouble)wxlua_getnumbertype(L, 3) : (wxDouble)0);
    // wxDouble v12 = 0
    wxDouble v12 = (argCount >= 2 ? (wxDouble)wxlua_getnumbertype(L, 2) : (wxDouble)0);
    // wxDouble v11 = 1
    wxDouble v11 = (argCount >= 1 ? (wxDouble)wxlua_getnumbertype(L, 1) : (wxDouble)1);
    // call constructor
...
static int LUACALL wxLua_wxAffineMatrix2D_Mirror(lua_State *L)
{
    ...
    int direction = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)wxHORIZONTAL);
    // get this
    wxAffineMatrix2D * self = (wxAffineMatrix2D *)wxluaT_getuserdatatype(L, 1, wxluatype_wxAffineMatrix2D);
    // call Mirror
...
static int LUACALL wxLua_wxDC_Blit(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool useMask = false
    bool useMask = (argCount >= 10 ? wxlua_getbooleantype(L, 10) : (bool)false);
    // wxRasterOperationMode logicalFunc = wxCOPY
    wxRasterOperationMode logicalFunc = (argCount >= 9 ? (wxRasterOperationMode)wxlua_getenumtype(L, 9) : (wxRasterOperationMode)wxCOPY);
    // wxCoord ysrc
...
static int LUACALL wxLua_wxDC_DrawLabel1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int indexAccel = -1
    int indexAccel = (argCount >= 5 ? (int)wxlua_getnumbertype(L, 5) : (int)-1);
    // int alignment = wxALIGN_LEFT | wxALIGN_TOP
    int alignment = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)wxALIGN_LEFT | wxALIGN_TOP);
    // const wxRect rect
...
static int LUACALL wxLua_wxDC_DrawLabel(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int indexAccel = -1
    int indexAccel = (argCount >= 6 ? (int)wxlua_getnumbertype(L, 6) : (int)-1);
    // int alignment = wxALIGN_LEFT | wxALIGN_TOP
    int alignment = (argCount >= 5 ? (int)wxlua_getnumbertype(L, 5) : (int)wxALIGN_LEFT | wxALIGN_TOP);
    // const wxRect rect
...
static int LUACALL wxLua_wxDC_DrawLines(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxCoord yoffset = 0
    wxCoord yoffset = (argCount >= 4 ? (wxCoord)wxlua_getnumbertype(L, 4) : (wxCoord)0);
    // wxCoord xoffset = 0
    wxCoord xoffset = (argCount >= 3 ? (wxCoord)wxlua_getnumbertype(L, 3) : (wxCoord)0);
...
static int LUACALL wxLua_wxDC_DrawPolygon(lua_State *L)
{
    ...
    wxPolygonFillMode fill_style = (argCount >= 5 ? (wxPolygonFillMode)wxlua_getenumtype(L, 5) : (wxPolygonFillMode)wxODDEVEN_RULE);
    // wxCoord yoffset = 0
    wxCoord yoffset = (argCount >= 4 ? (wxCoord)wxlua_getnumbertype(L, 4) : (wxCoord)0);
    // wxCoord xoffset = 0
    wxCoord xoffset = (argCount >= 3 ? (wxCoord)wxlua_getnumbertype(L, 3) : (wxCoord)0);
...
static int LUACALL wxLua_wxDC_DrawRoundedRectangle(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // double radius = 20
    double radius = (argCount >= 6 ? (double)wxlua_getnumbertype(L, 6) : (double)20);
    // wxCoord height
    wxCoord height = (wxCoord)wxlua_getnumbertype(L, 5);
    // wxCoord width
    wxCoord width = (wxCoord)wxlua_getnumbertype(L, 4);
...
static int LUACALL wxLua_wxDC_FloodFill(lua_State *L)
{
    ...
    wxFloodFillStyle style = (argCount >= 5 ? (wxFloodFillStyle)wxlua_getenumtype(L, 5) : (wxFloodFillStyle)wxFLOOD_SURFACE);
    // const wxColour colour
...
static int LUACALL wxLua_wxDC_GetAsBitmap(lua_State *L)
{
    ...
    const wxRect * subrect = (argCount >= 2 ? (const wxRect *)wxluaT_getuserdatatype(L, 2, wxluatype_wxRect) : (const wxRect *)NULL);
    // get this
    wxDC * self = (wxDC *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDC);
    // call GetAsBitmap
    // allocate a new object using the copy constructor
...
static int LUACALL wxLua_wxDC_GradientFillLinear(lua_State *L)
{
    ...
    wxDirection nDirection = (argCount >= 5 ? (wxDirection)wxlua_getenumtype(L, 5) : (wxDirection)wxEAST);
    // const wxColour destColour
    const wxColour * destColour = (const wxColour *)wxluaT_getuserdatatype(L, 4, wxluatype_wxColour);
    // const wxColour initialColour
    const wxColour * initialColour = (const wxColour *)wxluaT_getuserdatatype(L, 3, wxluatype_wxColour);
...
static int LUACALL wxLua_wxScreenDC_StartDrawingOnTop1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxRect rect = NULL
    wxRect * rect = (argCount >= 1 ? (wxRect *)wxluaT_getuserdatatype(L, 1, wxluatype_wxRect) : (wxRect *)NULL);
...
static int LUACALL wxLua_wxBufferedDC_Init1(lua_State *L)
{
    ...
    int style = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)wxBUFFER_CLIENT_AREA);
    // wxBitmap buffer
...
static int LUACALL wxLua_wxBufferedDC_constructor2(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int style = wxBUFFER_CLIENT_AREA
    int style = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)wxBUFFER_CLIENT_AREA);
    // wxBitmap buffer
...
static int LUACALL wxLua_wxBufferedPaintDC_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int style = wxBUFFER_CLIENT_AREA
    int style = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)wxBUFFER_CLIENT_AREA);
    // wxWindow window
    wxWindow * window = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
    // call constructor
...
static int LUACALL wxLua_wxCaretSuspend_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxWindow win = NULL
    wxWindow * win = (argCount >= 1 ? (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow) : (wxWindow *)NULL);
    // call constructor
...
static int LUACALL wxLua_wxVideoMode_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int freq = 0
    int freq = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)0);
    // int depth = 0
    int depth = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)0);
    // int height = 0
    int height = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)0);
    // int width = 0
    int width = (argCount >= 1 ? (int)wxlua_getnumbertype(L, 1) : (int)0);
...
static int LUACALL wxLua_wxArrayVideoModes_Add(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // size_t copies = 1
    size_t copies = (argCount >= 3 ? (size_t)wxlua_getuintegertype(L, 3) : (size_t)1);
...
static int LUACALL wxLua_wxArrayVideoModes_Insert(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // size_t copies = 1
    size_t copies = (argCount >= 4 ? (size_t)wxlua_getuintegertype(L, 4) : (size_t)1);
    // int nIndex
...
static int LUACALL wxLua_wxArrayVideoModes_RemoveAt(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // size_t count = 1
    size_t count = (argCount >= 3 ? (size_t)wxlua_getuintegertype(L, 3) : (size_t)1);
    // size_t nIndex
    size_t nIndex = (size_t)wxlua_getuintegertype(L, 2);
    // get this
    wxArrayVideoModes * self = (wxArrayVideoModes *)wxluaT_getuserdatatype(L, 1, wxluatype_wxArrayVideoModes);
...
static int LUACALL wxLua_wxDisplay_ChangeMode(lua_State *L)
{
    ...
    const wxVideoMode * mode = (argCount >= 2 ? (const wxVideoMode *)wxluaT_getuserdatatype(L, 2, wxluatype_wxVideoMode) : (const wxVideoMode *)&wxDefaultVideoMode);
    // get this
...
static int LUACALL wxLua_wxDisplay_constructor2(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // size_t index = 0
    size_t index = (argCount >= 1 ? (size_t)wxlua_getuintegertype(L, 1) : (size_t)0);
    // call constructor
...
static int LUACALL wxLua_wxDisplay_constructor(lua_State *L)
{
    ...
    unsigned int index = (argCount >= 1 ? (unsigned int)wxlua_getuintegertype(L, 1) : (unsigned int)0);
    // call constructor
    wxDisplay* returns = new wxDisplay(index);
    // add to tracked memory list
    wxluaO_addgcobject(L, returns, wxluatype_wxDisplay);
...
static int LUACALL wxLua_wxEffects_DrawSunkenEdge(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int borderSize = 1
    int borderSize = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)1);
    // const wxRect rect
    const wxRect * rect = (const wxRect *)wxluaT_getuserdatatype(L, 3, wxluatype_wxRect);
    // wxDC dc
    wxDC * dc = (wxDC *)wxluaT_getuserdatatype(L, 2, wxluatype_wxDC);
...
static int LUACALL wxLua_wxRendererNative_DrawCheckBox(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int flags = 0
    int flags = (argCount >= 5 ? (int)wxlua_getnumbertype(L, 5) : (int)0);
    // const wxRect rect
    const wxRect * rect = (const wxRect *)wxluaT_getuserdatatype(L, 4, wxluatype_wxRect);
    // wxDC dc
    wxDC * dc = (wxDC *)wxluaT_getuserdatatype(L, 3, wxluatype_wxDC);
...
static int LUACALL wxLua_wxRendererNative_DrawHeaderButton(lua_State *L)
{
    ...
    wxHeaderButtonParams * params = (argCount >= 7 ? (wxHeaderButtonParams *)wxluaT_getuserdatatype(L, 7, wxluatype_wxHeaderButtonParams) : (wxHeaderButtonParams *)NULL);
    // wxHeaderSortIconType sortArrow = wxHDR_SORT_ICON_NONE
    wxHeaderSortIconType sortArrow = (argCount >= 6 ? (wxHeaderSortIconType)wxlua_getenumtype(L, 6) : (wxHeaderSortIconType)wxHDR_SORT_ICON_NONE);
    // int flags = 0
    int flags = (argCount >= 5 ? (int)wxlua_getnumbertype(L, 5) : (int)0);
    // const wxRect rect
    const wxRect * rect = (const wxRect *)wxluaT_getuserdatatype(L, 4, wxluatype_wxRect);
...
static int LUACALL wxLua_wxRendererNative_DrawSplitterSash(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int flags = 0
    int flags = (argCount >= 7 ? (int)wxlua_getnumbertype(L, 7) : (int)0);
