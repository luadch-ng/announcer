...
static int LUACALL wxLua_wxContextHelp_constructor(lua_State *L)
{
    ...
    // bool beginHelp = true
    bool beginHelp = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // wxWindow win = NULL
...
static int LUACALL wxLua_wxContextHelpButton_constructor(lua_State *L)
{
    ...
    long style = (argCount >= 5 ? (long)wxlua_getnumbertype(L, 5) : (long)wxBU_AUTODRAW);
    ...
    wxWindowID id = (argCount >= 2 ? (wxWindowID)wxlua_getnumbertype(L, 2) : (wxWindowID)wxID_CONTEXT_HELP);
    // wxWindow parent
...
static int LUACALL wxLua_wxHelpControllerHelpProvider_constructor(lua_State *L)
{
    ...
    wxHelpController * hc = (argCount >= 1 ? (wxHelpController *)wxluaT_getuserdatatype(L, 1, wxluatype_wxHelpController) : (wxHelpController *)NULL);
    // call constructor
...
static int LUACALL wxLua_wxHelpControllerBase_KeywordSearch(lua_State *L)
{
    ...
    wxHelpSearchMode mode = (argCount >= 3 ? (wxHelpSearchMode)wxlua_getenumtype(L, 3) : (wxHelpSearchMode)wxHELP_SEARCH_ALL);
...
static int LUACALL wxLua_wxHelpControllerBase_LoadFile(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString file = ""
    const wxString file = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (const wxString)wxString(wxEmptyString));
    // get this
    wxHelpControllerBase * self = (wxHelpControllerBase *)wxluaT_getuserdatatype(L, 1, wxluatype_wxHelpControllerBase);
    // call LoadFile
...
static int LUACALL wxLua_wxHelpControllerBase_SetFrameParameters(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool newFrameEachTime = false
    bool newFrameEachTime = (argCount >= 5 ? wxlua_getbooleantype(L, 5) : (bool)false);
    // const wxPoint pos = wxDefaultPosition
...
static int LUACALL wxLua_wxBestHelpController_constructor(lua_State *L)
{
    ...
    int style = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)wxHF_DEFAULT_STYLE);
    // wxWindow parentWindow = NULL
    wxWindow * parentWindow = (argCount >= 1 ? (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow) : (wxWindow *)NULL);
    // call constructor
