...
static int LUACALL wxLua_wxPickerBase_SetPickerCtrlGrowable(lua_State *L)
{
    ...
    // bool grow = true
    bool grow = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxPickerBase * self = (wxPickerBase *)wxluaT_getuserdatatype(L, 1, wxluatype_wxPickerBase);
...
static int LUACALL wxLua_wxColourPickerCtrl_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 9 ? wxlua_getwxStringtype(L, 9) : (const wxString)wxString(wxT("wxColourPickerCtrl")));
    ...
    long style = (argCount >= 7 ? (long)wxlua_getnumbertype(L, 7) : (long)wxCLRP_DEFAULT_STYLE);
...
static int LUACALL wxLua_wxColourPickerCtrl_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxColourPickerCtrl"
    const wxString name = (argCount >= 8 ? wxlua_getwxStringtype(L, 8) : (const wxString)wxString(wxT("wxColourPickerCtrl")));
    // const wxValidator validator = wxDefaultValidator
    ...
    // long style = wxCLRP_DEFAULT_STYLE
    long style = (argCount >= 6 ? (long)wxlua_getnumbertype(L, 6) : (long)wxCLRP_DEFAULT_STYLE);
    // const wxSize size = wxDefaultSize
...
static int LUACALL wxLua_wxDatePickerCtrl_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 9 ? wxlua_getwxStringtype(L, 9) : (const wxString)wxString(wxT("wxDatePickerCtrl")));
    // const wxValidator validator = wxDefaultValidator
    const wxValidator * validator = (argCount >= 8 ? (const wxValidator *)wxluaT_getuserdatatype(L, 8, wxluatype_wxValidator) : (const wxValidator *)&wxDefaultValidator);
    // long style = wxDP_DEFAULT | wxDP_SHOWCENTURY
    long style = (argCount >= 7 ? (long)wxlua_getnumbertype(L, 7) : (long)wxDP_DEFAULT | wxDP_SHOWCENTURY);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 6 ? (const wxSize *)wxluaT_getuserdatatype(L, 6, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 5 ? (const wxPoint *)wxluaT_getuserdatatype(L, 5, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
    // const wxDateTime dt = wxDefaultDateTime
    const wxDateTime * dt = (argCount >= 4 ? (const wxDateTime *)wxluaT_getuserdatatype(L, 4, wxluatype_wxDateTime) : (const wxDateTime *)&wxDefaultDateTime);
    // wxWindowID id
    wxWindowID id = (wxWindowID)wxlua_getnumbertype(L, 3);
    // wxWindow parent
    wxWindow * parent = (wxWindow *)wxluaT_getuserdatatype(L, 2, wxluatype_wxWindow);
...
static int LUACALL wxLua_wxDatePickerCtrl_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxDatePickerCtrl"
    const wxString name = (argCount >= 8 ? wxlua_getwxStringtype(L, 8) : (const wxString)wxString(wxT("wxDatePickerCtrl")));
    // const wxValidator validator = wxDefaultValidator
    const wxValidator * validator = (argCount >= 7 ? (const wxValidator *)wxluaT_getuserdatatype(L, 7, wxluatype_wxValidator) : (const wxValidator *)&wxDefaultValidator);
    // long style = wxDP_DEFAULT | wxDP_SHOWCENTURY
    long style = (argCount >= 6 ? (long)wxlua_getnumbertype(L, 6) : (long)wxDP_DEFAULT | wxDP_SHOWCENTURY);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 5 ? (const wxSize *)wxluaT_getuserdatatype(L, 5, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 4 ? (const wxPoint *)wxluaT_getuserdatatype(L, 4, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
    // const wxDateTime dt = wxDefaultDateTime
    const wxDateTime * dt = (argCount >= 3 ? (const wxDateTime *)wxluaT_getuserdatatype(L, 3, wxluatype_wxDateTime) : (const wxDateTime *)&wxDefaultDateTime);
    // wxWindowID id
    wxWindowID id = (wxWindowID)wxlua_getnumbertype(L, 2);
    // wxWindow parent
    wxWindow * parent = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
...
static int LUACALL wxLua_wxTimePickerCtrl_Create(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = wxTimePickerCtrlNameStr
    const wxString name = (argCount >= 9 ? wxlua_getwxStringtype(L, 9) : (const wxString)wxString(wxTimePickerCtrlNameStr));
    // const wxValidator validator = wxDefaultValidator
    const wxValidator * validator = (argCount >= 8 ? (const wxValidator *)wxluaT_getuserdatatype(L, 8, wxluatype_wxValidator) : (const wxValidator *)&wxDefaultValidator);
    // long style = wxTP_DEFAULT
    long style = (argCount >= 7 ? (long)wxlua_getnumbertype(L, 7) : (long)wxTP_DEFAULT);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 6 ? (const wxSize *)wxluaT_getuserdatatype(L, 6, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 5 ? (const wxPoint *)wxluaT_getuserdatatype(L, 5, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
...
static int LUACALL wxLua_wxTimePickerCtrl_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = wxTimePickerCtrlNameStr
    const wxString name = (argCount >= 8 ? wxlua_getwxStringtype(L, 8) : (const wxString)wxString(wxTimePickerCtrlNameStr));
    // const wxValidator validator = wxDefaultValidator
    const wxValidator * validator = (argCount >= 7 ? (const wxValidator *)wxluaT_getuserdatatype(L, 7, wxluatype_wxValidator) : (const wxValidator *)&wxDefaultValidator);
    // long style = wxTP_DEFAULT
    long style = (argCount >= 6 ? (long)wxlua_getnumbertype(L, 6) : (long)wxTP_DEFAULT);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 5 ? (const wxSize *)wxluaT_getuserdatatype(L, 5, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 4 ? (const wxPoint *)wxluaT_getuserdatatype(L, 4, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
...
static int LUACALL wxLua_wxDirPickerCtrl_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 10 ? wxlua_getwxStringtype(L, 10) : (const wxString)wxString(wxT("wxDirPickerCtrl")));
    // const wxValidator validator = wxDefaultValidator
    const wxValidator * validator = (argCount >= 9 ? (const wxValidator *)wxluaT_getuserdatatype(L, 9, wxluatype_wxValidator) : (const wxValidator *)&wxDefaultValidator);
    // long style = wxDIRP_DEFAULT_STYLE
    long style = (argCount >= 8 ? (long)wxlua_getnumbertype(L, 8) : (long)wxDIRP_DEFAULT_STYLE);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 7 ? (const wxSize *)wxluaT_getuserdatatype(L, 7, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 6 ? (const wxPoint *)wxluaT_getuserdatatype(L, 6, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
    // const wxString message = wxDirSelectorPromptStr
    const wxString message = (argCount >= 5 ? wxlua_getwxStringtype(L, 5) : (const wxString)wxString(wxDirSelectorPromptStr));
    // const wxString path = ""
    const wxString path = (argCount >= 4 ? wxlua_getwxStringtype(L, 4) : (const wxString)wxString(wxEmptyString));
    // wxWindowID id
    wxWindowID id = (wxWindowID)wxlua_getnumbertype(L, 3);
    // wxWindow parent
    wxWindow * parent = (wxWindow *)wxluaT_getuserdatatype(L, 2, wxluatype_wxWindow);
...
static int LUACALL wxLua_wxDirPickerCtrl_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxDirPickerCtrl"
    const wxString name = (argCount >= 9 ? wxlua_getwxStringtype(L, 9) : (const wxString)wxString(wxT("wxDirPickerCtrl")));
    // const wxValidator validator = wxDefaultValidator
    const wxValidator * validator = (argCount >= 8 ? (const wxValidator *)wxluaT_getuserdatatype(L, 8, wxluatype_wxValidator) : (const wxValidator *)&wxDefaultValidator);
    // long style = wxDIRP_DEFAULT_STYLE
    long style = (argCount >= 7 ? (long)wxlua_getnumbertype(L, 7) : (long)wxDIRP_DEFAULT_STYLE);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 6 ? (const wxSize *)wxluaT_getuserdatatype(L, 6, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 5 ? (const wxPoint *)wxluaT_getuserdatatype(L, 5, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
    // const wxString message = wxDirSelectorPromptStr
    const wxString message = (argCount >= 4 ? wxlua_getwxStringtype(L, 4) : (const wxString)wxString(wxDirSelectorPromptStr));
    // const wxString path = ""
    const wxString path = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxEmptyString));
    // wxWindowID id
    wxWindowID id = (wxWindowID)wxlua_getnumbertype(L, 2);
    // wxWindow parent
    wxWindow * parent = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
...
static int LUACALL wxLua_wxFilePickerCtrl_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 11 ? wxlua_getwxStringtype(L, 11) : (const wxString)wxString(wxT("wxFilePickerCtrl")));
    // const wxValidator validator = wxDefaultValidator
    const wxValidator * validator = (argCount >= 10 ? (const wxValidator *)wxluaT_getuserdatatype(L, 10, wxluatype_wxValidator) : (const wxValidator *)&wxDefaultValidator);
    // long style = wxFLP_DEFAULT_STYLE
    long style = (argCount >= 9 ? (long)wxlua_getnumbertype(L, 9) : (long)wxFLP_DEFAULT_STYLE);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 8 ? (const wxSize *)wxluaT_getuserdatatype(L, 8, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 7 ? (const wxPoint *)wxluaT_getuserdatatype(L, 7, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
    // const wxString wildcard = wxFileSelectorDefaultWildcardStr
    const wxString wildcard = (argCount >= 6 ? wxlua_getwxStringtype(L, 6) : (const wxString)wxString(wxFileSelectorDefaultWildcardStr));
    // const wxString message = wxFileSelectorPromptStr
    const wxString message = (argCount >= 5 ? wxlua_getwxStringtype(L, 5) : (const wxString)wxString(wxFileSelectorPromptStr));
    // const wxString path = ""
    const wxString path = (argCount >= 4 ? wxlua_getwxStringtype(L, 4) : (const wxString)wxString(wxEmptyString));
    // wxWindowID id
    wxWindowID id = (wxWindowID)wxlua_getnumbertype(L, 3);
...
static int LUACALL wxLua_wxFilePickerCtrl_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxFilePickerCtrl"
    const wxString name = (argCount >= 10 ? wxlua_getwxStringtype(L, 10) : (const wxString)wxString(wxT("wxFilePickerCtrl")));
    // const wxValidator validator = wxDefaultValidator
    const wxValidator * validator = (argCount >= 9 ? (const wxValidator *)wxluaT_getuserdatatype(L, 9, wxluatype_wxValidator) : (const wxValidator *)&wxDefaultValidator);
    // long style = wxFLP_DEFAULT_STYLE
    long style = (argCount >= 8 ? (long)wxlua_getnumbertype(L, 8) : (long)wxFLP_DEFAULT_STYLE);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 7 ? (const wxSize *)wxluaT_getuserdatatype(L, 7, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 6 ? (const wxPoint *)wxluaT_getuserdatatype(L, 6, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
    // const wxString wildcard = wxFileSelectorDefaultWildcardStr
    const wxString wildcard = (argCount >= 5 ? wxlua_getwxStringtype(L, 5) : (const wxString)wxString(wxFileSelectorDefaultWildcardStr));
    // const wxString message = wxFileSelectorPromptStr
    const wxString message = (argCount >= 4 ? wxlua_getwxStringtype(L, 4) : (const wxString)wxString(wxFileSelectorPromptStr));
    // const wxString path = ""
    const wxString path = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxEmptyString));
    // wxWindowID id
    wxWindowID id = (wxWindowID)wxlua_getnumbertype(L, 2);
...
static int LUACALL wxLua_wxFontPickerCtrl_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 9 ? wxlua_getwxStringtype(L, 9) : (const wxString)wxString(wxT("wxFontPickerCtrl")));
    // const wxValidator validator = wxDefaultValidator
    const wxValidator * validator = (argCount >= 8 ? (const wxValidator *)wxluaT_getuserdatatype(L, 8, wxluatype_wxValidator) : (const wxValidator *)&wxDefaultValidator);
    // long style = wxFNTP_DEFAULT_STYLE
    long style = (argCount >= 7 ? (long)wxlua_getnumbertype(L, 7) : (long)wxFNTP_DEFAULT_STYLE);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 6 ? (const wxSize *)wxluaT_getuserdatatype(L, 6, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 5 ? (const wxPoint *)wxluaT_getuserdatatype(L, 5, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
    // const wxFont initial = wxNullFont
    const wxFont * initial = (argCount >= 4 ? (const wxFont *)wxluaT_getuserdatatype(L, 4, wxluatype_wxFont) : (const wxFont *)&wxNullFont);
    // wxWindowID id
    wxWindowID id = (wxWindowID)wxlua_getnumbertype(L, 3);
    // wxWindow parent
    wxWindow * parent = (wxWindow *)wxluaT_getuserdatatype(L, 2, wxluatype_wxWindow);
...
static int LUACALL wxLua_wxFontPickerCtrl_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxFontPickerCtrl"
    const wxString name = (argCount >= 8 ? wxlua_getwxStringtype(L, 8) : (const wxString)wxString(wxT("wxFontPickerCtrl")));
    // const wxValidator validator = wxDefaultValidator
    const wxValidator * validator = (argCount >= 7 ? (const wxValidator *)wxluaT_getuserdatatype(L, 7, wxluatype_wxValidator) : (const wxValidator *)&wxDefaultValidator);
    // long style = wxFNTP_DEFAULT_STYLE
    long style = (argCount >= 6 ? (long)wxlua_getnumbertype(L, 6) : (long)wxFNTP_DEFAULT_STYLE);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 5 ? (const wxSize *)wxluaT_getuserdatatype(L, 5, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 4 ? (const wxPoint *)wxluaT_getuserdatatype(L, 4, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
    // const wxFont initial = wxNullFont
    const wxFont * initial = (argCount >= 3 ? (const wxFont *)wxluaT_getuserdatatype(L, 3, wxluatype_wxFont) : (const wxFont *)&wxNullFont);
    // wxWindowID id
    wxWindowID id = (wxWindowID)wxlua_getnumbertype(L, 2);
    // wxWindow parent
    wxWindow * parent = (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow);
