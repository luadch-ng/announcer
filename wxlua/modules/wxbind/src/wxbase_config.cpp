...
static int LUACALL wxLua_wxConfigBase_DeleteEntry(lua_State *L)
{
    ...
    bool bDeleteGroupIfEmpty = (argCount >= 3 ? wxlua_getbooleantype(L, 3) : (bool)true);
    // const wxString key
...
static int LUACALL wxLua_wxConfigBase_Flush(lua_State *L)
{
    ...
    bool bCurrentOnly = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)false);
    // get this
    wxConfigBase * self = (wxConfigBase *)wxluaT_getuserdatatype(L, 1, wxluatype_wxConfigBase);
    // call Flush
...
static int LUACALL wxLua_wxConfigBase_Get(lua_State *L)
{
    ...
    bool CreateOnDemand = (argCount >= 1 ? wxlua_getbooleantype(L, 1) : (bool)true);
    // call Get
...
static int LUACALL wxLua_wxConfigBase_GetNumberOfEntries(lua_State *L)
{
    ...
    bool bRecursive = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)false);
    // get this
    wxConfigBase * self = (wxConfigBase *)wxluaT_getuserdatatype(L, 1, wxluatype_wxConfigBase);
...
static int LUACALL wxLua_wxConfigBase_Set(lua_State *L)
{
    ...
    wxConfigBase * pConfig = (argCount >= 1 ? (wxConfigBase *)wxluaT_getuserdatatype(L, 1, wxluatype_wxConfigBase) : (wxConfigBase *)NULL);
...
static int LUACALL wxLua_wxConfigBase_SetExpandEnvVars(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool bDoIt = true
    bool bDoIt = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxConfigBase * self = (wxConfigBase *)wxluaT_getuserdatatype(L, 1, wxluatype_wxConfigBase);
...
static int LUACALL wxLua_wxConfig_constructor(lua_State *L)
{
    ...
    const wxString globalFilename = (argCount >= 4 ? wxlua_getwxStringtype(L, 4) : (const wxString)wxString(wxEmptyString));
    // const wxString localFilename = ""
    const wxString localFilename = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxEmptyString));
    // const wxString vendorName = ""
    const wxString vendorName = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (const wxString)wxString(wxEmptyString));
    // const wxString appName = ""
    const wxString appName = (argCount >= 1 ? wxlua_getwxStringtype(L, 1) : (const wxString)wxString(wxEmptyString));
    // call constructor
...
static int LUACALL wxLua_wxFileConfig_GetLocalFile(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int style = 0
    int style = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)0);
    // const wxString basename
    const wxString basename = wxlua_getwxStringtype(L, 1);
    // call GetLocalFile
    // allocate a new object using the copy constructor
...
static int LUACALL wxLua_wxFileConfig_constructor(lua_State *L)
{
    ...
    long style = (argCount >= 5 ? (long)wxlua_getnumbertype(L, 5) : (long)wxCONFIG_USE_LOCAL_FILE | wxCONFIG_USE_GLOBAL_FILE);
    // const wxString globalFilename = ""
    const wxString globalFilename = (argCount >= 4 ? wxlua_getwxStringtype(L, 4) : (const wxString)wxString(wxEmptyString));
    // const wxString localFilename = ""
    const wxString localFilename = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxEmptyString));
