...
static int LUACALL wxLua_wxImage_Clear(lua_State *L)
{
    ...
    unsigned char value = (argCount >= 2 ? (unsigned char)wxlua_getuintegertype(L, 2) : (unsigned char)0);
    // get this
    wxImage * self = (wxImage *)wxluaT_getuserdatatype(L, 1, wxluatype_wxImage);
    // call Clear
    self->Clear(value);
...
static int LUACALL wxLua_wxImage_ConvertAlphaToMask1(lua_State *L)
{
    ...
    unsigned char threshold = (argCount >= 5 ? (unsigned char)wxlua_getuintegertype(L, 5) : (unsigned char)wxIMAGE_ALPHA_THRESHOLD);
    // unsigned char mb
...
static int LUACALL wxLua_wxImage_ConvertAlphaToMask(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // unsigned char threshold = wxIMAGE_ALPHA_THRESHOLD
    unsigned char threshold = (argCount >= 2 ? (unsigned char)wxlua_getuintegertype(L, 2) : (unsigned char)wxIMAGE_ALPHA_THRESHOLD);
    // get this
    wxImage * self = (wxImage *)wxluaT_getuserdatatype(L, 1, wxluatype_wxImage);
    // call ConvertAlphaToMask
...
static int LUACALL wxLua_wxImage_ConvertToGreyscale(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // double lb = 0.114
    double lb = (argCount >= 4 ? (double)wxlua_getnumbertype(L, 4) : (double)0.114);
    // double lg = 0.587
    double lg = (argCount >= 3 ? (double)wxlua_getnumbertype(L, 3) : (double)0.587);
    // double lr = 0.299
    double lr = (argCount >= 2 ? (double)wxlua_getnumbertype(L, 2) : (double)0.299);
    // get this
    wxImage * self = (wxImage *)wxluaT_getuserdatatype(L, 1, wxluatype_wxImage);
...
static int LUACALL wxLua_wxImage_Create5(lua_State *L)
{
    ...
    bool static_data = (argCount >= 5 ? wxlua_getbooleantype(L, 5) : (bool)false);
    // unsigned char alpha
...
static int LUACALL wxLua_wxImage_Create4(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool static_data = false
    bool static_data = (argCount >= 6 ? wxlua_getbooleantype(L, 6) : (bool)false);
    // unsigned char alpha
...
static int LUACALL wxLua_wxImage_Create3(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool static_data = false
    bool static_data = (argCount >= 4 ? wxlua_getbooleantype(L, 4) : (bool)false);
    // unsigned char data
    unsigned char * data = (unsigned char *)wxlua_getstringtype(L, 3);
    // const wxSize sz
    const wxSize * sz = (const wxSize *)wxluaT_getuserdatatype(L, 2, wxluatype_wxSize);
...
static int LUACALL wxLua_wxImage_Create1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool clear = true
    bool clear = (argCount >= 3 ? wxlua_getbooleantype(L, 3) : (bool)true);
    // const wxSize sz
    const wxSize * sz = (const wxSize *)wxluaT_getuserdatatype(L, 2, wxluatype_wxSize);
    // get this
    wxImage * self = (wxImage *)wxluaT_getuserdatatype(L, 1, wxluatype_wxImage);
...
static int LUACALL wxLua_wxImage_Create(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool clear = true
    bool clear = (argCount >= 4 ? wxlua_getbooleantype(L, 4) : (bool)true);
    // int height
    int height = (int)wxlua_getnumbertype(L, 3);
    // int width
    int width = (int)wxlua_getnumbertype(L, 2);
...
static int LUACALL wxLua_wxImage_IsTransparent(lua_State *L)
{
    ...
    unsigned char threshold = (argCount >= 4 ? (unsigned char)wxlua_getuintegertype(L, 4) : (unsigned char)128);
    // int y
    int y = (int)wxlua_getnumbertype(L, 3);
    // int x
    int x = (int)wxlua_getnumbertype(L, 2);
...
static int LUACALL wxLua_wxImage_LoadFile3(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int index = -1
    int index = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)-1);
    // const wxString mimetype
...
static int LUACALL wxLua_wxImage_Mirror(lua_State *L)
{
    ...
    bool horizontally = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxImage * self = (wxImage *)wxluaT_getuserdatatype(L, 1, wxluatype_wxImage);
    // call Mirror
    // allocate a new object using the copy constructor
...
static int LUACALL wxLua_wxImage_Rescale(lua_State *L)
{
    ...
    wxImageResizeQuality quality = (argCount >= 4 ? (wxImageResizeQuality)wxlua_getenumtype(L, 4) : (wxImageResizeQuality)wxIMAGE_QUALITY_NORMAL);
    // int height
    int height = (int)wxlua_getnumbertype(L, 3);
    // int width
    int width = (int)wxlua_getnumbertype(L, 2);
...
static int LUACALL wxLua_wxImage_Resize(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int blue = -1
    int blue = (argCount >= 6 ? (int)wxlua_getnumbertype(L, 6) : (int)-1);
    // int green = -1
    int green = (argCount >= 5 ? (int)wxlua_getnumbertype(L, 5) : (int)-1);
    // int red = -1
    int red = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)-1);
    // const wxPoint pos
...
static int LUACALL wxLua_wxImage_Rotate(lua_State *L)
{
    ...
    wxPoint * offsetAfterRotation = (argCount >= 5 ? (wxPoint *)wxluaT_getuserdatatype(L, 5, wxluatype_wxPoint) : (wxPoint *)NULL);
    // bool interpolating = true
    bool interpolating = (argCount >= 4 ? wxlua_getbooleantype(L, 4) : (bool)true);
...
static int LUACALL wxLua_wxImage_Rotate90(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool clockwise = true
    bool clockwise = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxImage * self = (wxImage *)wxluaT_getuserdatatype(L, 1, wxluatype_wxImage);
    // call Rotate90
    // allocate a new object using the copy constructor
...
static int LUACALL wxLua_wxImage_SetAlpha(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool static_data = false
    bool static_data = (argCount >= 3 ? wxlua_getbooleantype(L, 3) : (bool)false);
    // unsigned char alpha = NULL
    unsigned char * alpha = (argCount >= 2 ? (unsigned char *)wxlua_getstringtype(L, 2) : (unsigned char *)NULL);
    // get this
    wxImage * self = (wxImage *)wxluaT_getuserdatatype(L, 1, wxluatype_wxImage);
    // call SetAlpha
...
static int LUACALL wxLua_wxImage_SetMask(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool hasMask = true
    bool hasMask = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxImage * self = (wxImage *)wxluaT_getuserdatatype(L, 1, wxluatype_wxImage);
    // call SetMask
...
static int LUACALL wxLua_wxImage_constructor11(lua_State *L)
{
    ...
    long type = (argCount >= 2 ? (long)wxlua_getnumbertype(L, 2) : (long)wxBITMAP_TYPE_ANY);
    // const wxString name
    const wxString name = wxlua_getwxStringtype(L, 1);
    // call constructor
...
static int LUACALL wxLua_wxImage_constructor9(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int index = -1
    int index = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)-1);
    // const wxString mimetype
...
static int LUACALL wxLua_wxImage_constructor2(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool clear = true
    bool clear = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // const wxSize sz
    const wxSize * sz = (const wxSize *)wxluaT_getuserdatatype(L, 1, wxluatype_wxSize);
    // call constructor
...
static int LUACALL wxLua_wxImageHandler_LoadFile(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int index = 0
    int index = (argCount >= 5 ? (int)wxlua_getnumbertype(L, 5) : (int)0);
    // bool verbose = true
    bool verbose = (argCount >= 4 ? wxlua_getbooleantype(L, 4) : (bool)true);
    // wxInputStream stream
...
static int LUACALL wxLua_wxArtProvider_GetBitmap(lua_State *L)
{
    ...
    const wxSize * size = (argCount >= 3 ? (const wxSize *)wxluaT_getuserdatatype(L, 3, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxString client = wxART_OTHER
    const wxString client = (argCount >= 2 ? wxlua_getwxStringtype(L, 2) : (const wxString)wxString(wxART_OTHER));
    // const wxString id
...
static int LUACALL wxLua_wxArtProvider_GetSizeHint(lua_State *L)
{
    ...
    bool platform_dependent = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)false);
