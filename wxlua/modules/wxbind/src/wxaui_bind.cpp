...
static int LUACALL wxLua_wxAuiToolBarEvent_constructor(lua_State *L)
{
    ...
    // int win_id = 0
    int win_id = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)0);
    // wxEventType command_type = wxEVT_NULL
    wxEventType command_type = (argCount >= 1 ? (wxEventType)wxlua_getnumbertype(L, 1) : (wxEventType)wxEVT_NULL);
    // call constructor
...
static int LUACALL wxLua_wxAuiToolBar_AddControl(lua_State *L)
{
    ...
    const wxString label = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxEmptyString));
    // wxControl control
...
static int LUACALL wxLua_wxAuiToolBar_AddLabel(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const int width = -1
    const int width = (argCount >= 4 ? (const int)wxlua_getnumbertype(L, 4) : (const int)-1);
    // const wxString label = wxEmptyString
    const wxString label = (argCount >= 3 ? wxlua_getwxStringtype(L, 3) : (const wxString)wxString(wxEmptyString));
    // int tool_id
...
static int LUACALL wxLua_wxAuiToolBar_AddStretchSpacer(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int proportion = 1
    int proportion = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)1);
    // get this
    wxAuiToolBar * self = (wxAuiToolBar *)wxluaT_getuserdatatype(L, 1, wxluatype_wxAuiToolBar);
...
static int LUACALL wxLua_wxAuiToolBar_AddTool2(lua_State *L)
{
    ...
    const wxString long_help_string = (argCount >= 8 ? wxlua_getwxStringtype(L, 8) : (const wxString)wxString(wxEmptyString));
    // const wxString short_help_string = wxEmptyString
    const wxString short_help_string = (argCount >= 7 ? wxlua_getwxStringtype(L, 7) : (const wxString)wxString(wxEmptyString));
    // wxObject client_data = NULL
    wxObject * client_data = (argCount >= 6 ? (wxObject *)wxluaT_getuserdatatype(L, 6, wxluatype_wxObject) : (wxObject *)NULL);
    // bool toggle = false
    bool toggle = (argCount >= 5 ? wxlua_getbooleantype(L, 5) : (bool)false);
...
static int LUACALL wxLua_wxAuiToolBar_AddTool(lua_State *L)
{
    ...
    wxItemKind kind = (argCount >= 6 ? (wxItemKind)wxlua_getenumtype(L, 6) : (wxItemKind)wxITEM_NORMAL);
    // const wxString short_help_string = wxEmptyString
    const wxString short_help_string = (argCount >= 5 ? wxlua_getwxStringtype(L, 5) : (const wxString)wxString(wxEmptyString));
    // const wxBitmap bitmap
    const wxBitmap * bitmap = (const wxBitmap *)wxluaT_getuserdatatype(L, 4, wxluatype_wxBitmap);
    // const wxString label
    const wxString label = wxlua_getwxStringtype(L, 3);
...
static int LUACALL wxLua_wxAuiToolBar_Create(lua_State *L)
{
    ...
    long style = (argCount >= 6 ? (long)wxlua_getnumbertype(L, 6) : (long)wxAUI_TB_DEFAULT_STYLE);
...
static int LUACALL wxLua_wxAuiToolBar_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // long style = wxAUI_TB_DEFAULT_STYLE
    long style = (argCount >= 5 ? (long)wxlua_getnumbertype(L, 5) : (long)wxAUI_TB_DEFAULT_STYLE);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 4 ? (const wxSize *)wxluaT_getuserdatatype(L, 4, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint position = wxDefaultPosition
    const wxPoint * position = (argCount >= 3 ? (const wxPoint *)wxluaT_getuserdatatype(L, 3, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
    // wxWindowID id = -1
    wxWindowID id = (argCount >= 2 ? (wxWindowID)wxlua_getnumbertype(L, 2) : (wxWindowID)-1);
    // wxWindow parent
...
static int LUACALL wxLua_wxAuiTabCtrl_AddButton(lua_State *L)
{
    ...
    const wxBitmap * disabled_bitmap = (argCount >= 5 ? (const wxBitmap *)wxluaT_getuserdatatype(L, 5, wxluatype_wxBitmap) : (const wxBitmap *)&wxNullBitmap);
    // const wxBitmap normal_bitmap = wxNullBitmap
    const wxBitmap * normal_bitmap = (argCount >= 4 ? (const wxBitmap *)wxluaT_getuserdatatype(L, 4, wxluatype_wxBitmap) : (const wxBitmap *)&wxNullBitmap);
    // int location
...
static int LUACALL wxLua_wxAuiNotebook_AddPage(lua_State *L)
{
    ...
    const wxBitmap * bitmap = (argCount >= 5 ? (const wxBitmap *)wxluaT_getuserdatatype(L, 5, wxluatype_wxBitmap) : (const wxBitmap *)&wxNullBitmap);
    // bool select = false
    bool select = (argCount >= 4 ? wxlua_getbooleantype(L, 4) : (bool)false);
    // const wxString caption
...
static int LUACALL wxLua_wxAuiNotebook_InsertPage1(lua_State *L)
{
    ...
    // bool select = false
    bool select = (argCount >= 5 ? wxlua_getbooleantype(L, 5) : (bool)false);
    // const wxString text
...
static int LUACALL wxLua_wxAuiNotebook_InsertPage(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxBitmap bitmap = wxNullBitmap
    const wxBitmap * bitmap = (argCount >= 6 ? (const wxBitmap *)wxluaT_getuserdatatype(L, 6, wxluatype_wxBitmap) : (const wxBitmap *)&wxNullBitmap);
    // bool select = false
    bool select = (argCount >= 5 ? wxlua_getbooleantype(L, 5) : (bool)false);
    // const wxString caption
    const wxString caption = wxlua_getwxStringtype(L, 4);
...
static int LUACALL wxLua_wxAuiNotebook_constructor1(lua_State *L)
{
    ...
    long style = (argCount >= 5 ? (long)wxlua_getnumbertype(L, 5) : (long)wxAUI_NB_DEFAULT_STYLE);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 4 ? (const wxSize *)wxluaT_getuserdatatype(L, 4, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 3 ? (const wxPoint *)wxluaT_getuserdatatype(L, 3, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
...
static int LUACALL wxLua_wxAuiFloatingFrame_constructor(lua_State *L)
{
    ...
    long style = (argCount >= 5 ? (long)wxlua_getnumbertype(L, 5) : (long)wxRESIZE_BORDER | wxSYSTEM_MENU | wxCAPTION | wxFRAME_NO_TASKBAR | wxFRAME_FLOAT_ON_PARENT | wxCLIP_CHILDREN);
    // wxWindowID id = wxID_ANY
    wxWindowID id = (argCount >= 4 ? (wxWindowID)wxlua_getnumbertype(L, 4) : (wxWindowID)wxID_ANY);
    // const wxAuiPaneInfo pane
...
static int LUACALL wxLua_wxAuiPaneInfo_BottomDockable(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool b = true
    bool b = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxAuiPaneInfo * self = (wxAuiPaneInfo *)wxluaT_getuserdatatype(L, 1, wxluatype_wxAuiPaneInfo);
    // call BottomDockable
...
static int LUACALL wxLua_wxAuiPaneInfo_CaptionVisible(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool visible = true
    bool visible = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxAuiPaneInfo * self = (wxAuiPaneInfo *)wxluaT_getuserdatatype(L, 1, wxluatype_wxAuiPaneInfo);
    // call CaptionVisible
...
static int LUACALL wxLua_wxAuiPaneInfo_GripperTop(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool attop = true
    bool attop = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxAuiPaneInfo * self = (wxAuiPaneInfo *)wxluaT_getuserdatatype(L, 1, wxluatype_wxAuiPaneInfo);
    // call GripperTop
...
static int LUACALL wxLua_wxAuiPaneInfo_Resizable(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool resizable = true
    bool resizable = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxAuiPaneInfo * self = (wxAuiPaneInfo *)wxluaT_getuserdatatype(L, 1, wxluatype_wxAuiPaneInfo);
    // call Resizable
...
static int LUACALL wxLua_wxAuiManager_AddPane1(lua_State *L)
{
    ...
    const wxString caption = (argCount >= 4 ? wxlua_getwxStringtype(L, 4) : (const wxString)wxString(wxEmptyString));
    // int direction = wxLEFT
    int direction = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)wxLEFT);
    // wxWindow window
    wxWindow * window = (wxWindow *)wxluaT_getuserdatatype(L, 2, wxluatype_wxWindow);
    // get this
    wxAuiManager * self = (wxAuiManager *)wxluaT_getuserdatatype(L, 1, wxluatype_wxAuiManager);
...
static int LUACALL wxLua_wxAuiManager_InsertPane(lua_State *L)
{
    ...
    int insert_level = (argCount >= 4 ? (int)wxlua_getnumbertype(L, 4) : (int)wxAUI_INSERT_PANE);
...
static int LUACALL wxLua_wxAuiManager_LoadPerspective(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool update = true
    bool update = (argCount >= 3 ? wxlua_getbooleantype(L, 3) : (bool)true);
...
static int LUACALL wxLua_wxAuiManager_constructor(lua_State *L)
{
    ...
    unsigned int flags = (argCount >= 2 ? (unsigned int)wxlua_getuintegertype(L, 2) : (unsigned int)wxAUI_MGR_DEFAULT);
    // wxWindow managed_wnd = NULL
    wxWindow * managed_wnd = (argCount >= 1 ? (wxWindow *)wxluaT_getuserdatatype(L, 1, wxluatype_wxWindow) : (wxWindow *)NULL);
    // call constructor
...
static int LUACALL wxLua_wxAuiManagerEvent_Veto(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool veto = true
    bool veto = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxAuiManagerEvent * self = (wxAuiManagerEvent *)wxluaT_getuserdatatype(L, 1, wxluatype_wxAuiManagerEvent);
    // call Veto
    self->Veto(veto);
...
static int LUACALL wxLua_wxAuiMDIParentFrame_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 8 ? wxlua_getwxStringtype(L, 8) : (const wxString)wxString(wxT("wxAuiMDIParentFrame")));
    // long style = wxDEFAULT_FRAME_STYLE | wxVSCROLL | wxHSCROLL
    long style = (argCount >= 7 ? (long)wxlua_getnumbertype(L, 7) : (long)wxDEFAULT_FRAME_STYLE | wxVSCROLL | wxHSCROLL);
    // const wxSize size = wxDefaultSize
...
static int LUACALL wxLua_wxAuiMDIParentFrame_Tile(lua_State *L)
{
    ...
    wxOrientation orient = (argCount >= 2 ? (wxOrientation)wxlua_getenumtype(L, 2) : (wxOrientation)wxHORIZONTAL);
    // get this
    wxAuiMDIParentFrame * self = (wxAuiMDIParentFrame *)wxluaT_getuserdatatype(L, 1, wxluatype_wxAuiMDIParentFrame);
    // call Tile
    self->Tile(orient);
...
static int LUACALL wxLua_wxAuiMDIParentFrame_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxAuiMDIParentFrame"
    const wxString name = (argCount >= 7 ? wxlua_getwxStringtype(L, 7) : (const wxString)wxString(wxT("wxAuiMDIParentFrame")));
    // long style = wxDEFAULT_FRAME_STYLE | wxVSCROLL | wxHSCROLL
    long style = (argCount >= 6 ? (long)wxlua_getnumbertype(L, 6) : (long)wxDEFAULT_FRAME_STYLE | wxVSCROLL | wxHSCROLL);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 5 ? (const wxSize *)wxluaT_getuserdatatype(L, 5, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 4 ? (const wxPoint *)wxluaT_getuserdatatype(L, 4, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
...
static int LUACALL wxLua_wxAuiMDIChildFrame_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 8 ? wxlua_getwxStringtype(L, 8) : (const wxString)wxString(wxT("wxAuiMDIChildFrame")));
    // long style = wxDEFAULT_FRAME_STYLE
    long style = (argCount >= 7 ? (long)wxlua_getnumbertype(L, 7) : (long)wxDEFAULT_FRAME_STYLE);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 6 ? (const wxSize *)wxluaT_getuserdatatype(L, 6, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 5 ? (const wxPoint *)wxluaT_getuserdatatype(L, 5, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
...
static int LUACALL wxLua_wxAuiMDIChildFrame_CreateStatusBar(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = ""
    const wxString name = (argCount >= 5 ? wxlua_getwxStringtype(L, 5) : (const wxString)wxString(wxEmptyString));
    // wxWindowID winid = 1
    wxWindowID winid = (argCount >= 4 ? (wxWindowID)wxlua_getnumbertype(L, 4) : (wxWindowID)1);
    // long style = 1
    long style = (argCount >= 3 ? (long)wxlua_getnumbertype(L, 3) : (long)1);
    // int number = 1
    int number = (argCount >= 2 ? (int)wxlua_getnumbertype(L, 2) : (int)1);
    // get this
    wxAuiMDIChildFrame * self = (wxAuiMDIChildFrame *)wxluaT_getuserdatatype(L, 1, wxluatype_wxAuiMDIChildFrame);
...
static int LUACALL wxLua_wxAuiMDIChildFrame_Iconize(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool iconize = true
    bool iconize = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxAuiMDIChildFrame * self = (wxAuiMDIChildFrame *)wxluaT_getuserdatatype(L, 1, wxluatype_wxAuiMDIChildFrame);
    // call Iconize
...
static int LUACALL wxLua_wxAuiMDIChildFrame_Maximize(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool maximize = true
    bool maximize = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxAuiMDIChildFrame * self = (wxAuiMDIChildFrame *)wxluaT_getuserdatatype(L, 1, wxluatype_wxAuiMDIChildFrame);
    // call Maximize
...
static int LUACALL wxLua_wxAuiMDIChildFrame_SetStatusText(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int number = 0
    int number = (argCount >= 3 ? (int)wxlua_getnumbertype(L, 3) : (int)0);
    // const wxString text
...
static int LUACALL wxLua_wxAuiMDIChildFrame_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxAuiMDIChildFrame"
    const wxString name = (argCount >= 7 ? wxlua_getwxStringtype(L, 7) : (const wxString)wxString(wxT("wxAuiMDIChildFrame")));
    // long style = wxDEFAULT_FRAME_STYLE
    long style = (argCount >= 6 ? (long)wxlua_getnumbertype(L, 6) : (long)wxDEFAULT_FRAME_STYLE);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 5 ? (const wxSize *)wxluaT_getuserdatatype(L, 5, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 4 ? (const wxPoint *)wxluaT_getuserdatatype(L, 4, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
...
static int LUACALL wxLua_wxAuiMDIClientWindow_CreateClient(lua_State *L)
{
    ...
    long style = (argCount >= 3 ? (long)wxlua_getnumbertype(L, 3) : (long)wxVSCROLL | wxHSCROLL);
    // wxAuiMDIParentFrame parent
    wxAuiMDIParentFrame * parent = (wxAuiMDIParentFrame *)wxluaT_getuserdatatype(L, 2, wxluatype_wxAuiMDIParentFrame);
    // get this
...
static int LUACALL wxLua_wxAuiMDIClientWindow_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // long style = 0
    long style = (argCount >= 2 ? (long)wxlua_getnumbertype(L, 2) : (long)0);
    // wxAuiMDIParentFrame parent
    wxAuiMDIParentFrame * parent = (wxAuiMDIParentFrame *)wxluaT_getuserdatatype(L, 1, wxluatype_wxAuiMDIParentFrame);
    // call constructor
