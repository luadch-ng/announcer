...
static int LUACALL wxLua_wxMDIParentFrame_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 8 ? wxlua_getwxStringtype(L, 8) : (const wxString)wxString(wxT("wxMDIParentFrame")));
...
static int LUACALL wxLua_wxMDIParentFrame_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxMDIParentFrame"
    const wxString name = (argCount >= 7 ? wxlua_getwxStringtype(L, 7) : (const wxString)wxString(wxT("wxMDIParentFrame")));
    // long style = wxDEFAULT_FRAME_STYLE | wxVSCROLL | wxHSCROLL
...
static int LUACALL wxLua_wxMDIChildFrame_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 8 ? wxlua_getwxStringtype(L, 8) : (const wxString)wxString(wxT("wxMDIChildFrame")));
...
static int LUACALL wxLua_wxMDIChildFrame_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxMDIChildFrame"
    const wxString name = (argCount >= 7 ? wxlua_getwxStringtype(L, 7) : (const wxString)wxString(wxT("wxMDIChildFrame")));
    // long style = wxDEFAULT_FRAME_STYLE
...
static int LUACALL wxLua_wxDocMDIParentFrame_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 9 ? wxlua_getwxStringtype(L, 9) : (const wxString)wxString(wxT("wxDocMDIParentFrame")));
    // long style = wxDEFAULT_FRAME_STYLE
    long style = (argCount >= 8 ? (long)wxlua_getnumbertype(L, 8) : (long)wxDEFAULT_FRAME_STYLE);
    // const wxSize size = wxDefaultSize
...
static int LUACALL wxLua_wxDocMDIParentFrame_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxDocMDIParentFrame"
    const wxString name = (argCount >= 8 ? wxlua_getwxStringtype(L, 8) : (const wxString)wxString(wxT("wxDocMDIParentFrame")));
    // long style = wxDEFAULT_FRAME_STYLE
    long style = (argCount >= 7 ? (long)wxlua_getnumbertype(L, 7) : (long)wxDEFAULT_FRAME_STYLE);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 6 ? (const wxSize *)wxluaT_getuserdatatype(L, 6, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
...
static int LUACALL wxLua_wxDocMDIChildFrame_Create(lua_State *L)
{
    ...
    const wxString name = (argCount >= 10 ? wxlua_getwxStringtype(L, 10) : (const wxString)wxString(wxT("wxDocMDIChildFrame")));
    // long type = wxDEFAULT_FRAME_STYLE
    long type = (argCount >= 9 ? (long)wxlua_getnumbertype(L, 9) : (long)wxDEFAULT_FRAME_STYLE);
    // const wxSize size = wxDefaultSize
...
static int LUACALL wxLua_wxDocMDIChildFrame_constructor1(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // const wxString name = "wxDocMDIChildFrame"
    const wxString name = (argCount >= 9 ? wxlua_getwxStringtype(L, 9) : (const wxString)wxString(wxT("wxDocMDIChildFrame")));
    // long type = wxDEFAULT_FRAME_STYLE
    long type = (argCount >= 8 ? (long)wxlua_getnumbertype(L, 8) : (long)wxDEFAULT_FRAME_STYLE);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 7 ? (const wxSize *)wxluaT_getuserdatatype(L, 7, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 6 ? (const wxPoint *)wxluaT_getuserdatatype(L, 6, wxluatype_wxPoint) : (const wxPoint *)&wxDefaultPosition);
...
static int LUACALL wxLua_wxDocChildFrame_constructor(lua_State *L)
{
    ...
    const wxString name = (argCount >= 9 ? wxlua_getwxStringtype(L, 9) : (const wxString)wxString(wxT("wxDocChildFrame")));
    // long style = wxDEFAULT_FRAME_STYLE
    long style = (argCount >= 8 ? (long)wxlua_getnumbertype(L, 8) : (long)wxDEFAULT_FRAME_STYLE);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 7 ? (const wxSize *)wxluaT_getuserdatatype(L, 7, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
...
static int LUACALL wxLua_wxDocManager_CloseDocuments(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool force = true
    bool force = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxDocManager * self = (wxDocManager *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocManager);
    // call CloseDocuments
...
static int LUACALL wxLua_wxDocManager_constructor(lua_State *L)
{
    ...
    bool initialize = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // long flags = 0
    long flags = (argCount >= 1 ? (long)wxlua_getnumbertype(L, 1) : (long)0);
    // call constructor
...
static int LUACALL wxLua_wxDocParentFrame_constructor(lua_State *L)
{
    ...
    const wxString name = (argCount >= 8 ? wxlua_getwxStringtype(L, 8) : (const wxString)wxString(wxT("wxDocParentFrame")));
    // long style = wxDEFAULT_FRAME_STYLE
    long style = (argCount >= 7 ? (long)wxlua_getnumbertype(L, 7) : (long)wxDEFAULT_FRAME_STYLE);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 6 ? (const wxSize *)wxluaT_getuserdatatype(L, 6, wxluatype_wxSize) : (const wxSize *)&wxDefaultSize);
...
static int LUACALL wxLua_wxDocTemplate_CreateDocument(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // long flags = 0
    long flags = (argCount >= 3 ? (long)wxlua_getnumbertype(L, 3) : (long)0);
    // const wxString path
    const wxString path = wxlua_getwxStringtype(L, 2);
    // get this
...
static int LUACALL wxLua_wxDocTemplate_InitDocument(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // long flags = 0
    long flags = (argCount >= 4 ? (long)wxlua_getnumbertype(L, 4) : (long)0);
    // const wxString path
...
static int LUACALL wxLua_wxDocTemplate_constructor(lua_State *L)
{
    ...
    long flags = (argCount >= 10 ? (long)wxlua_getnumbertype(L, 10) : (long)wxDEFAULT_TEMPLATE_FLAGS);
    // wxClassInfo viewClassInfo = NULL
    wxClassInfo * viewClassInfo = (argCount >= 9 ? (wxClassInfo *)wxluaT_getuserdatatype(L, 9, wxluatype_wxClassInfo) : (wxClassInfo *)NULL);
    // wxClassInfo docClassInfo = NULL
    wxClassInfo * docClassInfo = (argCount >= 8 ? (wxClassInfo *)wxluaT_getuserdatatype(L, 8, wxluatype_wxClassInfo) : (wxClassInfo *)NULL);
...
static int LUACALL wxLua_wxDocument_SetFilename(lua_State *L)
{
    ...
    bool notifyViews = (argCount >= 3 ? wxlua_getbooleantype(L, 3) : (bool)false);
    // const wxString filename
    const wxString filename = wxlua_getwxStringtype(L, 2);
    // get this
    wxDocument * self = (wxDocument *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocument);
...
static int LUACALL wxLua_wxDocument_UpdateAllViews(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // wxObject hint = NULL
    wxObject * hint = (argCount >= 3 ? (wxObject *)wxluaT_getuserdatatype(L, 3, wxluatype_wxObject) : (wxObject *)NULL);
    // wxView sender = NULL
    wxView * sender = (argCount >= 2 ? (wxView *)wxluaT_getuserdatatype(L, 2, wxluatype_wxView) : (wxView *)NULL);
    // get this
    wxDocument * self = (wxDocument *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocument);
    // call UpdateAllViews
...
static int LUACALL wxLua_wxView_Close(lua_State *L)
{
    ...
    bool deleteWindow = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : (bool)true);
    // get this
    wxView * self = (wxView *)wxluaT_getuserdatatype(L, 1, wxluatype_wxView);
    // call Close
...
static int LUACALL wxLua_wxCommandProcessor_Submit(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool storeIt = true
    bool storeIt = (argCount >= 3 ? wxlua_getbooleantype(L, 3) : (bool)true);
    // wxCommand command
    wxCommand * command = (wxCommand *)wxluaT_getuserdatatype(L, 2, wxluatype_wxCommand);
    // get this
    wxCommandProcessor * self = (wxCommandProcessor *)wxluaT_getuserdatatype(L, 1, wxluatype_wxCommandProcessor);
...
static int LUACALL wxLua_wxCommandProcessor_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int maxCommands = -1
    int maxCommands = (argCount >= 1 ? (int)wxlua_getnumbertype(L, 1) : (int)-1);
    // call constructor
...
static int LUACALL wxLua_wxFileHistory_constructor(lua_State *L)
{
    ...
    wxWindowID idBase = (argCount >= 2 ? (wxWindowID)wxlua_getnumbertype(L, 2) : (wxWindowID)wxID_FILE1);
    // int maxFiles = 9
    int maxFiles = (argCount >= 1 ? (int)wxlua_getnumbertype(L, 1) : (int)9);
    // call constructor
