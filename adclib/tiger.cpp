...
#define round(a,b,c,x,mul) \
     ...
     t2[(unsigned char)(((unsigned long)(c))>>(2*8))] ^ \
     t3[(unsigned char)((c)>>(4*8))] ^ \
     t4[(unsigned char)(((unsigned long)((c)>>(4*8)))>>(2*8))] ; \
     b += t4[(unsigned char)(((unsigned long)(c))>>(1*8))] ^ \
     t3[(unsigned char)(((unsigned long)(c))>>(3*8))] ^ \
     t2[(unsigned char)(((unsigned long)((c)>>(4*8)))>>(1*8))] ^ \
     t1[(unsigned char)(((unsigned long)((c)>>(4*8)))>>(3*8))]; \
     b *= mul;
...
unsigned long long ADCLIB::TigerHash::table[4 * 256] = {
