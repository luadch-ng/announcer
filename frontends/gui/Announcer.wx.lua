    ...
    if pid > 0 then
        ...
        if exists then
            ...
            if ret ~= wx.wxKILL_OK then
                ...
                log_broadcast( log_window, "LOGOUT SUCCESSFUL", "YELLOW" )
                log_broadcast( log_window, app_name .. " " .. _VERSION .. " ready.", "ORANGE" )
            end
        end
        pid = 0
...
control_hubname = wx.wxTextCtrl( tab_1, wx.wxID_ANY, "", wx.wxPoint( 20, 22 ), wx.wxSize( 745, 20 ), wx.wxSUNKEN_BORDER )
...
control_hubaddress = wx.wxTextCtrl( tab_1, wx.wxID_ANY, "", wx.wxPoint( 20, 72 ), wx.wxSize( 662, 20 ), wx.wxSUNKEN_BORDER )
...
control_hubport = wx.wxTextCtrl( tab_1, wx.wxID_ANY, "", wx.wxPoint( 713, 72 ), wx.wxSize( 52, 20 ), wx.wxSUNKEN_BORDER )
...
control_nickname = wx.wxTextCtrl( tab_1, wx.wxID_ANY, "", wx.wxPoint( 20, 122 ), wx.wxSize( 745, 20 ) )
...
control_password = wx.wxTextCtrl( tab_1, wx.wxID_ANY, "", wx.wxPoint( 20, 172 ), wx.wxSize( 745, 20 ), wx.wxSUNKEN_BORDER + wx.wxTE_PASSWORD )
...
control_keyprint = wx.wxTextCtrl( tab_1, wx.wxID_ANY, "", wx.wxPoint( 20, 222 ), wx.wxSize( 745, 20 ), wx.wxSUNKEN_BORDER )
...
control_bot_desc = wx.wxTextCtrl( tab_2, wx.wxID_ANY, "", wx.wxPoint( 20, 22 ), wx.wxSize( 350, 20 ), wx.wxSUNKEN_BORDER )
...
control_bot_slots = wx.wxTextCtrl( tab_2, wx.wxID_ANY, "", wx.wxPoint( 20, 72 ), wx.wxSize( 350, 20 ), wx.wxSUNKEN_BORDER )
...
control_bot_share = wx.wxTextCtrl( tab_2, wx.wxID_ANY, "", wx.wxPoint( 20, 122 ), wx.wxSize( 350, 20 ), wx.wxSUNKEN_BORDER )
...
control_sleeptime = wx.wxTextCtrl( tab_2, wx.wxID_ANY, "", wx.wxPoint( 415, 22 ), wx.wxSize( 350, 20 ), wx.wxSUNKEN_BORDER )
...
control_announceinterval = wx.wxTextCtrl( tab_2, wx.wxID_ANY, "", wx.wxPoint( 415, 72 ), wx.wxSize( 350, 20 ), wx.wxSUNKEN_BORDER )
...
control_sockettimeout = wx.wxTextCtrl( tab_2, wx.wxID_ANY, "", wx.wxPoint( 415, 122 ), wx.wxSize( 350, 20 ), wx.wxSUNKEN_BORDER )
...
control_logfilesize = wx.wxSpinCtrl( tab_2, wx.wxID_ANY, "", wx.wxPoint( 335, 177 ), wx.wxSize( 120, 20 ) )
